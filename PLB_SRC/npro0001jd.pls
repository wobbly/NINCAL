...
NINlast   form      11          hold exchange portion NIN  for Previous Year
...
.Set Vars used for About Box
        ...
        move    "November 29, 2001",Wreldate
...
.
     ...
     move    "                                        ",APIFileName
              ...
              open            tempfile,str45,exclusive                        ;test using exclusive 06sep05
              positeof tempfile
              fposit          tempfile,N10
...
.exclusive clients & lists
              open            tempfile,"c:\work\income7.dat",exclusive
...
pass2
              open            tempfile2,"c:\work\average7.srt",exclusive
...
.Previous year
              ...
              call            Trim using str9
              pack            str4,"P",str9
              setprop         sheet.range(str4),*Value="Last Year"
.Salesperson
              move            howmany,str9       ."7"
              call            Trim using str9
              pack            str4,"Q",str9
...
;end patch 1.3
               reset          str15
               clear          str15
               move           "CDEFGHIJKLMNOPQ",str15       .setprop the column
               move           str15,str1
               move           howmany,endrow
               add            C2,endrow
