...
release   init      "2.89"                DLH Change Srv2008a\fax to nins2\fax
Reldate   Init      "11 January 2012"
.release   init      "2.88"                DLH Sendmail
.Reldate   Init      "22 April 2008"
.release  init      "2.87"                DLH Oct2007 Facsys upgrade
.release  init      "2.86"                DMB 06JUN2006  Added code for yet another triplex donnelley record mod
.release  init      "2.85"                DMB 13JAN2006  Check for Non Zero-Filled Date
.release  init      "2.84"                JD 09JAN2006  Check for Bad Date.
.release  init      "2.83"               JD 19DEC2005  New contact Triplex/Donnelley
.release  init      "2.82"               JD 16DEC2005  New format from Triplex/Donnelley
...
.Patch2.81
         OPEN      INPUT,"shipinfo"
.         OPEN      INPUT,"c:\work\shipinfo.csv"
...
.Patch2.82
//Patch 2.86 
.added two dummy strings to record read

//Patch 2.86 
INPUT2   READ      INPUT,SEQ;*CDFON,str1:
                                                             str1:
                                                             str1:
                                                             str1:                                                       
                                                             str1:                                                       
...
.Patch2.82
        ...
        move       scost to spost
.>Patch 2.85 Coded Added for correct date format  
          call debug
          move str10 to str2
          type str2
          if not equal
...
.>Patch 2.85 End Coded Added for correct date format                  
.>Patch 2.85 Coded Commented Out        
.        unpack    str10 into mm,slash,dd,slash,cc,yy
.>Patch 2.85 EndfCoded Commented Out
        pack      sdate from cc,yy,mm,dd
.>Patch 2.85 Coded Commented Out                
.Patch2.84
...
HEADER   ADD       C1 TO PAGE
         ...
         if        equal
.Patch2.83
.         PRINT     *L,*L,"^[D14153827088^[NRosa Alvarez-TDMC  ^]",*n,032,hpreset:
...
.         EXECUTE   "c:\command.com /c copy g:\DATA\TDMCSHP.LST \\NINs2\Laser2 "
         PACK      TASKNAME,"c:\winnt\system32\cmd.exe /c copy ",NTWKPATH1,"TDMCSHP.LST \\NINs2\Laser8 "
         Execute   TASKNAME
.         else
                    ElseIf              (osflag = c3 | osflag = c4)
         PACK      TASKNAME,"c:\command.com /c copy ",NTWKPATH1,"TDMCSHP.LST \\SNINs2\Laser8 "
         EXECUTE   TASKNAME
                    Elseif              (osflag = c6)
         PACK      TASKNAME,"c:\windows\system32\cmd.exe /c copy ",NTWKPATH1,"TDMCSHP.LST \\NINs2\Laser8 "
         Execute   TASKNAME
.end patch 2.57
.END PATCH 2.52 REPLACED LOGIC
         endif
...
.END PATCH 2.5 REPLACED LOGIC
      ...
      Move    "This is a Informational e-mail from  the Triplex shipping program",MailSubjct
.   Set the text message that is send with the attachments

          Clear     MailBOdy
          append   "This is a Informational e-mail from  the Triplex shipping program",MailBody
