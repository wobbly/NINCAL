...
RELEASE  INIT      "1.71"           DLH add details to mailbody
Reldate   Init      "2014 October 13"
...
HOLD     DIM       7
seqcount FORM      7             .detail file
seqcount1 FORM      7          .balance file
INPUT    FORM      7
OUTOFBAL FORM      7
NODET    FORM      7
nomastr  form      7
...
LINES    FORM      2
lastrec  dim       1
ElapsedTime           External   "ElapsedTime;ElapsedTime"
+..............................................................................
.MAIN
...............................................................................
...
.          PRTOPen   Laser,"PDF995","Nona0006.pdf"
          PRTOPen   Laser,"PDF:","c:\work\pdf\Nona0006.pdf"
.end patch 1.7
...
.END PATCH 1.5 REPLACED LOGIC
         ...
         clock     time to time
         MOVE      C4 TO NMOAPATH
         MOVE      C3 TO NMOALOCK               .note if running during biz hours may want to use locking
         move      c2 to nmobpath
         MOVE      "EXIT" TO PF5
         TRAP      exit IF F5
         CALL      PAINT
...
MENU     
         ...
         CLOCK     TIME TO TIME
         Clear     MailBody
         append    "Start time: ",Mailbody
         append    time,mailbody
         move      time to starttime
         append    "<br>",Mailbody
         MOVE      NO TO OVER
         move      c0 to detcnt
         CALL      NMOBks
         ...
         goto      BAD IF over
         add       c1 to detcnt
         DISPLAY   *P10:13,"DETAIL RECORD  ",DETCNT," record mlr/brk ",nmobmlr,slash,nmobbrk," Transaction: ",transnum
...
.         PRINT     *L,*1,"NO BALANCE RECORD: ",NMOAFLD4," DETAIL(S): ",TOTAL
          ...
          add       eightlpi,row
          prtpage   Laser;*pcolumn:row,*font=font3,*boldoff,"NO BALANCE RECORD(Nmoafld4 brk/mlr): ",NMOAFLD4," Balance: ",TOTAL," Transaction: ",transnum
.end patch 1.6
         ADD       C2 TO LINES
         ADD       C1 TO nomastr
...
.         open      testfile,"g:\data\text\ninmob"
          ...
          PACK      STR255 from "NINMOB.dat|NINS1:502"
         open      testfile,STR255
.END PATCH 1.5 REPLACED LOGIC
         move      c0 to seqcount1
...
pass4
         ...
         goto      end4 if over
         add       c1 to seqcount1
         DISPLAY   *P10:18,"Seq Bal RECORD  ",seqcount1," record "
         goto      pass4
end4    
.begin patch 1.6
.         COMPARE   "60" TO LINES
...
.                   *l,*l,*1,"end time ",time
          ...
          add       eightlpi,row
          prtpage   Laser;*pcolumn:row,*font=font3,*boldoff,"Balance record count Seq     : ",seqcount1
          add       eightlpi,row
...
CheckFile
          ...
          append    "<br>",Mailbody
          append    "RECORDS WITHOUT DETAIL: ",mailbody                             
          append      NoDet,Mailbody
          append    "<br>",Mailbody
          append    "OUT OF BALANCE: ",Mailbody
          append      OUTOFBAL,Mailbody
          append    "<br>",Mailbody
          append    "NO MASTER BALANCE RECORDS: ",Mailbody
          append    NOMASTR,Mailbody
          append    "<br>",Mailbody
          append    "Detail RECORDS count isam   : ",mailbody
          append    detcnt,Mailbody
          append    "<br>",Mailbody
          append    "Detail record count Seq     : ",mailbody
          append    seqcount,Mailbody
          append    "<br>",Mailbody
          append    "Balance RECORDS count isam   : ",mailbody
          append    input,mailbody
          append    "<br>",Mailbody
          append    "Balance record count Seq     : ",Mailbody
          append    seqcount1,mailbody
          append    "<br>",Mailbody
         CLOCK     TIME TO TIME
         append    "Stop time: ",Mailbody
         append    time,mailbody
         append    "<br>",Mailbody
         move         time,endtime
         call         ElapsedTime using starttime,endtime,lapsedtime
         append    "Elapsed time: ",Mailbody
         append    Lapsedtime,mailbody
         append    "<br>",Mailbody
          Reset     MailBOdy
          pack      Mailto from "DavidHerrick@nincal.com,GemmaSpranza@nincal.com,RobbWhiting@nincal.com"
