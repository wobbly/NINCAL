...
.        call    Paint
          ...
          clear     taskname
          pack      taskname,"\\nts1\e\data\text\ninord.dat c:\work\ninash, l408 -198-199,200-201,2,176,196-197"
         ...
         for       COUNTER from "1" TO "31"
                    Pack      Nordfld7 from "05X",Counter
                    rep       Zfill in counter
                    move      "NLCR020A-Read NINASH",Location
                    pack      KeyLocation,"Key: ",NORDFLD1,NORDFLD2,NORDFLD3,NORDFLD4,nordfld7
                trap          IOMssg Giving Error if IO
                    read      NORDFLE2,NORDFLD1,NORDFLD2,NORDFLD3,NORDFLD4,NORDFLD7;ORDVARS
                    trapclr   IO
                    loop
                              until over
                              move      C0,N8
        ...
        if (RptFlag = C2)
                  ...
                  append  "1-2,3-3,10-54,69-74,61-68",taskname
...
.First check 995 autolaunch settings
                              Call      PDF995Auto
                        PRTOPEN PRFile,"PDF995","Nlcr020c"
        endif
          move      C0,page2
          if (RptFlag = C2)
                    call      PrintHeader
...
.                        open    tempfile2,"C:\WORK\STATS1.SRT",EXCLUSIVE
                        open    tempfile2,str45,EXCLUSIVE
                            ...
                            prtpage prfile;*pcolumn:row,*font=font3,*boldon,"Active Records",*boldoff;
                              add       eightlpi,row
                        loop
                                        read    tempfile2,SEQ;SalesNo,str1,str2,OMLRNUM,MCOMP,OLNUM,str8,OLRN,OSTAT
                                        until over
                                if (OSTAT = "l" | OSTAT = "z")
...
.TEST FOR ENOUGH ROOM ON PAGE
        ...
        prtpage prfile;*pcolumn:row,*font=font2,*boldoff;
        prtpage prfile;*pcolumn1:row,STr2," ",Salesper;
...
LCRLoadInfo
        ...
        if (OSTAT = "l")
                    if (RptFlag = C2)
                              ...
                              call      NMLRKEY
                              write   tempfile2,SEQ;Osales10,Osales,"1",NORD5STAT,OMLRNUM,MCOMP,OLNUM,OMDTEC,OMDTEY,OMDTEM,OMDTED,OLRN,OSTAT
                    endif
                add     C1,SalesLCR(2)
                if (NORD5STAT = "00")           .LCR
                        add     C1,SalesLCR(3)
        ...
        elseif (OSTAT = "z")  .Cancelled LCR
                if (RptFlag = C2)
                              pack      MKEY,OMLRNUM,"000"
                              call      NMLRKEY
                        write   tempfile2,SEQ;Osales10,Osales,"205",OMLRNUM,MCOMP,OLNUM,OMDTEC,OMDTEY,OMDTEM,OMDTED,OLRN,OSTAT
                endif
                add     C1,SalesLCR(2)
...
.                   endif
        elseif (OSTAT = "p")
                if (RptFlag = C2)
                              pack      MKEY,OMLRNUM,"000"
                              call      NMLRKEY
                        write   tempfile2,SEQ;Osales10,Osales,"1",NORD4STAT,OMLRNUM,MCOMP,OLNUM,OMDTEC,OMDTEY,OMDTEM,OMDTED,OLRN,OSTAT
                endif
                add     C1,LMPend(2)
        ...
        elseif (OSTAT = "x")                    .Cancelled/Denied
                ...
                if (OHIST = "p")                .Cancelled
                        if (RptFlag = C2)
                                        pack      MKEY,OMLRNUM,"000"
                                        call      NMLRKEY
                                write   tempfile2,SEQ;Osales10,Osales,"207",OMLRNUM,MCOMP,OLNUM,OMDTEC,OMDTEY,OMDTEM,OMDTED,OLRN,OSTAT
                        endif
                        add     C1,LMPend(10)
                elseif (OHIST = "z")            .Denied
                        if (RptFlag = C2)
                                        pack      MKEY,OMLRNUM,"000"
                                        call      NMLRKEY
                                write   tempfile2,SEQ;Osales10,Osales,"206",OMLRNUM,MCOMP,OLNUM,OMDTEC,OMDTEY,OMDTEM,OMDTED,OLRN,OSTAT
                        endif
                        add     C1,LMPend(9)
                endif
        endif
