...
.begin patch 4.1
           include    nrtndd.inc
.end patch 4.1
release  init      "4.2"          DLH     add brk/consult email.
reldate   Init      "2015 June 2"
.release  init      "4.1"          DLH     added return to info, cleaned up formatting (both in Excel version)
.reldate   Init      "2014 November 13"
.release  init      "4.05"          DLH     added Flags= to prtopen with PDF:
.reldate   Init      "2014 March 25"
.Release    INIT    "4.04"               DLH      .more detail on lcr excel
.Reldate   Init      "2014 January 29"
.Release    INIT    "4.03"               DLH      .Excel 2013 *WindowState=xlMinimized
.Reldate   Init      "2014 January 22"
.release   init      "4.02"         DLH     .Do not write to .csv file if excel file is being created
..                                          .add copywrite to excel, cleanup patch 3.5
.RelDate   Init      "2013 May 20"
.release   init      "4.01"         DLH     Convert Internal PDF
.RelDate   Init      "2013 April 22"
.release   init      "4.00"         DLH     Convert to printpage
.RelDate   Init      "28 Jan 2013"
...
.Begin patch 3.92
                    setprop   sheet.Range("V5"),*Value="Broker/Consultant"
                    setprop   sheet.Range("W5"),*Value="Invoiced"
                    setprop   sheet.Range("X5"),*Value="RTN TO##"
                    setprop   sheet.Range("Y5"),*Value="RTN TO"
.Begin patch 4.2
                    setprop   sheet.Range("Z5"),*Value="Broker/Consultant Email"
                    setprop   sheet.Range("AA5"),*Value="Broker/Consultant Name"
.Header Formatting
...
.                    setprop   sheet.Range("A5:Y5"),*HorizontalAlignment=xlAlignCenter
.                    setprop   sheet.Range("A5:Y5").Font,*Bold="True"
.                    sheet.range("A5:Y5").BorderAround using *LineStyle=1,*Weight=MedThick
                    setprop   sheet.Range("A5:aa5"),*HorizontalAlignment=xlAlignCenter
                    setprop   sheet.Range("A5:aa5").Font,*Bold="True"
                    sheet.range("A5:aa5").BorderAround using *LineStyle=1,*Weight=MedThick
.Begin patch 4.2
.end patch 3.92
.end patch 3.85               
.
...
.Find Printer Aread
          ...
          call      GetWinVer
          if        (flatflag = 2)
          display   *P01:07,"Print File  : Excel"
          goto      Prestart
          endif
          if        (PDFFLAG = 2)
.begin patch 4.01                   
...
.            MOVE      "(LCR)" TO CANTEXT
.end patch xxx per SA 20130may 24
...
.End PATCH 3.84 
          ...
          PRTPAGE   Laser;*p=1:row,DATEPRT1:
                    ...
                    *p=1575:row,olrn:
                    *p=2094:row,Client:
                    *p5000:row,*alignment=*right,Numprt1:
                    *p5600:row,*alignment=*Left,enttext:
.                    *p5625:row,*alignment=*right,numprt2,*alignment=*Left:
                    *p=6775:row,DatePrt2:
                    *p=7765:row,DatePrt3
          add       sixlpi,row
          ...
          add       sixlpi,row
          PRTPAGE   Laser;*p=2094:row,O2Des:
...
.                   *N,*34,O2DES,*72,PPMPRT,NMODDESC,prtnet
          ...
          PRTPAGE   Laser;*p=1:row,DATEPRT1:
                    ...
                    *p=2094:row,Client:
                    *p=3824:row,TaxPrt:
                    *p5000:row,*alignment=*right,Numprt1,*alignment=*Left,b1,enttext:
                    *p5625:row,*alignment=*right,numprt2,*alignment=*Left:
                    *p=6775:row,DatePrt2:
                    *p=7775:row,DatePrt3
          add       sixlpi,row
          ...
          add       sixlpi,row
          PRTPAGE   Laser;*p=2094:row,O2Des:
                    *p5000:row,*alignment=*right,ppmprt1,*alignment=*Left,prtnet
...
.                                        copyrite,"1981-2016, Names in the News"
.end patch 4.02
.end patch 3.87
...
....xxx
          Reset     Levels
          if        (levels = "orders@mmidirect.com")
          Pack      MailTO from levels,",creques@nincal.com"
          move      "MMI Weekly ORDER File",MailSubjct
          move      "KrsniWatkins@nincal.com",MailCC
...
.begin patch 4.0
          ...
          add       sixlpi,row
          PrtPAge   Laser;*p=1:row,"(",OLNUM,")",*p=4250:row,*alignment=*center,"LISTS USAGES OF LIST:",*alignment=*Left,*p=7250:row,"PAGE:":
                    *alignment=*right,*p=8160:row,PAGE,*alignment=*left
          add       sixlpi,row
          add       sixlpi,row
          PrtPAge   Laser;*p=4250:row,*alignment=*center,LISTNAME,*alignment=*Left
...
.Begin patch 4.0
         add       sixlpi,row
          add       sixlpi,row
          PrtPAge   Laser;*p=4250:row,*alignment=*center,Levels,*alignment=*Left
...
.begin patch 4.0
          add       sixlpi,row
          add       sixlpi,row
          PrtPAge   Laser;*p=1:row,"ORDER",*p=1075:row,"CLIENT",*p=5250:row,"ORDERED",*p=6775:row,"MAIL",*p=7775:row,"RETURN"
          add       sixlpi,row
          PrtPAge   Laser;*p=1:row,*ULON," DATE",*p=1075:row,"PO",*p=1575:row,"LR##",*p=2094:row,"MAILER DESCRIPTION",*p=4500:row,"PRICE":
                    *p=5250:row,"QUANTITY",*p=6000:row,"LIST KEY",*p=6775:row,"DATE",*p=7775:row,"DATE",*ULOFF
.         PRINT        *N,*06,"ORDER":
.                      *15,"CLIENT":
.                      *85,"ORDERED":
.                      *118,"MAIL":
...
.begin patch 4.0
          ...
          PrtPAge   Laser;*p=1:row,"CONFIDENTIAL",*p=3250:row,compnme,*p=7250:row,"DATE:":
                    *alignment=*right,*p=8160:row,TODAY,*alignment=*left
          add       sixlpi,row
          PrtPAge   Laser;*p=1:row,"(",OLNUM,")",*p=3375:row,"REPORT OF USAGES OF LIST:",*p=7250:row,"PAGE:":
                    *alignment=*right,*p=8160:row,PAGE,*alignment=*left
          add       sixlpi,row
          add       sixlpi,row
          PrtPAge   Laser;*p=4250:row,*alignment=*center,LISTNAME,*alignment=*Left
          add       sixlpi,row
          add       sixlpi,row
          PrtPAge   Laser;*p=1:row,"ORDER",*p=1075:row,"CLIENT",*p=5250:row,"ORDERED",*p=6000:row,"SHIPPED",*p=6775:row,"MAIL",*p=7775:row,"RETURN"
          add       sixlpi,row
          PrtPAge   Laser;*p=1:row,*ULON," DATE",*p=1075:row,"PO",*p=1575:row,"LR##",*p=2094:row,"CLIENT/OFFER/SELECTION",*p=4500:row,"PRICE":
                    *p=5250:row,"QUANTITY",*p=6000:row,"QUANTITY",*p=6775:row,"DATE",*p=7775:row,"DATE",*ULOFF
...
.begin patch 4.0
          ...
          PrtPAge   Laser;*p=1:row,"ORDER",*p=1075:row,"CLIENT",*p=5250:row,"ORDERED",*p=6775:row,"MAIL",*p=7775:row,"RETURN"
          add       sixlpi,row
          PrtPAge   Laser;*p=1:row,*ULON," DATE",*p=1075:row,"PO",*p=1575:row,"LR##",*p=2094:row,"Broker/OFFER/SELECTION",*p=4500:row,"PRICE":
                    *p=5250:row,"QUANTITY",*p=6775:row,"DATE",*p=7775:row,"DATE",*ULOFF
...
.begin patch 4.1
          pack      str12,"X",str9
          setprop   sheet.Range(str12),*Value=ORTNNUM
          move      ORTNNUM,NRTNFLD
          move      "Process1-NRTNKEY",Location
          pack      KeyLocation,"Key: ",NRTNFLD
          call      NRTNKEY
          pack      str12,"Y",str9
          setprop   sheet.Range(str12),*Value=RTCOMP
.end patch 4.1
.Begin patch 4.2
           packkey  cnctfld4 from obrknum,OBRKCNT
          move      "Process1-cnctKEY2",Location
          pack      KeyLocation,"Key: ",cnctfld4
           Clear      CNCTEMAIL
           CLear      CNCTFNAME
          call      CNCTKEY2
          pack      str12,"Z",str9
          setprop   sheet.Range(str12),*Value=CNCTEMAIL
          pack      str12,"AA",str9
          setprop   sheet.Range(str12),*Value=CNCTFNAME
.end patch 4.2
