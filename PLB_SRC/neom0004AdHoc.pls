...
.
         ...
         MOVE      "ADHOC INVOICE REGISTER" TO STITLE
...
BEGIN
         DISPLAY   *P10:11,"Sorting 'new' Invoices: "
          pack      str4 from Sysyr,sysmo
          rep       zfill in str4
          Pack      Taskname from "\\nins1\e\data\text\Nininv.dat,\\nins1\e\data\Nininv.New;124-129,S=#"132='",str4,"'#""
...
.  
NEWBUS
.2016 Marc 1 DLH turn off this Jose bullshit
.                match     "M",src
...
OWNPREP  MOVE      OLON TO OWNKEY
         ...
         write     clninv,seq;*cdfon,"Mailer ##","Lr##","Inv##","Prepay","Owner","Brk Guar":
           ...
           pack       str10a from chk1dtem,"/",chk1dted,"/",chk1dtec,chk1dtey
...
.needs previous year if $ its not new
                 ...
                 pack    nrevfld from "EB","00",Cidr,"2014"            ....YEARLY
                 else

                 pack    nrevfld from "RB","00",cidr,"2014"
.end patch 3.81
                 endif
                 call    nrevkey
                 return
