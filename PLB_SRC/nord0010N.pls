...
.         XIF
...............................................................................
Release  init      "4.24"              DLH remove Kelly
...
.END PATCH 4.12 ADDED LOGIC
         MOVE      "NORD0010N" TO PROGRAM
         MOVE      "EXIT" TO PF5
         MOVE      "Names in the News - Only" TO COMPNME
         MOVE      "NIN ORDER ANALYSIS PROGRAM" TO STITLE
         move      c1 to v
         TRAP      Stop IF F5
         CALL      PAINT
...
.
         ...
         OPEN      Results,"ordstatsN",exclusive
         TRAPCLR   IO
...
.begin patch 4.2
          if        (Ocompid = "P" or OCompId2 = "P")          .if pacific lists skip         
          goto        read1
          endif
.End patch 4.2
...
.
.begin patch 4.15
          Move      "Here is your NIN order history PDF File",MailSubjct
.begin patch 4.16
...
.         Move      "JoseDuenas@nincal.com,Dherric@nincal.com,LynBunch@nincal.com",MailTo
          Move      "Dherric@nincal.com,SusanAnstrand@nincal.com,JenniferDeerr@nincal.com",MailTo
.end patch 4.22
.end patch 4.16
.         Move      "DavidHerrick@nincal.com",MailTo
          Move      Str55,MailBody
          MOve      "c:\work\pdf\ordprtN.pdf",MailAttach
          call      SendMail
...
ERR      DISPLAY   *P1:1,*ES,"RANGE ERROR :",ERROR;
         ...
         GOTO      ERR
NOfile
         prepare   results,"\\nins1\e\data\text\OrdstatsN.dat","\\nins1\e\data\index\OrdstatsN.isi","6","62",exclusive
...
IO       DISPLAY   *P1:24,*EL,"IO ERROR ",ERROR;
         STOP
SendDaveEmail
          Move      "Nord0010N - Alert",MailSubjct
           Clear     MailFrom
           Clear    MailAttach
           If       (user = " " or user = "")
