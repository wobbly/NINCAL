...
..	OPEN    REDFILE,"\\nins1\e\data\dbase\revenue"
   	prepare    NEWFILE,"c:\work\revenue.0506"
*.==========================================================================
...
.Check to see if Clients meet criteria for Report
        branch  loopflg to Brkchk,brkchk
Brkchk
        if      (loopflg =2)
		  move    "M" to typer
		  else
...
.===================================================================================
                if (loopflg = c2)
                goto    listview
.New code to force adding of new year for 2nd pass of listmgnt.
                    if (NEWTOT > C0)
		        unpack  nrevfld,type,src,cid,yr0
