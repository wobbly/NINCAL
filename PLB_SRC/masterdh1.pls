...
main
	...
	Move	No,ClntServFlag
	else
	Move	Yes,ClntServFlag
	endif
...
;                          "C A L I F O R N I A":
                   ...
                   *WHITE,*DIOFF
         XIF
         DISPLAY   *P01:07," 1...ORDER ENTRY & INQUIRY":
                   *P01:08," 2...INVOICE ENTRY & INQUIRY ":
                   *P01:09," 3...FULFILLMENT ENTRY & INQUIRY ":
                   *P01:10," 4...DATA CARD ENTRY & INQUIRY":
                   *P01:11," 5...SHIPMENT ENTRY & INQUIRY":
                   *P01:12," 6...CASH RECEIPT/ADJUSTMENT PROGRAM":
                   *P01:13," 7...MAILER FILE MAINTENANCE":
                   *P01:14," 8...program offline":
                   *P01:15," 9...LIST OWNER FILE MAINTENANCE":
                   *P01:16,"10...Booking Instructions":
                   *P01:17,"11...DATA CARD (LIST) REQUESTS":
                   *P01:18,"12...ORDER MERGE INQUIRY":
                   *P42:07,"13...BILL-TO FILE MAINTENANCE":
                   *P42:8,"14...PAY-TO FILE MAINTENANCE":
                   *P42:9,"15...RETURN-TO FILE MAINTENANCE":
                   *P42:10,"16...ORDER HISTORY PIC PROGRAM":
                   *P42:11,"17...CALCULATOR PROGRAM":
                   *P42:12,"18...LIST APPROVAL PROGRAM":
                   *P42:13,"19...RUNNING EXCHANGE CHARGES PROGRAM":
                   *P42:14,"20...EXCHANGE STATUS INQUIRY":
                   *P42:15,"21...Test O' the Day            ":
                   *P42:16,"22...invoice l/o # mod program  ":
                   *P42:17,"23...LIST USAGE INQUIRY PROGRAM ":
                   *P42:18,"24...Marketing List Maint":
...
;                   *P01:10,"25...LIST APPROVAL REQUEST USAGE PROG":
...
;                   *P62:24,"Day    : ",DAY
          DISPLAY   *P01:07,"25...CORRECTION/CANCELLATION PROGRAM":
.         DISPLAY   *P01:07,"25...LIST APPROVAL REQUEST USAGE PROG":
                   *P01:08,"26...MAILDATE SCHEDULE PROGRAM ":
                   *P01:09,"27...BROKER CALL PROGRAM ":
.START PATCH 2.93 REPLACED LOGIC
.                   *P01:10,"28... ":
                   *P01:10,"28...Mailer/Mailer Notes Program":
.END PATCH 2.93 REPLACED LOGIC
.                   *P01:10,"28...CORRECTION/CANCELLATION PROGRAM ":
                   *P01:11,"29...APPROVAL SUMMARY PROGRAM  ":
                   *P01:12,"30...REINSTATE DATACARDS ":
                   *P01:13,"31...Promotional Fax":
                   *P01:14,"32...MARK ORDERS BILLED":
                   *P01:15,"33...Client Credit History":
                   *P01:16,"34...Broker/Consultant/Mailer/Offer":
                   *P01:17,"35...CHECK INFORMATION MAINT.":
                   *P01:18,"36...List Owner Payable Account":
                   *P42:07,"37...Mailer payment inquiry":
                   *P42:08,"38...TELECOMMUNICATION MAINT. MENU":
                   *P42:09,"39...TDMC BILLING PROGRAM":
                   *P42:10,"40...List Management Order Reports":
                   *P42:11,"41...MAIL PLANNER PROGRAM":
                   *P42:12,"42...Money on account":
                   *P42:13,"43...Amount Due":
                   *P42:14,"44...Request For Counts":
                   *P42:15,"45...Suppression Report":
                   *P42:16,"46...":
.START PATCH 2.94 ADDED LOGIC
                   *P42:17,"47...Sample Scanning Program":
.END PATCH 2.94 ADDED LOGIC
                   *P01:19,*HON,"(F1 for Page 1)",*HOFF:
                   *P01:20,"(F6 NIN Intranet)":
                   *P01:21,"(F7 NIN Website)":
                   *P42:19,"(F3 to Exit Menu)":
                   *P42:20,"(F4 for ext. directory)":
...
;                          "C A L I F O R N I A":
                   *P70:3,"PAGE THREE":
                   *P23:4,"O P E R A T I O N S   P L B   M E N U":
                   *WHITE,*DIOFF
         XIF
...
NAPR0001 MOVE      "APPROVAL",LOGINFO
         CALL      LOGWRITE
         CHAIN     "NAPR0001"
Ndat0009 MOVE      "NDAT0009",LOGINFO
         chain     "Ndat0009"
         winshow
...
Piferror
              noreturn
              move             C0,Soundflag           ;if does not exist turn off
              goto            AfterPif
