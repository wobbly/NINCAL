...
.End
	 ...
	 Move	c0 to DateToOld
               if	(LincYear <> 0)
               move	Lincyear to str4
               unpack	str4 into str2,yy
               move	Lmonth to MM
               call	cvtjul
...
NlOINC0007TabChange
        IF (N1 = C1)
                ...
                move    C2,TabNum
                Activate NLoincb
	 setprop 	NLOINC0007bButton002,Visible=0
	 setprop 	NLOINC0007bButton001,Visible=1
	 setprop 	NLOINC0007bButton002,Enabled=0
	 setprop 	NLOINC0007bButton001,Enabled=1
...
LoadListView
                                             ...
                                             clear str4
                                             MOve	Lincyear,str4
                                             NLOINC0007aListView001.SetItemText using IN9,str4,8
                                             MOve	LincRecID,str6
...
VerifyRep
	...
	sub	Lincyear,LincYear
              ...
              Getitem	NLOINC0007EditText002,0,str4
              Move	str4,Lincyear
              count	N2,str4

              if	(n2 > 1 & N2 < 4)
             	alert   caution,"Starting year format CCYY",result
...
VerifyRepAbort
	setprop   NLOINC0007aButton002,Enabled=1            .save
        	setprop   NLOINC0007aButton002,Visible=1            .save
	Setprop   NLOINC0007aButton003,Enabled=0            .add 
	setprop   NLOINC0007aButton003,Visible=0            .add 
