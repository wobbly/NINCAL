...
//        include   nfuldd.inc
          ...
          Include Cntdd.inc   
//Patch 3.8.9       
Release   Init      "3.8.9" DMB   09SEP2006 Fulfillment Conversion
.Release  Init      "3.8.8" DLH Update "Lotus" version
...
;
         ...
         MATCH     "NDAT0055" TO PROGRAM       .CHAINED FROM DSINIT WITH INFO?
         IF        not equal                 .NO
         MOVE      "NDAT0055" TO PROGRAM
...
.End Patch 3.8.3
            ...
            write     htmlfile,seq;"                <option value=#"index.php/contact-us/#">Contact</option>"
            ...
            write     htmlfile,seq;"          </tr>"
            write     htmlfile,seq;"          <tr>"
            write     htmlfile,seq;"            <td> <a href=#"index.php/contact-us/#" onMouseOut=#"MM_swapImgRestore()#" onMouseOver=#"MM_swapImage('Image8','','/images/navLeft_ON_04.gif',1)#"><img src=#"/images/navLeft_OFF_04.gif#" alt=#"Contact#" name=#"Image8#" width=#"130#" height=#"30#" border=#"0#"></a></td>"
            write     htmlfile,seq;"          </tr>"
            write     htmlfile,seq;"          <tr> "
...
.End Patch 3.8.3
            ...
            write     htmlfile,seq;"          </tr> "
            write     htmlfile,seq;"          <tr> "
            write     htmlfile,seq;"            <td> <a href=#"index.php/contact-us/#" onMouseOut=#"MM_swapImgRestore()#" onMouseOver=#"MM_swapImage('Image8','','/images/NnavLeft_ON_04.gif',1)#"><img src=#"/images/NnavLeft_OFF_04.gif#" alt=#"Contact#" name=#"Image8#" width=#"130#" height=#"30#" border=#"0#"></a></td>"
            write     htmlfile,seq;"          </tr>"
            write     htmlfile,seq;"          <tr>"
            write     htmlfile,seq;"            <td> <img src=#"/images/navLeft_OFF_05.gif#" width=#"130#" height=#"3#" alt=#"#"></td>"
            write     htmlfile,seq;""
...
//                  move      str4,nownfld
//                  call      nownkey
//                  Packkey   Nfulfld,ownctn
//                  move      C1,NFULPATH
//                  move      "Driver-NFULKey",Location
