...
release  init      "2.6"        DLH reactivated
...
.
         PACK      TASKNAME,NTWKPATH1,"INDEX\DUPEOWN"
         OPEN      DUPEOWN,TASKNAME,READ
         display   *p1:24,*el,"opening elim own";
         PACK      TASKNAME,NTWKPATH1,"INDEX\ELIMOWN"
         OPEN      ELIMOWN,TASKNAME,READ
         display   *p1:24,*el,"opening elim list";
         PACK      TASKNAME,NTWKPATH1,"INDEX\ELIMLIST"
         OPEN      ELIMLIST,TASKNAME,READ
...
.         PREPARE   OUTPUT,"g:\DATA\CARDupd.CAL"
         PACK      TASKNAME,NTWKPATH1,"CARDupd.CAL"
...
.begin patch 2.6
.         PACK      TASKNAME,"c:\command.com /c copy ",NTWKPATH1,"cardupd.cal ",NTWKPATH1,"cardupd.dat"
.         EXECUTE   TASKNAME
          Copyfile  "\\nins1\e\data\cardupd.cal","\\nins1\e\data\cardupd.dat"
.end patch 2.6
.END PATCH 2.4 REPLACED LOGIC
...
.         EXECUTE   TASKNAME
          Index     "\\nins1\e\data\cardupd.dat,\\nins1\e\data\cardupd.isi -2-7,s,c"
.end patch 2.6
.END PATCH 2.4 REPLACED LOGIC
         IF        OVER
...
.START PATCH 2.4 REPLACED LOGIC
.         PREPARE   OUTPUT,"g:\DATA\CARDUPD.CAL"
         PACK      TASKNAME,NTWKPATH1,"CARDUPD.CAL|nins1:502"
         PREPARE   OUTPUT,TASKNAME
.END PATCH 2.4 REPLACED LOGIC
         GOTO      A100
....................................................................
