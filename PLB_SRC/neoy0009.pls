...
.end patch 1.9
.
RElease   Init      "2.81"    DH internal sort
...
. .............................................................................
         TRAP      ABORT IF F5
         MOVE      "EXIT" TO PF5
         MOVE      "NEOY0009" TO PROGRAM
         MOVE      "CLIENT INCOME BY MONTH / BY TEAM" TO STITLE
...
.
         ...
         MOVE      date TO DATEMASK
         GOTO      DATEDIS
.patch for DH Run of 2001 Dates
BEGIN
Putin
         KEYIN     *P12:12," Put in LR >> ",*T05,NINVFLD;

         KEYIN     *P12:12,*DV,NINVFLD,"  This It? ",*T05,str1;
          goto putin if (str1 <> YES)
.patch for DH Run of 2001 Dates
         CALL      NINVTST
.patch for DH Run of 2001 Dates
         GOTO putin if over
...
.                       pack      taskname from NTWKPATH2,"sort32 ","\\nins1\e\data\income2.dat ","\\nins1\e\data\income2.srt ":
.                         "/s (158,13,n,d)"
          pack      taskname from "\\nins1\e\data\income2.dat,\\nins1\e\data\income2.srt,c:\work ":
                              "-d168-180"         
          Sort      Taskname
.                      execute   taskname
.end patch 2.81
