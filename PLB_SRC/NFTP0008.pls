PC      EQU     0
        ...
        include CONS.INC
.========================================================================================
         MOVE      "NFTP0008" TO PROGRAM
         MOVE      "SOLO FTP PROGRAM" TO STITLE
...
;.        call Paint
        ...
        OPEN FTPTMP,"SOLOFTPTMP"
        OPEN FTPSAV,"FTPSAV8",EXCLUSIVE
        PREPARE FTPDWN,"\\nins1\E\DATA\SOLOftpdwn"
          Clear     Mailbody
...
OVERNOW
   Display    *P10:11,*EF,*White,"Job Complete!!"
          If (n2 = c0)
                  ...
                  Close FTPDWN
                  pack  taskname,NTWKPATH1,"SoloFtpdwn.DAT"
                  erase TASKNAME
          Move      "No SOLO Files to Download.",MailSubjct
   ...
   Close   FTPTMP
   pack    taskname,NTWKPATH1,"SOLOFtpTMP.DAT"
   erase   taskname
   Pause   C5
   STOP
ForeignFile
          Move      "There is an unrecognized file on the SOLO FTP Site. Please Verify",MailSubjct
          Move      "ComputerRequest@nincal.com",MailFrom
          Move      "Dherric@nincal.com",MailTo
