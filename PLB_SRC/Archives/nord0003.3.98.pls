...
NOHD     COMPARE   C55 TO PRTLINES
         ...
         RETURN
         XIF
MLRTOTLS COMPARE   C57 TO PRTLINES
         CALL      HEADING IF NOT LESS
...
.end patch 3.96
         ...
         return
.
BRKTOTLS COMPARE   C57 TO PRTLINES
         CALL      HEADING IF NOT LESS
         MOVE      NUMMASKB TO NUMPRT1B
...
.begin patch dh add copyrite
                    ...
                    Pack      Taskname from "=Hyperlink(#"http://www.namesinthenews.com#",#"© 1981-2013, Names in the News#")"
...
;dh goes bad               
               setprop        sheet.Range("S8"),*Value="Sales Person ##"
               setprop        sheet.Range("T8"),*Value="Mailer"
               setprop        sheet.Range("U8"),*Value="Broker/Consultant"
;dh goes bad               
.
               setprop xlRowHeight,VarValue="27.0"
               setprop        sheet.range("A8:S8").Rows,*RowHeight=xlRowHeight
