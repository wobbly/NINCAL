...
release init    "1.1"                   12JUN2007 ASH       PLI Inclusion
...
.                              endif
                               getitem ComboBoxes(4),0,N8
                               if (N8 = 2)        .Pacific Lists
                                        move      "P",NUSECOMP
                               else               .NIN
                                        move      "C",NUSECOMP
                               endif
                               getitem ComboBoxes(2),0,N8
                               if (N8   = 1)
                                         call      OrderCreateCampaign using NCMPFLD,ComboBoxes(3),userlogn,NUSECOMP
                               elseif   (N8 = 2)
                               //Spreadsheet does not use Logo or Title - also, it is pretty much obsolete
                                         call      OrderCreateCampaignA using NCMPFLD,ComboBoxes(3),userlogn
                               elseif   (N8 = 3)
                                         call      OrderCreateCampaignB using NCMPFLD,ComboBoxes(3),userlogn,NUSECOMP
                               endif
.END PATCH 1.1 REPLACED LOGIC
                    endif
          endif
...
.Called   by Reports menu, Campaign submenu
          setprop   Report2,title="NIN Campaign Report"                     .DH 2010March17
...
.         create    Report2;StatTextBoxes(5)=90:110:10:310,"Report Type",""
          ...
          create    Report2;StatTextBoxes(2)=50:70:10:110,"Printer",""
          create    Report2;StatTextBoxes(5)=70:90:10:310,"Report Type",""
          create    Report2;StatTextBoxes(6)=90:110:10:310,"Corporate Logo",""
.END PATCH 1.1 REPLACED LOGIC
...
.         create    Report2;ComboBoxes(2)=90:111:80:310,"",";S)tandard;)TNC;)NWF//UNICEF"
          ...
          create    Report2;ComboBoxes(1)=50:71:80:310,"",";P)rint to File;)Laser 3;).PDF File;)Laser 2"
          create    Report2;ComboBoxes(2)=70:91:80:310,"",";S)tandard;)TNC;)NWF//UNICEF"
          create    Report2;ComboBoxes(4)=90:111:120:310,"",";N)IN;)PLI"
.END PATCH 1.1 REPLACED LOGIC
...
.Establish default Corporate Logo, which user can change
          ...
          if (NUSECOMP = "P")
                    setitem   ComboBoxes(4),0,C2
          else
                    setitem   ComboBoxes(4),0,C1
          endif
.END PATCH 1.1 ADDED LOGIC
