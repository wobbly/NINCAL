.//This version doesn't upload properly
...
.//		Start over.  Skip those.
		...
		GOTO Main IF (NFTPPROTOCOL = "FTPS_IMPLICIT")	.//We use these two.  Commented out.
		GOTO Main IF (NFTPCOMP = "009428")		.//We use these two.  Commented out.	
		CALL InitMySiteVars
		CALL OpenSite
		CALL Transfer
		CALL DisconnectSite
