...
;           open               NINvfile,NINVNAME
           move               c1 to ninvflag
;           Prepare            NINvAcdFile,"\\nins1\e\data\text\NINInvAcd.dat","\\nins1\e\data\index\NINInvAcd.isi","9","49",exclusive
           ...
           Prepare            PInvFile,"\\nins1\e\data\NINVoiceDev.dat","\\nins1\e\data\index\NINvoiceDEv.isi","6","303"
           move               c1 to NInvAcdflag
Looper         CAll           Ninvks
               goto           eoj if over
breakit        add            c1 to count
               display        *p10:10,"Records read ",count,b1,invnum
               if             (InvDtey = "05" and INvdtem = "08")
               goto	looper
               endif
