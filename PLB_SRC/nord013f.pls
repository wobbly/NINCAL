...
.end patch 1.53
.
Release   Init      "2.37"            DLH Use date from Dsprog.dat at EOM
Reldate   Init      "29 Jan 2010"
.Release   Init      "2.36"            DLH New year.
.Reldate   Init      "4 Jan 2010"
.Release   Init      "2.35"            DLH Merge PL data back into NIN
.Reldate   Init      "14 Dec 2009"
...
.         move      "686400" to nordfld               .1st lr of 2009
         move      "770000" to nordfld               .lr in 2012
.end patch 2.34
         call      nordkey
         ADD       C1 TO COUNTO
...
.start patch 1.7
         ...
         Call      DateTest
         if           (dateflag = c1)           .invalid date cannot check
         goto         billed
         endif
         call      cvtjul
