...
.         pack DateString,mm,slash,dd,slash,cc,yy
        ...
        create  Red=255:0:0
         ...
         Pack      Str55,NTWKPATH1,"mrgeskip.ped|10.10.30.103:502"
.          pack      Taskname,"e:\data\text\mrgeskip.ped|10.10.30.103:502"
.         Open      skipped,STR45
         Open      skipped,"e:\data\text\mrgeskip.ped|10.10.30.103:502"
...
.                                                OPEN      INPUT,InputName
                                        	if (COMPHOLD = "009413" & ExInputFlag = yes ) .Trylon
...
.begin patch 1.7
                                        ...
                                        call      debug
.                                        .1)lr, 2)list code, 3)list name, 4)date recvd, 5)status, 6)notes, 7)list pty, 8)list code, 9)order qty, 10)gross input, 11)total omits, 12)total errors,
