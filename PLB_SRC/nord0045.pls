...
.Release   Init      "1.5"    DLH       cleanup filter functions
.Reldate   INit      "30 NOvember 2012"
...
ToDateB   form      8
RecType   dim       1
RepType   dim       1                   .0=Cancelled & Denied, 1=Cancelled Only,2=Denied only
...
.END PATCH 1.1 ADDED LOGIC
                    ...
                    pack      str10,"H",str9
                    Clear     str12
                    pack      str12 from oodtem,slash,oodted,slash,oodtec,oodtey
                    setprop   sheet1.range(str10),*Value=str12
...
. get exel version info
          ...
          ENDIF
          if        (#ver = c1)
         Pack      Taskname with "c:\work\Cancelled Denied Report.xlsx"
          else
         Pack      Taskname with "c:\work\Cancelled Denied Report.xls"
          endif
...
OrderWriteRecords
          if (DeptType = "2" & OSALES10 = "0" & OSALES = "6")
                    return
          endif
          move      C0,N8
.START PATCH 1.1 REPLACED LOGIC
.         if (DateType = "0") .Use Denied/Approval Date as Default
          if (DateType = "0" & RecType <> "4")    .Use Denied/Approval Date as Default
.END PATCH 1.1 REPLACED LOGIC
...
.         if (N8 = C0 OR (N8 >= FromDateB AND N8 <= ToDateB))
          ...
          Move      Howmany,str10
          setitem   NORD0045StatRecords,0,str10
          return
...
.
          ...
          pack      str10,"H",str9
          setprop sheet1.range(str10),*Value="Date Entered"
          pack      str10,"I",str9
...
.
        ...
        move    n3 to PRIMTRACE                 .What are we catagory are we searching under?
          ...
          Move      c0,reptype                  .for now default cancelled or denied
