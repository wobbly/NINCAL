...
.		Write	htmlfile,seq;"<BODY BACKGROUND=#"\\nts2\c\http\datacards\data_gradient.jpg#" text=#"##777777#" link=#"##2759A6#" vlink=#"##748EB8#" alink=#"##2759A6#">"
		Write	htmlfile,seq;"<BODY BACKGROUND=#"\\nts0\c\netutils\images\data_gradient.jpg#" text=#"##777777#" link=#"##2759A6#" vlink=#"##748EB8#" alink=#"##2759A6#">"
.>Patch 1.2 Code Modified End
	else
		Write	htmlfile,seq;"<BODY BACKGROUND=#"data_gradient.jpg#" text=#"##777777#" link=#"##2759A6#" vlink=#"##748EB8#" alink=#"##2759A6#">"
	endif
.Patch 1.1.5
...
WritePLILogo
	...
	write	htmlfile,seq;"1300 Clay Street, 11th floor"
	write	htmlfile,seq;"Oakland, CA 94612-1429"
...
.................................
	if (externalmode)
		...
		append	lstnum to str55
		append	".htm" to str55
		reset	str55
		rep	zfill in str55
		erase	str55
		trap ExtTrap if IO
		prepare	htmlfile,str55,exclusive
		trapclr IO
	else
