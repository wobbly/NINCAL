...
.release   init    "9.91"     DLH  suppres LCRS from printing when pringing from Mailer/Owner/manager copies from "diskin" files
...
Sortmlr             Display   *p1:22,*el,"sorting Nprint.dat to Nprint.tmp"
...
.file for Owner pass
SortOwn             Display   *p1:22,*el,"sorting Nprint.dat to Nprint.own"
.begin patch 10.00  add NIN contact
...
SortFul             Display   *p1:22,*el,"sorting Nprint.own to Nprint.Ful"
.begin patch 10.00  add NIN contact
...
sortLR              Display   *p1:22,*el,"sorting Nprint.dat to Nprint.LR"
.begin patch 10.00  add NIN contact
...
.non LM first
SortBrk             Display   *p1:22,*el,"sorting Nprint.dat to Nprint.TMP"
.begin patch 10.00  add NIN contact
...
Rerun
                    ...
                    pack      KeyLocation,"SEq "
                    trap      IOMssg giving Error if IO
                    open      INPUT,"\\NinS1\e\data\NPRINT.TMP|10.10.30.103:502"
...
.Prep for Owner run
                                        ...
                                        pack      KeyLocation,"SEq "
                                        trap      IOMssg giving Error if IO
                                        open      INPUT,"\\NinS1\e\data\NPRINT.OWN|10.10.30.103:502"
...
.Prep for Fulfillment run     
                                        ...
                                        pack      KeyLocation,"SEq "
                                        trap      IOMssg giving Error if IO
                                        open      INPUT,"\\NinS1\e\data\NPRINT.FUL|10.10.30.103:502"
...
.Prep for Office run, which includes creation of file for Overlay run
                                        ...
                                        pack      KeyLocation,"SEq "
                                        trap      IOMssg giving Error if IO
                                        open      INPUT,"\\NinS1\e\data\NPRINT.LR|10.10.30.103:502"
...
.Prep for Overlay run
                                        ...
                                        call      FindFirstFile
                                                  ...
                                                  open      INPUT,"\\NinS1\e\data\NPRINT.OVR|10.10.30.103:502"
...
.                    pack      MailTo,"JamieMittone@nincal.com"
                    pack      MailTo,"CarolFrazer@nincal.com,LauraDeBarros@nincal.com,KrsniWatkins@nincal.com"
...
.                              Else
                              ...
                              append    CRLF,Mailbody
                              append    "180 Grand Ave. Suite 1545",Mailbody
                              append    CRLF,Mailbody
                              append    "Oakland, CA 94612-3784",Mailbody
                              append    CRLF,Mailbody
