...
.xxx
          ...
          if (CallFlag = 1)
                    ...
                    move      "OWNER",COMMENT
                    pack      INITS,DimPtr1
                if (PrintFlag = C0 | PrintFlag = 1)     .Laser2 = Default
                        if (osflag = c1 | Osflag = C5 | osflag = c6)         .nt win2k Xp
                                PRTOPEN DataCardPrint,"\\SRV2008a\laser2","dataprnt.lst"
                        elseif (osflag = c3 | OSflag =c4)         .win 95 98
                                PRTOPEN DataCardPrint,"Laser2","dataprnt.lst"
                ...
                elseif (PrintFlag = 2)  .Laser3
                        if (osflag = c1 | osflag = C5 | osflag = c6)         .nt 2k xp
                                PRTOPEN DataCardPrint,"\\SRV2008a\laser3 Blankstock","dataprnt.lst"
                        elseif (osflag = c3 | osflag =c4)         .win 95 98
