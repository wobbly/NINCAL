...
COLDBAP   FORM        9.2      New Biz BR AP
COLDLAP   FORM        9.2      New Biz LM AP
COLDLAR   FORM        9.2      New Biz LM AR
R14ColdBR FORM        9.2      New Biz BR AP Adv pay
R14ColdLM FORM        9.2      New Biz LM AP Adv Pay
.end patch xxx
...
.begin patch 4.62
          If        (Sls = "02" or Sls = "06" or Sls = "19" or Sls = "27" or Sls = "28") .list man
                      if         (NewBiz = Yes)
                      add       FaPt to R14ColdLM
                      else
                      add       FaPt to R14LM
                      endif
          else
                      if         (NewBiz = Yes)
                     add       Fapt to R14ColdBR
                      else
                     add       Fapt to R14BR
                     endif
          endif
...
.begin patch xxx
         ...
         call         NewBus  
           ...
           iF        (nEWbIZ = yES)
           Add        Fart,COLDBAR                      
           ADD        FAP1T    TO COLDBAP                      
           ADD        FAP2T    TO COLDBAP 
           else      
          ADD                 FART     TO TBAR
          ADD                 FAP1T    TO TBAP
          ADD                 FAP2T    TO TBAP
...
.begin patch xxx
         ...
         call         NewBus  
           iF        (nEWbIZ = yES)
           Add        Fart,COLDLAR                      
           ADD        FAP1T    TO COLDLAP                      
           ADD        FAP2T    TO COLDLAP 
           else      
          ADD                 FART     TO TLMAR
          ADD                 FAP1T    TO TLMAP
          ADD                 FAP2T    TO TLmAP
...
.end Patch 4.53
          ...
          add     eightlpi,row                 
.begin patch xxx          
                prtpage prfile;*pColumn:row,*ALIGNMENT=*Left,"Cold New BROKERAGE RENTAL: ";
                prtpage prfile;*pColumn4R:row,*ALIGNMENT=*Right,COLDBAR;                                       
                prtpage prfile;*pColumn5R:row,*ALIGNMENT=*Right,COLDBAP;                                                     
          add     eightlpi,row                 
                prtpage prfile;*pColumn:row,*ALIGNMENT=*Left,"Cold New Management: ";
                prtpage prfile;*pColumn4R:row,*ALIGNMENT=*Right,COLDLAR;                                       
                prtpage prfile;*pColumn5R:row,*ALIGNMENT=*Right,COLDLAP;                                                     
          add     eightlpi,row                 
.end patch xxx          
          ...
          add     eightlpi,row                                     
                prtpage prfile;*pColumn:row,*ALIGNMENT=*Left,*ll,"   Cold BRK AP CODE 14 TOTAL: ";                                       
                prtpage prfile;*pColumn3:row,*ALIGNMENT=*Right,*ll,R14;                   
          add     eightlpi,row                                     
                prtpage prfile;*pColumn:row,*ALIGNMENT=*Left,*ll,"   Cold LM  AP CODE 14 TOTAL: ";                                       
                prtpage prfile;*pColumn3:row,*ALIGNMENT=*Right,*ll,R14;                   
          add     eightlpi,row                                     
...
.begin patch 4.53
          ...
          Append    CRLF,MailBody                                               
.begin patch xxx
          append    "Cold AR Brokerage TOTALS       ",Mailbody
...
.begin patch 4.62         
          ...
          Append    CRLF,MailBody                                               
.end patch 4.62          
          append    "AP Cold Brokerage ADV Pay    ",Mailbody
          append    R14ColdBR,Mailbody
          Append    CRLF,MailBody                                               
          ...
          Append    CRLF,MailBody                                                      
.begin patch xxx
          append    "Cold AP Brokerage TOTALS       ",Mailbody
...
.end patch xxx
          ...
          Append    CRLF,MailBody                                               
.begin patch xxx
          append    "Cold AR Management TOTALS       ",Mailbody
...
.begin patch 4.62          
          ...
          Append    CRLF,MailBody                                               
.end patch 4.62
          append    "AP Cold Management ADV Pay    ",Mailbody
          append    R14ColdLM,Mailbody
          Append    CRLF,MailBody                                               
          ...
          Append    CRLF,MailBody                                                      
.begin patch xxx
          append    "Cold AP Management TOTALS       ",Mailbody
...
.begin patch xxx
        pack    RowNumber,"A","92"
        setprop sheet.range(RowNumber),*Value="Cold Brk AR Adj"
        pack    RowNumber,"B","92"
        setprop sheet.range(RowNumber),*Value=COLDBar
        pack    RowNumber,"A","93"
        setprop sheet.range(RowNumber),*Value="Cold Brk AP Adj"
        pack    RowNumber,"B","93"
        setprop sheet.range(RowNumber),*Value=COLDBap
        pack    RowNumber,"A","94"
        setprop sheet.range(RowNumber),*Value="Cold LM AR Adj"
        pack    RowNumber,"B","94"
        setprop sheet.range(RowNumber),*Value=COLDLar
        pack    RowNumber,"A","95"
        setprop sheet.range(RowNumber),*Value="Cold LM AP Adj"
        pack    RowNumber,"B","95"
        setprop sheet.range(RowNumber),*Value=COLDLap
        pack    RowNumber,"A","96"
        setprop sheet.range(RowNumber),*Value="Cold BR AP ADV Pay Adj"
        pack    RowNumber,"B","96"
        setprop sheet.range(RowNumber),*Value=R14ColdBR
        pack    RowNumber,"A","97"
        setprop sheet.range(RowNumber),*Value="Cold LM AP ADV Pay Adj"
        pack    RowNumber,"B","97"
        setprop sheet.range(RowNumber),*Value=R14ColdLM
...
NEWBUS
projread
. Projection Section Update Yearly!!
...
checkrev
           if         (NewBiz = yes)
                 ...
                 pack    nrevfld,type,src,cid,"2015" ......<<<<<<<<Yearly??????????????????????????
                 call    nrevkey
