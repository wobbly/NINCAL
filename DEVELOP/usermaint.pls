...
.//                                                                           //
.//              Release 1.7  23FEB2015  RVW  Only do RenderUniversalCSS and  //
.//                                           and RenderMenu                  //
.//              Release 1.6  15MAR2007  DLH  cgi servername MIA              //
...
.    Start Release 1.7 - comment out
.    CGIRenderHeader
.    End Release comment 1.7 - comment out
.    Start Release 1.7 - add
...
.            move "Unable to delete user account.  Please contact the webmaster." to errorMsg
            move "Unable to delete user account.  Please contact the <a href=#"#/contact.htm#";#"> website administrator</a>." to errorMsg
