...
.**********.686400 FIRST NIN LR OF 2010
         MOVE       "643810" TO NORDFLD            change every jan. previous yr.         
.end 12/31/09
.begin patch 1.71
.          CLOCK     DATE TO DATE
          if        (program = "NORD0030")
...
.                        PRTOPEN prfile,"\\SRV2008a\laser3 Blankstock",str25
                        PRTOPEN prfile,"\\SRV2008a\laser8",str25
...
.          PRTOPEN prfile,"\\SRV2008a\laser6",str25,noprint,spoolfile=str40
.         PRTOPEN prfile,"\\SRV2008a\laser6",str25,noprint,spoolfile=str40
        else
.          PRTOPEN prfile,"Laser6","List Mgmt Ref",noprint,spoolfile=str40
                if (osflag = c1 | osflag = C5 | osflag = c6)         .nt
.                        PRTOPEN prfile,"\\SRV2008a\laser3 Blankstock","List Mgmt Ref"
                        PRTOPEN prfile,"\\SRV2008a\laser8","List Mgmt Ref"
                elseif (osflag = c3 | osflag = c4)         .win 95 98
.                        PRTOPEN prfile,"laser3 Blankstock","List Mgmt Ref"
