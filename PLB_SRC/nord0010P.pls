...
.         XIF
...............................................................................
Release  init      "4.23"              JD    13Jan08 year 2009
.Release  init      "4.22"              DLH  09Jan08 send copies to SHerene,Joey
.Release  init      "4.21"              DLH  07Jan08 year 2008
.Release  Init      "4.2"          DLH 14March 2007  Pacific lists - this version excludes
...
.begin patch 4.23a -DLH
.FIRSTN   INIT      "010000"  Start here - what is the firstn lr really?
...
.END PATCH 4.12 ADDED LOGIC
         MOVE      "NORD0010P" TO PROGRAM
         MOVE      "EXIT" TO PF5
         MOVE      "Pacific Lists" TO COMPNME
         MOVE      "PL ORDER ANALYSIS PROGRAM" TO STITLE
         move      c1 to v
         TRAP      Stop IF F5
         CALL      PAINT
...
.
         ...
         OPEN      Results,"ordstatsP",exclusive
         TRAPCLR   IO
...
.begin patch 4.2
          if        (Ocompid = "P" or OCompId2 = "P")          .if pacific lists take it
.continue
          Else
          goto        read1
          endif
...
."27" = Sarah
."28" = Carolyn
          If        (salesnum = "27" or salesnum = "28" or Ocompid2 = "P")
          move      c2,salesbr
          else
          move      c1,salesbr
          endif
...
OK       BRANCH    SALESBR OF BRKAGE1,MANAGE1
         GOTO      BRKAGE1
OKEX
         BRANCH    SALESBR OF BRKAGE,MANAGE
.
...
.                    *p=column1a:1250,*PENSIZE=10,*line=column1b:1250
          ...
          prtpage   laser;*FONT=prtpg10,*p=1:150,"Confidential":
                    *p=4593:25,*font=fontO18b,"Pacific Lists, Inc.":
                    *p=5000:343,*font=fontO7,"1300 Clay St. 11th Floor":
                    *p=4900:443,"Oakland, CA 94612-1429":
                    *p=4835:543,"415-945-9450 ","·"," Fax 415-945-9451":
                    *p=4835:643,"A Division of Names in the News":
                    *FONT=prtpg10,*P=9500:150,"DATE: ",tODAY:
.                   *p=1475:1100,"2000":
.                   *p=3225:1100,"2001":
.                   *p=4975:1100,"2002":
...
.                                if (time3 > 5500)           .50 Seconds Maximum           .....Telecomm is a pud
...
.
.begin patch 4.15
          Move      "Here is your PL order PDF File",MailSubjct
.begin patch 4.16
...
.         Move      "JoseDuenas@nincal.com,Dherric@nincal.com,LynBunch@nincal.com",MailTo
          Move      "Dherric@nincal.com,ShereneKelly@nincal.com,JenniferDeerr@nincal.com",MailTo
.end patch 4.22
          Move      "Dherric@nincal.com",MailTo
.end patch 4.16
.         Move      "DavidHerrick@nincal.com",MailTo
          Move      Str55,MailBody
          MOve      "c:\work\pdf\ordprtP.pdf",MailAttach
          call      SendMail
...
ERR      DISPLAY   *P1:1,*ES,"RANGE ERROR :",ERROR;
         ...
         GOTO      ERR
NOfile
         prepare   results,"\\nins1\e\data\text\OrdstatsP.dat","\\nins1\e\data\index\OrdstatsP.isi","6","62",exclusive
...
IO       DISPLAY   *P1:24,*EL,"IO ERROR ",ERROR;
         STOP
SendDaveEmail
          Move      "Nord0010P - Alert",MailSubjct
           Clear     MailFrom
           Clear    MailAttach
           If       (user = " " or user = "")
