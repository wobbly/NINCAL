...
release   init    "1.01"     DLH  some html cleanup
...
.           append     "<meta http-equiv=#"Content-Type#" content=#"text/html; charset=utf-8#">",mailbody           
           ...
           append     "<title></title>",mailbody
.box for later
           append     "<style type=#"text/css#">",mailbody
           append     " div.c1 {width:200px;height:30px;border:1px solid ##000;}",mailbody
           append     "</style>",mailbody
           append     HexCRLF,mailbody
...
.detail table 4 sections
           ...
           append     "<tr>",mailbody
           append     "<td width=#"25%#" valign=#"top#"><strong>NIN##: ",mailbody
           append     OLRN,mailbody
           append     "</strong></td>",mailbody
           append     "<td width=#"25%#" valign=#"top#"><strong>Status: ",mailbody      
           ...
           append     "</strong></td>",mailbody
           append     "<td width=#"25%#" valign=#"top#"><strong>Mail Date: ",mailbody
           ...
           append     "</strong></td>",mailbody
           append     "<td width=#"25%#" valign=#"top#"><strong><div class=#"c1#">Answer:        </div>",mailbody      
           append     "</strong></td>",mailbody
           append     "</tr>",mailbody
           append     HexCRLF,mailbody
           append     "<tr>",mailbody
           append     "<td valign=#"top#"><strong>Mailer: ",mailbody
           call       trim using mcomp
           append     MCOMP,mailbody
           append     "</strong></td>",mailbody
           append     HexCRLF,mailbody
           append     "<td valign=#"top#"><strong>Offer: ",mailbody
           call       trim using ofdesc
           append     OFDESC,mailbody
           append     "</strong></td>",mailbody
           append     HexCRLF,mailbody
           
           append     "<td valign=#"top#"><strong>Qty: ",mailbody
           ...
           append     "</strong></td>",mailbody
           append     HexCRLF,mailbody          
           append     "<td valign=#"top#"><strong>Sample: ",mailbody
...
.           call       debug
           ...
           append     "</tr>",mailbody
           append     "</tbody>",mailbody
           append     "</table> <table width=#"100%#" border=#"1#" cellpadding=#"2#" cellspacing=#"2#" >",mailbody
.test 2016 March 25
.           append     HexCRLF,mailbody
.end test 2016 March 25
           append     "<tbody>",mailbody
           append     "<tr>",mailbody
           append     "<td width=#"33%#" valign=#"top#"><strong>Reco: ",mailbody
           ...
           append     "</strong></td>",mailbody
           append     HexCRLF,mailbody          
           append     "<td width=#"33%#" valign=#"top#"><strong> ",mailbody
