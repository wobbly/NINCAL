...
IFILE           IFILE          FIXED=300,KEYLEN=6,Name="NININV.ISI|NINS1:502 "                    
DATA     DIM       1
CODE     DIM       1
LR       DIM       6
INAME    DIM       20
...
Timer     Timer
          ...
          clear     taskname
          append    "TO MARK A OPEN INVOICE PAID",taskname
          append    CRLF,taskname
          append    "Change : '0' to 'P' or 'X' to 'Q'",taskname
          append    CRLF,taskname
          append    CRLF,taskname
          append    "TO MARK A BILLED ORDER UNBILLED",taskname
          append    CRLF,taskname
          append    "Change : 'P' to '0' or 'Q' to 'X'",taskname
          append    CRLF,taskname
          append    CRLF,taskname
          Reset     Taskname
...
CheckitOut
          ...
          if        (Str25 = "NININV" & Holdname = str25)
          OPEN      IFILE,"NININV.ISI|NINS1:502"
          Elseif    (Str25 = "NININV" & Holdname <>  str25)
          Close     IFile
          MOve      Str25,HOldname
          OPEN      IFILE,"NININV.ISI|NINS1:502"
          Elseif    (Str25 <> "NINORD")
