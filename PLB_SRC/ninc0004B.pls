...
.release   init      "1.05"          DLH     .Actual restructure the New Sherene Deal Jan 1 2010 forward
.reldate   Init      "26 January 2010"
.release   init      "1.04"          DLH     .Actual restructure
.reldate   Init      "25 January 2010"
.release   init      "1.03"          DLH     .Proposed restructure
...
OUTPUT1   IFILE     KEYLEN=8,FIX=252
.end patch 1.04
CSVFile   File      
.
...
Name      Dim       35        218-252     list or mailer name
...
.begin patch 1.04
NAME3   init    "Names in the News Brokerage"
...
.
         PACK      STR35,NTWKPATH1,"Income4b"
         PACK      STR45,NTWKPATH1,"Income4b"
         
          Prepare   Output,"c:\work\Income4b.tmp",exclusive   
.begin patch 1.04
.          PREPARE   OUTPUT1,STR35,STR45,"8","202",exclusive   
          PREPARE   OUTPUT1,STR35,STR45,"8","252",exclusive   
.end patch 1.04
          Prepare   CSVFIle,"c:\work\Income4b.CSV",exclusive   
...
Pass2
          Open      Output,"c:\work\Income4b.tmp",exclusive
...
.begin patch 1.04
                    BART,BLRT,opencount,opennames,oart,olrt,paidcount,paidnames,PART,PLRT,LateCount,LateNames,Lart,LLrt,Name
...
.          move      No,Detailflag
.          endif
          Elseif    (flag = "p")                               .billed and paid late
          Pack      Bdate from INVDTEM,"/",INVDTED,"/",INVDTEC,INVDTEY
          Pack      Pdate from Pmm,"/",Pdd,"/",Pcc,Pyy
          write     CsvFile,seq;*cdfon,Olrn,oqty,NotXnames,FormAr,Lrinc,Odate,qtybild,formar,lrinc,Bdate,MLdate,c0,c0,c0,qtybild,formar,lrinc:
                    Pdate,outid,name,str35
          endif 
.add detail for unqualified fpag "p"          
          REturn
...
.===========================================================================
          Weof      CsvFIle,seq
          Close     Csvfile
          OPen      OUTPUT1,"\\nins1\e\data\Income4b",exclusive   

.                              PRTOPEN PrFile,"PDF995","Income4b"
.                              PRTCLose Prfile
.win7 rc is misbehaving :(                              
                              PRTOPEN PrFile,"PDF:","c:\work\pdf\Income4b.pdf",Flags=PDF_FLAGS_WIN_ANSI_ENCODING
