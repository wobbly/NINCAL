...
RELEASE  INIT      "3.1"       DLH switch to PDF (strictly speaking this prog should not be used)
reldate    Init       "2015 January 29"s
...
delsmp   keyin     *p25:24,"Are you sure you wish to delete this record ? ",str1
         ...
         call      nsmpdel
         PACK      IMGNAME FROM DR,nsmpmlr,NSMPNUM,PDF
