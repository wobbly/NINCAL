...
.                              Read      Input,seq;*CDFON,Str55,TINVLR,tinvinv,str10,TINVDOLR           
                              Read      Input,seq;*CDFON,Str55,TINVLR,Olstname,mcomp,tinvord,tinvinv,str10,TINVDOLR           
.end patch 2.0
...
....New code
				Elseif (COMPHOLD = "009406") .Infogroup  add the records together
                                        	move	TinvDOlr,TinvdolrH
                                        	move	TinvDate,TinvDateH
                                        	call	Tinvkey
                                        	Move      tinvdolr to n92
                                        	Move      tinvdolrh to n102
                                        	add	N102,N92
                                        	move	N92,Tinvdolr
                                                  CALL      TINVUPD
                                                  ADD       C1 TO Update                                       
