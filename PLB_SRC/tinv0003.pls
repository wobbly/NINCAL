...
RELEASE  INIT      "2.3"            DLH open printer directly. windows vista and newer makes invoking cmd.exe difficult
reldate   Init      "2013 June 25"
.RELEASE  INIT      "2.2"            DLH open printer directly. windows vista and newer makes invoking cmd.exe difficult
...
.         read       input,seq;*CDFON,TINVLR,TINVDATE,TINVINV,TINVDOLR      
         read       input,seq;*CDFON,TINVLR,str10,TINVINV,TINVDOLR      
.end patch 2.3
         goto       eoj if over
.Patch 2.1
         type      TINVLR
...
.begin patch 2.3 Tinvdate is defined as ccyymmdd they have started sending mm/dd/ccyy   DLH June 2013
          explode   str10,"/" giving mm,dd,str4
...
.         if        not over
.START PATCH 1.7 REPLACED LOGIC
.         execute  "!c:\command.com /c copy g:\DATA\tdmcbill.LST \\NINS2\LASER2 "
.         execute  "!c:\command.com /c copy g:\DATA\tdmcbill.LST \\NINS2\LASER2 "
.        else
.         execute  "!c:\winnt\system32\cmd.exe /c copy g:\DATA\tdmcbill.LST \\NINS2\LASER2 "
.         execute  "!c:\winnt\system32\cmd.exe /c copy g:\DATA\tdmcbill.LST \\NINS2\LASER2 "
.
.begin patch 2.2
...
.         .execute "F:\PUBLIC\NPRINT g:\DATA\tdmcbill.LST Q=LASER2 NT NA=GS_JL f=0 S=NINS2_fpnw C=2"
.         display   *p2:23,"Please wait I'm PRINTING !!!!!"
         display   *p2:23,"I'm Done PRINTING !!!!!"
.end patch 2.2
         pause     "10"
         stop
