...
release  init      "4.44"          DLH     update discount portion for MSF/DCCC
...
.temp turn off for farm sanc anal
...
.          else
          ...
          add     Sixlpi,row
          PRTPAGE   Laser;*p=5750:row,"180 Grand Ave Ste 1545"
          add     Sixlpi,row
          PRTPAGE   Laser;*p=5750:row,"Oakland, Ca 94612-3799"
          add     Sixlpi,row
          add     Sixlpi,row
...
hdok4b 
          ...
          PRTPAGE   Laser;*p=1:row,*ULON,"Rental ##",*p=750:row,"Qty",*p=1500:row,"Description":
                   ...
                   *ULOFF,*font=Font1
.          print      *L,hpunon,hpt000,hpt1050,hpunoff:
...
.                             hpuprght,hpdtch85,hpt375,PAGENUM
          add       Sixlpi,row
          PrtPage   Laser;*p=1:row,*font=font1,CopyRightS,"1992-2015, Names in the News",*p=4000:row,Pagenum
...
.          else
          add       Sixlpi,row
          PrtPage   Laser;*p=1:row,*font=font1,CopyRightS,"1992-2015, Names in the News",*p=9500:row,Pagenum
...
.START PATCH 4.41 REPLACED LOGIC
.                              if not over
...
.END PATCH 4.41 REPLACED LOGIC
                                                  ...
                                                  move      c0,calcAR
.START PATCH 4.41 REPLACED LOGIC
.                                                  calc      calcar=(Num9/1000)*Nselprice          
                                                  calc      calcar=(Num9/1000)*Nsel3price          
.END PATCH 4.41 REPLACED LOGIC
                                                  add       CalcAR,MoreAR                              
                                                  elseif    (n3 = c2)           .Flat
.START PATCH 4.41 REPLACED LOGIC
.                                                  add       Nselprice,MoreAr
                                                  add       Nsel3price,MoreAr
.END PATCH 4.41 REPLACED LOGIC
                                                  endif                                      
                                        endif
.START PATCH 4.41 REMOVED LOGIC
.                              endif
.END PATCH 4.41 REMOVED LOGIC
                    elseif (NSEL3CODE = "L")
...
.          repeat
.START PATCH 4.41 REMOVED LOGIC
.This needs to be moved to below.  MOREAR is never re-initialized, so you will end up adding items in multiple times
.          Add       MoreAr,FormAR
.END PATCH 4.41 REMOVED LOGIC
          return
endcalcadd
.end patch 4.3
.START PATCH 4.41 MOVED LOGIC
          if        (Ostat <> "Q" & OSTAT <> "B")     .not billed lets look for addl charges
                    Add       MoreAr,FormAR
            endif
.END PATCH 4.41 MOVED LOGIC
......................................................................................
         cmatch    yes to mbildrct            .bill direct?  14apr95 dlh
          if       equal
         clear     ordmname
...
.begin patch 4.43
                    ...
                    call    Trim using str9
                    pack    RangeStr,"A",str9
                    setprop sheet.range(RangeStr),*Value="180 Grand Avenue, Ste ##1545"
                    add     C1,N9
                    move    N9,str9
                    call    Trim using str9
                    pack    RangeStr,"A",str9
                    setprop sheet.range(RangeStr),*Value="Oakland, CA 94612-3799"
.end patch 4.43
          endif
.END PATCH 3.75 ADDED LOGIC
          Move      c1,str9
