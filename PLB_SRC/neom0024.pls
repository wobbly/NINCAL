...
./                                      Produces Oar in excel format can also produce a csv dump which is obsolete now
...
./                      Expanded Report 1 - Includes Gross Billed (Pareom file -  Code T)
./                              Mailer    LR#       Inv#      Mail Date Income Amount       Qty       Qty       Price/M     Gross Billed      Chk. Date Chk. Number         Description         Mlr Tax
./                      Expanded Report 2 - Includes Gross Billed and Detailed Commission Breakouts     (Pareom file -  Code D)
...
.begin patch 2.54
          Include   NadjRes.inc
.end patch 2.54
.begin patch 2.590 1 June 2012
          include winapi.inc
.end patch 2.59 01 June 2012

./         INCLUDE   PrtPagedd.inc
./..........................................
Release    INIT    "2.61"               DLH      .Check for copyfile failure
Reldate   Init      "2015 May 1"
.Release    INIT    "2.60"               DLH      .Excel 2013 *WindowState=xlMinimized
.Reldate   Init      "2014 January 22"
.Release   init      "2.59"                 DLH  add use of the pdf995 wait for completion option
..                                               job is being run on a machine fast enough that the print (pdf's) can collide (be overwritten)  
.reldate   Init      "1 June 2012"
.Release   init      "2.58"                 DLH  use API calls for pdf995.ini paramenter changes
.reldate   Init      "13 March 2012"
.Release   init      "2.57"                 DLH  Set PDf995 path
.reldate   Init      "26 April 2011"
.Release   init      "2.56"                 DLH  allow add hoc run suppress writing to ninlob (create new one)
.reldate   Init      "4 February 2010"
.Release   init      "2.55"                 DLH  Excel version checking
.reldate   Init      "30 April 2009"
.Release   init      "2.54"                 DLH  Adj reason codes
...
rflag     DIM       1
./.............................................................................
.begin 2.55 to find version of excel  DH 04/02/09
#VERSION  DIM 10
#VER_F    FORM 4.2
#VER      FORM 1 1=EXCEL 2007 OR LATER
.end 2.55 to find version of excel
.begin patch 2.54
...
arform    FORM      10.2
arout     DIM       17
arflag    DIM       1        from parfile if True print ar, 'D' breaks out list cost details
...
.begin patch 2.56
adhocflag dim       1           default ' ' or 'F'  'T'=ad hoc
.end patch 2.56
...
Choose    if        (func = "2")
          move      "T",AdhocFlag
          MOVE      "Ad hoc List Owner Report" TO STITLE
          Pack      taskname from "\\nins1\e\data\ownerstm.adhoc,\\nins1\e\data\ownerstm.srt;12-15,20-25,1-1,26-33"
...
./         PACK      DATE FROM SYSMO,SLASH,"31",SLASH,SYSYR
         ...
         CALL      FUNCDISP
         GOTO      DATE
          Else                          .date was supplied - use it
          UNPACK    today INTO SYSMO,STR1,SYSDY,STR1,SYSYR
          move      today to datemask
          
         endif
.begin patch 2.56
.create a copy of lob file
          if        (adhocflag = True)
          pack      taskname from "\\nins1\e\data\text\ninlob.",sysyr,sysmo,"|NINS1:502"
          Copyfile  "\\nins1\e\data\text\ninlob.dat|NINS1:502",taskname
          pack      taskname from "\\nins1\e\data\text\ninlob.",sysyr,sysmo," \\nins1\e\data\index\ninlob",sysyr,sysmo," l28 -1-16,ne"
          Index     taskname,Sundm="NINS1:502"
          pack      taskname from "\\nins1\e\data\index\ninlob",sysyr,sysmo,"|NINS1:502"
          open      NlobFILE,taskname
          MOVE      C1 TO NlobFLAG
          endif
.end patch 2.56
OPEN     
...
./Patch 2.53
.begin 2.55 get exel version info
.         Pack      XLSNAME,"OWN",sysmo,sysyr
.         Pack      Taskname with "\\nins1\E\DATA\",XLSNAME,".xls"
.         Erase     Taskname
.end 2.55 get exel version info
...
./END PATCH 2.48 ADDED LOGIC
         ...
         Display   *P10:10,"Input records PROCESSED: ",COUNT,b1,slsown,b1,slslist
          ...
          if        (adhocflag = True)
.                    if        (Slsown <> "2227" & Slsown <> "6018" & Slsown <> "0390"  & Slsown <> " 390" & Slsown <> "7189")
.                    if        (Slsown <> "5799" & Slsown <> "5716" & Slsown <> "7189" & Slsown <> "5851" & Slsown <> "4352" & Slsown <> "2136" & SLSLIST <> "028834")
.                    goto      readsls
.                    endif
          endif                    
.Begin patch 2.41
...
getmore
.         Move      slsLR TO NORDFLD
           packkey    Nordfld,slslr
         REP       ZFILL IN NORDFLD
         CALL      NORDKEY
           packkey    Ninvfld,slslr
.         Move      slsLR TO NinvFLD
         REP       ZFILL IN NinvFLD
         call      ninvkey
         call      readpay
...
./.Begin patch 2.40         
         ...
         if        not equal
.**********TEMP   ????????????????  turned off for testing LO with no activity  2015 Dec 01
          call      noxfoot
...
./Patch 2.53.1
        ...
        Clear    MailFrom  
        Clear    Mailto  
        Append   "ComputerRequest@nincal.com",MailTo  
        Reset    MailTo  
        Reset    MailBody
...
.neom024aw- defunct
.find any previously stored that need deletion
.test o rue
test2
          clear     Mailbody
          pack      str45 from "\\nins1\e\storage\weboar\*",cc,SYSYR,SYSMO,".pdf"
          FIndDIr   str45,MailBody,Itemcount=n5
          if        (n5 > c0)
          ...
          match     "f",Dmfilename 
                    ...
                    clear     taskname
                    bump      DmFileName,c1
                    pack      taskname from "\\nins1\e\storage\weboar\",DmFIleName    ."comment :)
                    erase       taskname
                    endif
          repeat
          endif
.copy the new ones
          call      debug
          clear     Mailbody
          pack      str45 from "c:\work\pdf\*",cc,SYSYR,SYSMO,".pdf"
          FIndDIr   str45,MailBody,Itemcount=n5
          if        (n5 > c0)
                    FOr       n4 from c0 to N5
                    explode   MailBody,"|",Dmfilename 
                    match     "f",Dmfilename 
                              ...
                              clear     taskname
                              bump      DmFileName,c1
                              pack      str55 from "c:\work\pdf\",DmFIleName     ."comment :)
                              pack      taskname from "\\nins1\e\storage\weboar\",DmFIleName    ."comment :)
                              FindFIle  Str55
                                        if        zero                .file is not there
                                        copyfile    Str55,Taskname                          
.begin patch 2.61
                                        if  not zero                         .copy failed
                                        call    CopyFailed
                                        endif
.end patch 2.61
                                        erase       str55
...
.        Pack    MailTo,"ComputerRequest@nincal.com",",","GemmaSpranza@nincal.com",",","SandraInouye@nincal.com",",","GemmaBarlaan@nincal.com"
          if        (adhocflag = True)
        Pack    MailTo from "CReques@nincal.com,DavidHerrick@nincal.com"
          else
        Pack    MailTo from "CReques@nincal.com,GemmaSpranza@nincal.com,DavidHerrick@nincal.com"
          endif
./.End patch 2.53.5
          Call    SendMail
...
.begin patch 2.61
CopyFailed
        Move    "OAR Copy File Failed",MailSubjct
...
./TESTING ON DH MACHINE
                    Move      "COMSPEC",taskname
                    Clock     env,taskname
                    scan      "ComSpec=",taskname
                    bump      taskname,1
                    move      taskname,str1
.                    unpack    taskname into str25,str25,str1
...
.begin patch 2.58
                    ...
                    Pack    taskname,"C:\work\pdf\",str25                     ."
...
.begin patch 2.58
.                    pack      str45 from PDFPATH,"\res\pdf995.ini"
..                    pack      str45 from str1,":\progra~1\pdf995\res\pdf995.ini"
..                    Open      TestFile,"f:\progra~1\pdf995\res\pdf995.ini"
.                    Open      TestFile,str45
.                    pack      str55 from PDFPATH,"\res\pdf995.out"
..                    pack      str55 from str1,":\progra~1\pdf995\res\pdf995.out"
..end patch 2.57
..                    Prepare   TempFile,"f:\progra~1\pdf995\res\pdf995.out"
...
..begin patch 2.57
.                    pack      str55 from PDFPATH,"\res\pdf995.sav"
..                    pack      str55 from str1,":\progra~1\pdf995\res\pdf995.sav"
..                    Erase     "F:\progra~1\pdf995\res\pdf995.Sav"
.                    Erase     str55
.                    move      "PDF995 Rename",Filename
.                    pack      KeyLocation,"Ren Ini to Sav "
../TESTING ON DH MACHINE
..                    Rename    "f:\progra~1\pdf995\res\pdf995.ini","f:\progra~1\pdf995\res\pdf995.Sav"
.                    Rename    str45,str55
.                    move      "PDF995 Rename",Filename
...
..                    pack      str55 from str1,":\progra~1\pdf995\res\pdf995.out"
..end patch 2.57
..                    Rename    "f:\progra~1\pdf995\res\pdf995.out","f:\progra~1\pdf995\res\pdf995.ini"
.                    Rename    str55,str45
.end patch 2.58
...
.begin patch 2.57
                    pack      str45 from PDFPATH,"\res\pdf995.ini"
.                    pack      str45 from str1,":\progra~1\pdf995\res\pdf995.ini"
.                    Erase     "f:\progra~1\pdf995\res\pdf995.ini"
                    Erase     str45
                    move      "PDF995 Restore",Filename
...
.end patch 2.57
./TESTING ON DH MACHINE
.                    Rename    "f:\progra~1\pdf995\res\pdf995.Sav","f:\progra~1\pdf995\res\pdf995.ini"
                    Rename    str55,str45
          Return
./Patch 2.53.4
.begin patch 2.40
