...
release  init      "3.3"        DLH     print directly to users desired printer, do not use Butil.exe, create external call point
Reldate   Init      "17 March 2011"
...
.
         ...
         MOVE      C1 TO NORDPATH
.begin patch 3.3
.                    LR,   Guartyp,Inits,  printer,attn,   fax   
...
.                              if (OSFLAG = "1" or OSFLAG = "5" or OSFLAG = "6" or OSFLAG = "7" or OSFLAG = "9")  .NT4,NT5,XP,vista,win7
.                                  PRTOPEN PrintDoc,"@Kyocera FS-C5030N","Guaranty"
.                          elseif (osflag = c1)         .win 95 98
.                                  PRTOPEN PrintDoc,"@KYOCERAM","Guaranty"
.                          else   .(osflag = c0)         .Don't know prompt for printer
                                  PRTOPEN PrintDoc,"","Guaranty"
.                          endif
                    else
