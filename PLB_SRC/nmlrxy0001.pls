...
release   init      "1.1"     15JUN2007 ASH PLI Inclusion
          move      "June 15, 2007",Wreldate
...
.
          MailerXYListView.InsertColumn using "",25,3
          MailerXYListView.InsertColumn using "Mailer2",50,4
          MailerXYListView.InsertColumn using "Mailer2 Name",150,5
          MailerXYListView.InsertColumn using " ",25,6
          MailerXYListView.InsertColumn using "Notes",200,7
          MailerXYListView.InsertColumn using "Details",0,8
...
...........
          ...
          MailerXYListView.SetItemText using N9,str3,3
          pack      COMPFLD,NMLRXYMLR2
          move      "LoadLV2-COMPKEY",Location
          pack      KeyLocation,"Key: ",COMPFLD
          call      COMPKEY
        MailerXYListView.SetItemText using N9,COMPNUM,4
        MailerXYListView.SetItemText using N9,COMPCOMP,5
          if (CompExcl = "P")
                    move      "PLI",str3
          else
                    move      "NIN",str3
          endif
          MailerXYListView.SetItemText using N9,str3,6
        MailerXYListView.SetItemText using N9,NMLRXYNOTE,7
        MailerXYListView.SetItemText using N9,hold,8
.END PATCH 1.1 REPLACED LOGIC
          return
