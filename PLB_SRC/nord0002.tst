...
.                   trap      IO GIVING ERROR IF IO
                    ...
                    Erase     "\\nts1\e\data\Nprint.brk"
                    Erase     "\\nts1\e\data\Nprint.lm"
                    Erase     "\\nts1\e\data\Nprint.tmp"
.file for Owner pass
                    Display   *p1:22,*el,"sorting  to Nprint.own"
                    pack      taskname,"\\nts1\e\data\NPRINT.Dat,\\nts1\e\data\NPRINT.own;22-25,16-21,7-12"
                    sort      taskname
...
.file for Office pass if typist initials indicate it is an Auto billing order
                    ...
                    pack      taskname,"\\nts1\e\data\NPRINT.dat,\\nts1\e\data\NPRINT.LR;290-292,7-12,S=#"290='AMB'|290='ARB'#""
                    sort      taskname
...
.			pack      Mailfrom,"dherric@nincal.com"
                   ...
                   pack      Mailto,"JDuenas@nincal.com"
                    Clear     MailAttach
                    call      SendMail
...
.JD testing 1/23/09 turned off 

           MOVe      "Jduenas@nincal.com",Mailto
