...
.let print it all
.
         print     hpunon,hpbon,*2,"Triplex Billed : ",tottdmc,"  We Billed",*48,mt$ar,*62,mt$ap1,"/m ":
                   prcpass,"%":
                   *89,mt$lrinc,B1,PRCLRPASS,"%":
                   *l,*64,TDMCFLAT," Flat ",PRCFLAT,"%":
                   *91,INCrFLAT,B2,PRCLRFLAT,"%",hpboff,hpunoff
         PRINT     *L,*10,"NUMBER OF RECORDS read: ",applied
         splclose
;begin patch 1.8
                    call                GetWinVer
