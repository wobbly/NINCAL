PC      EQU     0
        ...
        include CONS.INC
.========================================================================================
         MOVE      "NFTP0007" TO PROGRAM
         MOVE      "SRDS FTP PROGRAM" TO STITLE
...
;.        call Paint
        ...
        OPEN FTPTMP,"SRDSFTPTMP"
        OPEN FTPSAV,"FTPSAV7",EXCLUSIVE
        PREPARE FTPDWN,"\\nins1\E\DATA\SRDSftpdwn"
          Clear     Mailbody
...
OVERNOW
   Display    *P10:11,*EF,*White,"Job Complete!!"
          If (n2 = c0)
                  ...
                  Close FTPDWN
                  pack  taskname,NTWKPATH1,"SRDSFtpdwn.DAT"
                  erase TASKNAME
          Move      "No SRDS Files to Download.",MailSubjct
   ...
   Close   FTPTMP
   pack    taskname,NTWKPATH1,"SRDSFtpTMP.DAT"
   erase   taskname
   Pause   C5
   STOP
ForeignFile
          Move      "There is an unrecognized file on the SRDS FTP Site. Please Verify",MailSubjct
          Move      "ComputerRequest@nincal.com",MailFrom
          Move      "Dherric@nincal.com",MailTo
