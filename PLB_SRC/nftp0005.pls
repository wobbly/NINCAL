.//at some future date someone could write the PLB to pull the date of the file from the file-
.//system to be put in taskname3 in the download function and then write it to the log
.//at the moment it renames the file as send and writes the date "upload" to the log for matching
.//purposes --RVW 4/27/16
...
.                      GOTO Main If (NFTPCOMP == "009411")                    .//Skip target_dwb_orders
                      CALL InitMySiteVars
                      CALL OpenSite
                      CALL Transfer
                      CALL DisconnectSite
