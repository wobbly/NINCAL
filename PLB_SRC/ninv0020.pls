...
.end patch 2.2
          ...
          include   ndatdd.inc
          inc       hp.inc
Release   Init        "2.53"        DLH New Minimums
REldate   INit      "2015 June 5"
.Release     Init        "2.52"        DLH Break process if we did not have a valid order read
.REldate   INit      "28 May 2010"
.Release     Init        "2.51"        DLH use dsprog to get correct date for EOM
.REldate   INit      "29 January 2010"
.Release     Init        "2.50"        JD Check for below min qty for all records
.REldate  INit      "31 October 2008"
.Release     Init        "2.49"        DLH  Clarify Minimum Charge
.REldate  INit      "22 AUgust 2008"
.Release     Init        "2.48"        JD  Force Pl client for PL excl list
...
.                   "/s(42,4,n,a,46,6,n,a,1,6,n,a,24,6,c,a) w(c:) Verbose"
.begin patch 2.48
          Erase     "\\nins1\e\data\text\exchmgnt.srt"
          Erase     "\\nins1\e\data\index\exchmgnt.isi"
...
.begin patch 2.41
          pause     "5"
.begin patch 2.53
          PACK      TASKNAME,"\\nins1\e\data\text\exchmgnt.dat \\nins1\e\data\index\exchmgnt,l100 -1-6"
.end patch 2.53
                    INDEX     TASKNAME
...
.begin patch 2.49
         ...
         PRINT     *1,hpdtch10,oLRn,hpt125,MCOMP,hpfixed,hpt400,QTYout:
.begin patch 2.53
                   slash,"Min. Fee",hpt700,ORTNDTEM,"/",ORTNDTEd,"/",ORTNDTEy,hpdtch10
.                   slash,"3,750-$15 Min. Fee",hpt700,ORTNDTEM,"/",ORTNDTEd,"/",ORTNDTEy,hpdtch10
.end patch 2.53
...
.         move     "018710" to ndatfld      .pull correct description
         move     nxrflist to ndatfld      .pull correct description
.end patch 2.48
         call     ndatkey
...
.Start patch 2.48
.         if        (CompExcl = "P")
          if        (CompExcl = "P" or ELSTCDE = "P")
          move      "024593" to olnum
          MOve      "P",OcompID         
          MOve      "P",OcompID2        
          move      "1490" to olon
         move     "024593" to ndatfld      .pull correct description
         call     ndatkey
          Else
.end patch 2.46
...
.begin patch 2.48
          if        (OCompID = "" or OCompID = " " or OCompID = "N")
.end patch 2.48
                    if        (ELSTCDE = "P")
                    move      "P",OCompid
                    Elseif    (ELSTCDE = "C")
