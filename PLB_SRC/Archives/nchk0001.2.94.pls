...
NOT GOING TO DO WHAT GS WANTS/NEEDS - terminated back to 2.93
release    init       "2.94"           DLH 29Nov2007  add MTDCASH Check
...
.begin patch 2.9
         ...
         PRINT     *26,"TOTAL InterComp Transfer's ",*48,MT$Trans
.end patch 2.9
.begin patch 2.94
...
OutMTD 
         ...
         COMPARE   "57" TO LINES
         CALL      HEADER IF GREATER
         PRINT     *L,*26," M-T-D By Control",*48,MT$AR,*62,MT$AP1:
