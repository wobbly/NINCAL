...
. Function:     Creates an Excel Spreadsheet with a summary of a client's usage in a given time period also shows the broker.
...
Release    INIT    "1.53"               DLH      .remove Krsni and Denise add Jen M
Reldate   Init      "2016 April 4"
.Release    INIT    "1.52"               DLH      .add Krsni
.Reldate   Init      "2014 September 3"
.Release    INIT    "1.51"               DLH      .Excel 2013 *WindowState=xlMinimized
.Reldate   Init      "2014 January 22"
.release   init    "1.5"                 DLH      dynamic resizing
.Reldate   INit      "2013 October 23"
.release   init    "1.4"                 DLH      Allow invoking from dsinit with predefined options
.Reldate   INit      "2013 May 03"
.release   init    "1.3"                 DLH      Menu's , cleanup
.Reldate   INit      "29 August 2012"
...
.Set Vars used for About Box
        move    "Nrep0001.PLS",Wprognme
        move    "Usage Reporting",Wfunction
...
x         plform              NREP0001
          ...
          winhide
.Create Menus
        create  NREP0001;mFile,FData
        create  NREP0001;mOptions,OData,mFile
        create  NREP0001;mHelp,HData,mOptions
...
.begin patch 1.4
          if        (program = "NREP0001")          .invoked from dsinit
                    move      yes,autoflag
                    scan      "RYTD" in comment
                    if        equal                                   .calc dates
                    unpack    today into mm,str1,dd,str1,yy           .we presume the got the date correct using last day of the month                    
                    rep       zfill,mm
                    rep       zfill,dd
                    rep       zfill,yy
                    ...
                    move      mm,n2
                              if        (n2 = "12")                   .will be jan thru dec
                                        move      c1,mm
                              elseif    (n2 = "11")                   .will be Dec thru Nov
                                        move      "12",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "10")                   .will be Nov thru Oct
                                        move      "11",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "9")                   .will be Oct thru SEp
                                        move      "10",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "8")                   .will be Sep thru Aug
                                        move      "09",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "7")                   .will be Aug thru Jul
                                        move      "08",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "6")                   .will be Jul thru Jun
                                        move      "07",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "5")                   .will be Jun thru May
                                        move      "06",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "4")                   .will be May thru Apr
                                        move      "05",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "3")                   .will be Apr thru March
                                        move      "04",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "2")                   .will be march thru Feb
                                        move     "03",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
                              elseif    (n2 = "1")                   .will be Feb thru Jan
                                        move      "02",mm
                                        move      yy,n2
                                        sub       c1 from n2
                                        move      n2,yy
          ...
          reset     Comment
.get parameters,  calc dates (start, end) source (LM or Brokerage), add salesperson optiopn.
.comment = Rytd = rolling ytd use current date as end date (runs at eom) calc start date
.comment Odte=order date, Mdte=Maildate
.comment sls = pull salesperson data
.func 1=LM, 2-brokerage
.also force report name and email it
                    IF        (func = "1")
                              move "YES",ListMFlag
                              Setprop NREP0001ButtonLM, value=c1
                              Setprop NREP0001ButtonSales,value=c0

                    elseif    (func = "2")      
                              move "NO",ListMFlag
                              Setprop NREP0001ButtonLM, value=c0
                              Setprop NREP0001ButtonSales,value=c1
                    else
                    shutdown  "cls"        
                    endif
                    scan      "SLS" in comment
                    if        equal                                   .
                              move "YES",P34Flag 
                              Setprop NREP001ButtonP34, value=c1
                    endif
                    Setprop NREP0001RadioOrder, value=C1
                              move "YES", OrderDateFlag
                    Setprop NREP0001RadioMail, value=c0
...
NREP0001ButtonOK
              move            "\\nins1\e\data\text\NINord.dat",str45
              open            tempfile,str45
              positeof tempfile
              fposit          tempfile,N10
              calc            howmany=(N10/408)             .302 = 300(NININV record length) + 2 bytes for CR/LF
              reposit tempfile,C0                           .Reposition File Pointer to beginning of file
              Close Tempfile
             call    RepInitProgressBar
...
.                             call      debug
                              ...
                              Call Trim using OBRKNUM                           
                                        If  (OBRKNUM <> "")
                                                  ...
                                                  move      "Compskey",Location
                                                  pack      KeyLocation,"Key: ",COMPSFFLD
...
.begin patch 1.4
          if        (Autoflag = yes)
                    ...
                    if        (#ver = c1)
                    pack      taskname from "c:\work\EOMUsage",cc,yy,mm,dd,".xlsx"
                    else
                    pack      taskname from "c:\work\EOMUsage",cc,yy,mm,dd,".xls"
                    endif
                    Erase     Taskname
                    ...
                    Move      "SMcGuir@nincal.com,JMagee@nincal.com",Mailto
.                    Move      "SMcGuir@nincal.com,KWatkin@nincal.com,DeniseHubbard@nincal.com",Mailto
.                    Move      "dherric@nincal.com",Mailto
                    move      "Rolling year usage",MailSubjct
...
.check the error if file does not exist just get out
                    ...
                    Pack       MailSubjct,"NREp0001 - ",str35,b1,str55
                    Move      "CReques@nincal.com",MailFrom
                    Move      "dherric@nincal.com",MailTO
...
XRESIZE
           ...
           RETURN
..................add progress bar ..................
REpUpdateProgressBar
              calc            CurRec=(CurRec+1)
              calc            CurVal=((CurRec/howmany)*100)
              if (CurVal <> LastVal)
               setitem        Nrep1ProgressBar,0,CurVal
               move           CurVal,LastVal
              endif
              checkevent
              return
