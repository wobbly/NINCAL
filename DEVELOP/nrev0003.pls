...
INPUT   TRAP     FORMAT1 IF FORMAT
        READ     INPUT,SEQ;TYPE,SOURCE,CLIENTID,CC,year,MONth,FILL1,CLIENT:
...
.
        add     month to mohold
        PACK    nrevfld FROM TYPE,SOURCE,CLIENTID,cc,year
...
.
        ...
        Store   CALC into MOhold OF JANNIN:
         ...
         GOTO    INPUT
.
WRITE   PACK    nrevfld FROM TYPE,SOURCE,CLIENTID,cc,year
.begin patch 5.2
.        MOVE    C0 TO JAN89
.        MOVE    C0 TO FEB89
.        MOVE    C0 TO MAR89
