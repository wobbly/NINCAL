PC       EQU       0
         ...
         INCLUDE   CONS.inc
.patch5.12
				include	compdd104.inc
				include	cntdd104.inc
.         INCLUDE   NMLRDD.inc
;patch5.12
         INCLUDE   NORDDD104.inc
         INCLUDE   NDATDD104.inc
.patch5.12
.         INCLUDE   nbrkdd.inc
.patch5.12
         INCLUDE   ncntdd104.inc
         INCLUDE   NOWNDD104.inc
         INCLUDE   OSLSPERN.INC
         INCLUDE   NRTNDD104.inc
.START PATCH 5.11A ADDED LOGIC
	INCLUDE	NCATDD104.INC
.END PATCH 5.11A ADDED LOGIC
..............................................................
.Following used only in order to load Search.plf
        include ncmpdd104.inc
...............................................................
...
PRMPIK   form     "14"            .Number of primary options
...
REPPIK   form     "33"            .Number of Report Options
.Flags
...
.Filter collection
.        listins ColFilter,Nord0006CheckExclude,Nord0006CheckNets,Nord0006CheckLCR,Nord0006CheckPending
...
;        listins ColPrint,Nord006CheckDUP,Nord006CheckX,Nord006CheckPDF,Nord0006ComboCopy
     ...
     winhide
        ...
        move    "NINCAL Order Pick Program",Wfunction
...
.                              "7.  Prepays by List":
                              ...
                              "11. ---------------------------------------":
                              "12. Diskin Flat File -(users directory)":
...
rep1
        if (DUPLEX = c0)
               append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\butil job=O24 INfile=",TASKNAME
.                append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\BUTIL job=ALPHAMLR INfile=",TASKNAME
        else
               append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O25 INfile=",TASKNAME
.                append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=ALPHAMLD INfile=",TASKNAME
        endif
        goto      repfini
...
rep2
        if (DUPLEX = c1)
                if (XLINES = c1)
.XLines/Duplexed
		         append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\butil job=O10 INfile=",TASKNAME
.		         append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\BUTIL job=NMLRALDW INfile=",TASKNAME
                else
.Duplexed
		         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O9 INfile=",TASKNAME
.		         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=nmlrald INfile=",TASKNAME
                endif
        else
                if (XLINES = c1)
.Default/Xtra Lines
		         append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\butil job=O11 INfile=",TASKNAME
.		         append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\BUTIL job=NMLRALW INfile=",TASKNAME
                else
.Default
                append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\butil job=O5 INfile=",TASKNAME
.append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\BUTIL job=O5 INfile=",TASKNAME
.	        append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\BUTIL job=NMLRAL INfile=",TASKNAME
                endif
         endif
         goto      repfini
rep3
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1  f:\apps\winbatch\butil  job=O14 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1  f:\apps\winbatch\butil  job=ALPHABK INfile=",TASKNAME
         goto      repfini

rep4
         if (DUPLEX = c0)
              if (XLINES = c1)
	                   append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil job=O7 INfile=",TASKNAME
.	                   append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil job=NMLRAL2W INfile=",TASKNAME
              else
	                   append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil job=O6 INfile=",TASKNAME
.                     append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil job=NMLRAL2 INfile=",TASKNAME
              endif
			 else
              if (XLINES = c1)
	                   append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil job=O33 INfile=",TASKNAME
.	                   append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil job=NMLRAL2W INfile=",TASKNAME
              else
	                   append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil job=O8 INfile=",TASKNAME
.                     append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil job=NMLRAL2 INfile=",TASKNAME
              endif
			 endif
         goto      repfini
rep5
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1  f:\apps\winbatch\butil  job=O1 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1  f:\apps\winbatch\butil  job=NMLRASIS INfile=",TASKNAME
         goto      repfini
rep6
...
..         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1  f:\apps\winbatch\butil  job=O3 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1  f:\apps\winbatch\butil  job=NMLRGT INfile=",TASKNAME
...
.			stop
         goto      repfini
rep7
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O13 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NMLRALU INfile=",TASKNAME
         goto      repfini
rep8
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O16 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NMLRALC INfile=",TASKNAME
         goto      repfini
rep9
;Patch5.05
;          move c1 to selrep
...
;          stop
;Patch5.05
;         append    "F:\apps\winbatch\develop\extmailplan.exe",TASKNAME
         append    "\\nts0\c\apps\winbatch\mailplan.exe",TASKNAME
         goto      repfini3
rep10
;Patch5.05
;         append    "f:\apps\winbatch\develop\extordersum.exe",TASKNAME
;Patch5.05
...
rep11
         ...
         goto      repfini2
rep12
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O12 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=nmlralf INfile=",TASKNAME
         goto      repfini
rep13
        append    "c:\progra~1\lanbatch\batch32  /X f:\apps\winbatch\butil  job=O18 INfile=",TASKNAME
.        append    "c:\progra~1\lanbatch\batch32  /X f:\apps\winbatch\butil  job=NMLRDTE INfile=",TASKNAME
         goto      repfini
rep14
        if (DUPLEX = c1)
              append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O28 INfile=",TASKNAME
        else
		        append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O19 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NLISTBK INfile=",TASKNAME
		  endif
        goto      repfini
rep15
         append    "f:\apps\winbatch\NLISTSUM.exe",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NLISTSUM INfile=",TASKNAME
         goto      repfini2
rep16
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O23 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NLISTMDT INfile=",TASKNAME
         goto      repfini
rep17
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O20 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NLISTC3 INfile=",TASKNAME
         goto      repfini
rep18
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O21 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NLISTBKA INfile=",TASKNAME
         goto      repfini
rep19
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O22 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NLISTOFR INfile=",TASKNAME
         goto      repfini
rep20
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=A2 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=DISKINVO INfile=",TASKNAME
         goto      repfini
rep21
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O27 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=DISKORD INfile=",TASKNAME
         goto      repfini
rep22
          move      newname to comment
          pack      func,cntprint
          chain     "nloinc0001"
rep23
         append    "\\nts0\c\apps\winbatch\butil  job=NSHPK INfile=",TASKNAME
         goto      repfini
rep24
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=A3 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=DISKINV INfile=",TASKNAME
         goto      repfini
rep25
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=A1 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NUNBILL INfile=",TASKNAME
         goto      repfini
rep26
...
.END PATCH 5.13 REPLACED LOGIC
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=REGX INfile=",TASKNAME
         goto      repfini
rep27
         append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\butil  job=QTYX INfile=",TASKNAME
         goto      repfini
rep28
.START PATCH 5.13 REPLACED LOGIC
. 	 alert type=yesno1," Discount Portion?", result,"Discount"
...
.END PATCH 5.14 REPLACED LOGIC
.END PATCH 5.13 REPLACED LOGIC
         append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\butil  job=DWNX INfile=",TASKNAME
         goto      repfini
rep29
         append    "c:\progra~1\lanbatch\batch -X -SA -Q\\nts0\c\lanbat~2 f:\apps\winbatch\butil  job=A4 INfile=",TASKNAME
;patch5.11
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=ARSTATE INfile=",TASKNAME
         goto      repfini
rep30
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O26 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=VALPAMLR INfile=",TASKNAME
         goto      repfini
rep31
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O28 INfile=",TASKNAME
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=nlistbkd INfile=",TASKNAME
         goto      repfini
rep32
         append    "F:\apps\winbatch\rentexch.exe",TASKNAME
         goto      repfini2
rep33
;Patch5.12
         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=O35 INfile=",TASKNAME
			goto			repfini
;Patch5.12
.rep7
.         append    "c:\progra~1\lanbatch\batch -X -S#"<ANY>#" -Q\\nts0\c\lanbat~1 f:\apps\winbatch\butil  job=NMLRPRE INfile=",TASKNAME
.         goto      repfini
repfini
	      APPEND    NEWNAME TO TASKNAME
         APPEND    " C=",TASKNAME
