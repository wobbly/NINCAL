...
release   init      "4.10"                      DLH       add Summary to Excel, change copywrite date
reldate   init      "14 March 2012"
.release   init      "4.09"                      DLH       change copywrite date
.reldate   init      "2010"
...
.start patch 4.05
.                  PRINT     *L,*1,copywrite,hpptch,"1991-2007, Names in the News":
.                  PRINT     *L,*1,copywrite,hpptch,"1991-2008, Names in the News":
                   PRINT     *L,*1,copywrite,hpptch,"1991-2011, Names in the News":
                   hp10ptch,*39,PAGENUM,hpptch,*60,"* Indicates report client was last to use list.";
         else          
         cmatch    "D" to prtsw
         if        equal
                   PRINT     *L,*1,copywrite,hpptch,"1995-2011, Names in the News":
.                  PRINT     *L,*1,copywrite,hpptch,"1995-2008, Names in the News":
.                  PRINT     *L,*1,copywrite,hpptch,"1995-2007, Names in the News":
.                  PRINT     *L,*1,copywrite,hpptch,"1995-2004, Names in the News/CA":
...
.                  PRINT     *L,*1,copywrite,hpptch,"1991-2008, Names in the News":
.                  PRINT     *L,*1,copywrite,hpptch,"1991-2007, Names in the News":
.                  PRINT     *L,*1,copywrite,hpptch,"1991-2004, Names in the News/CA":
.end patch 4.05
                   hp10ptch,*39,PAGENUM;
