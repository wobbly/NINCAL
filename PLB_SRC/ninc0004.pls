...
mrgsw     dim       1
.
release  init      "1.12"          DLH     added Flags= to prtopen with PDF:
reldate   Init      "2014 March 25"
.release   init      "1.11"          DLH     .
.reldate   Init      "2014 January 7"
.release   init      "1.10"          DLH     .Use date from dsprog if avail
.reldate   Init      "2013 April 25"
.release   init      "1.03"          DLH     .Use date from dsprog if avail
...
..win7 rc is misbehaving :(                              
                              PRTOPEN PrFile,"PDF:","c:\work\pdf\Income4.pdf",Flags=PDF_FLAGS_WIN_ANSI_ENCODING
