...
.
         ...
         OPEN      Results,"ordstats|10.10.30.103:502",exclusive
         TRAPCLR   IO
...
.                   
	...
	call	debug	
		...
		rep	"-/",str8
		clear	taskname
		pack 	taskname from "=(N55/365)*DAYS(#"",str8,"#",#"1/1/14#")"
		setprop sheet.range(ExRange1,ExRange1),*Formula=taskname,*NumberFormat="######0"
		clear	taskname
		pack 	taskname from "=(O55/365)*DAYS(#"",str8,"#",#"1/1/14#")"
                    setprop sheet.range(ExRange2,ExRange2),*Formula=taskname,*NumberFormat="##,####0"
.Exchange
		MOve	Row12,RowA
		add	c9,RowA
...
.                   
                    ...
                    pack            Exrange2 from ColumnB,DimRow1
		clear	taskname
		pack 	taskname from "=(N57/365)*DAYS(#"",str8,"#",#"1/1/14#")"
		setprop sheet.range(ExRange1,ExRange1),*Formula=taskname,*NumberFormat="######0"
		clear	taskname
		pack 	taskname from "=(O57/365)*DAYS(#"",str8,"#",#"1/1/14#")"
                    setprop sheet.range(ExRange2,ExRange2),*Formula=taskname,*NumberFormat="##,####0"
.YTD
.Current year
.rent
