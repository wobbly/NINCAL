...............................................................................
.NEOM0004 - sales register for Individual Salesperson
...............................................................................
.
PC       EQU       0
         INC       COMMON.inc
...
.
...........................................
Release  init      "3.6"        DLH     cleanup and use to ID Denise sales
Reldate    Init       "2016 February 23"
.CLOCK    FUNCTION
........................
DATE     DIM       8
SYSMO    DIM       2
...
READINV  CALL      NINVKS
         GOTO      TOTAL IF OVER
         MOVE      B1 TO RUNFLAG
         MATCH     INVDTEY TO SYSyr
         GOTO      readinv IF NOT EQUAL
         MATCH     "518239" TO invnum
         GOTO      TOTAL IF EQUAL
         ADD       C1 TO COUNT
...
.>Patch 3.38 Comment Out         
.         print     hpunon,hpbon,*2,"S.B. Billed : ",tdmcamt,"  We Billed",*48,mt$ar,*62,mt$ap1,"/m ":
.                   prcpass,"%":
...
.>Patch 3.38 Comment Out                     
.         print     *2,"S.B. Billed : ",tdmcamt,"  We Billed",*48,mt$ar,*62,mt$ap1,"/m ":
.                   prcpass,"%":
.                   *89,mt$lrinc,B1,PRCLRPASS,"%":
.                   *l,*64,TDMCFLAT," Flat ",PRCFLAT,"%":
...
.>Patch 3.38      Comment Out                 
.         PRINT     *5,"S.B. Breakout IS FOR TEST PURPOSES ONLY!!!!!!!!":
.                   *L,*5,"--------------------------------------------------":
.                   *L
...
.>Patch 3.38      Comment Out                 
.         PRINT     *l,*5,hpbon,"S.B. Billed us  Charges","##",*48,MT$TDMC,hpboff
.>Patch 3.38      Comment Out        
.>Patch 3.38      Code Added           
