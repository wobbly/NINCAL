...
.NOrd0049
.
.Pending ORder report PROGRAM - USED to  Pending ORders to LM
.
.
.FOR TESTING PURPOSES FOLLOW LOGIC AROUND ".nordTEST" LABELS.  THESE
...
release   Init      "1.01"              DLH pdf and email to Jennifer M
...
.
          ...
          move      C1,NORD6PATH
          move      C1,NPNDPATH
.Set time from which we will start 
...
BREAK
                              ...
                              prtclose prfile
.begin patch 1.1
          Move      "Here is your LM Pending Order report",MailSubjct
          Move      "Creques@nincal.com",MailFrom
          Move      "JenniferMagee@nincal.com",MailTo
          Pack      str45,"c:\work\pdf\Pending.pdf"
          Move      Str45,MailBody               
          
          MOve      str45,MailAttach
...
.                              endif
                                 Erase     "c:\work\pdf\Pending.pdf"
                                 pack    str45,"c:\work\pdf\Pending.pdf"
                              
                        PRTOPEN PRFILE,"PDF:",str45,Flags=PDF_FLAGS_WIN_ANSI_ENCODING
.end patch 1.01
...
.Total Page
        ...
        prtpage prfile;*UNITS=*HIENGLISH,*ORIENT=*LANDSCAPE;
          move      "300",row
          prtpage   prfile;*pcolumn:row,*font=font1,*boldon,"Monthly Pending Orders Report - 'Want by Dates Past'";
          add       sixlpi,row
          add       sixlpi,row
...
.Header Information
        prtpage prfile;*UNITS=*HIENGLISH,*ORIENT=*LANDSCAPE;
          move      "300",row
          prtpage   prfile;*pcolumn:row,*font=font1,*boldon,"Monthly Pending Report - 'Want by Dates Past'";
          add       sixlpi,row
          add       sixlpi,row
