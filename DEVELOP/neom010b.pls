...
.end patch 4.1
	...
	ADD       LRINC TO TLRINC4
         ...
         GOTO      DTLPRT2
.begin patch 4.1
BRK1		if	(Ocompid = "P" or OrderID = "B")	  		     
.BRK1		if	(Ocompid = "P")	  		     
.begin patch 4.1
...
.>Patch 3.65 Code Added
        ...
        add     eightlpi,row                 
              prtpage prfile;*pColumn1:row,*ALIGNMENT=*Left,*ll,O1DES,b5,sls,b2,mslsper;           
.BEGIN PATCH 3.82
...
OhMy
              Create  ex
              pack            Taskname,"\\nts1\d\users\dherric\monday2008.xls"
.              pack            Taskname,"\\nts1\d\users\dherric\monday.xls"       
