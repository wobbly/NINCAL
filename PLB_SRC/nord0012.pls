...
.         XIF
...............................................................................
Release  init      "1.33"              DLH  Year Change  search for "every year"
reldate   Init      "2016 January 5"
.Release  init      "1.32"              DLH  Year Change
.reldate   Init      "2015 February 2"
.Release  init      "1.31"              DLH  Year Change
.reldate   Init      "2014 February 3"
.Release  init      "1.3"              DLH  Year Change
.reldate   Init      "2013 January 2"
.Release  init      "1.2"              DLH  Sunbelt PDF
.reldate   Init      "2013 May 6"
.Release  init      "1.14"              DLH  New Year
.reldate   Init      "03 Jan 13"
.Release  init      "1.13"              DLH  New Year
.reldate   Init      "03 Jan 12"
.Release  init      "1.12"              DLH  New Year
.reldate   Init      "03 Jan 11"
.Release  init      "1.11"              DLH  New Year
...
FIRSTN   INIT      "780000"  Start here - what is the firstn lr really?
.end patch 1,1
COUNT    FORM      2
MNTH    FORM      "01"
...
...............
          ...
          prtpage   laser;*FONT=prtpg10,*p=1:150,"Confidential":
                    ...
                    *p=1:400,*alignment=*Left,"Sales History for : ",Str25
.begin patch 1.1 Change Every Year
           Move       "2012",n4
          prtpage   laser;*p=1475:1100,n4
           add        c1,n4
          prtpage   laser;*p=3225:1100,n4
           add        c1,n4
          prtpage   laser;*p=4975:1100,n4
           add        c1,n4
          prtpage   laser;*p=6725:1100,n4
           add        c1,n4
          prtpage   laser;*p=8475:1100,n4
...
.                   *p=8475:1100,"2008":
.end patch 1.1
         prTPAGE    LASER;*FONT=prtpg10,*p=column1a:1250,*PENSIZE=10,*line=column1b:1250
...
.         Move      "JoseDuenas@nincal.com,Dherric@nincal.com,ShereneKelly@nincal.com,JoeyGamache@nincal.com",MailTo
          ...
          Move      Str55,MailBody
          MOve      "c:\work\pdf\ordSlsprt.pdf",MailAttach
          call      SendMail
          winshow
         pause     "30"
...
ERR      DISPLAY   *P1:1,*ES,"RANGE ERROR :",ERROR;
         ...
         GOTO      ERR
NOfile
         prepare   results,"\\nins1\e\data\text\OrdSlsstats.dat","\\nins1\e\data\index\OrdSlsstats.isi","8","64",exclusive
         return
.
IO       DISPLAY   *P1:24,*EL,"IO ERROR ",ERROR;
         STOP
SendDaveEmail
          Move      "Nord0012 - Alert",MailSubjct
           Clear     MailFrom
           Clear    MailAttach
           If       (user = " " or user = "")
