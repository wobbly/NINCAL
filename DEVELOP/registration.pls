...
//                                                                           //
//                      1.4  25FEB2015  RVW  separated menu, header, and CSS //
//                      1.3  13Nov2012  DLH  replace Dundas.mailer           //
...
.START PATCH 1.4 ADD LOGIC    
     call CGIRenderUniversalCSS
     call CGIRenderMenu
.END PATCH 1.4 ADD LOGIC  
    ///////////////////////////////////////////////////////////////////////////
    ...
    if not over
        if (cgiemail = fUserIO.email)
            ...
            pack errorMsg from "This email address is already registered.  Click ":
                "<a class='errorMsg' href='/plb-bin/login.plc'>here</a> to log in.</a>"
            call actionDisplay
            return
        endif
    endif
...
.          Pack      Mailfrom,"creques@nincl.com"      .fix typo 2015 Jan 22 DLH
...
.    setprop objMailer,*Body=mailBody
          pack      mailsubjct,"NEW CLIENT REGISTRATION"
