...
//Clean up pre-existing Web Datacard records
          move      C1,NDATWPATH
          move      C1,N6
          DISPLAY   *P01:05,*ef,"Options     : Cleanup"
          loop
                    move      N6,NDATWFLD
                    rep       zfill,NDATWFLD
                    ...
                    add       C1,N6
          DISPLAY   *P01:05,"Options     : Cleanup":
                    *P01:06,"Input File  : Ndatw":
                    *P01:09,"Record Count:",N6;
          repeat
          if (N6 <> C0)
          //There are valid records in the file.
                    ...
                    //Delete them all
                              ...
                              call      NDATWKS
                              until over
                              DISPLAY   *P01:05,"Options     : Cleanup - Deleting":
                              *P01:06,"Input File  : Ndatw":
                              *P01:09,"Record Count:",N6;
                    repeat
          endif
...
.                   ". <br><br>",newline:
.                   "Testing PLease ignore <a href=#"#/contact.htm#";#"> website administrator</a> to correct this problem."
...
WritePLILogo
          ...
          write     htmlfile,seq;"180 Grand Ave, Suite 1545"
          write     htmlfile,seq;"Oakland, CA 94612-3784"
