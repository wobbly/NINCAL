...
.end patch 1.22
.begin patch 1.29
.//Binary    Init      "BINARY"  RVW remove as this is not the issue
.end patch 1.29
...
.begin patch 1.29
		if	(NFTPCOMP = "009406")
.//		Setprop MySite,*TransferType=Binary  RVW remove as this is not the issue
		endif
.end patch 1.29
...
.//   Set the text message that is send with the attachments
                                                  ...
                                                  Display *P10:10,"Connecting to : ",NFTPADDRESS,b5,NFTPCOMP                                                    
                                                            ...
                                                            Setprop MySite,*RemoteFolder=NFTP2RemoteDir         
.begin patch 1.29
.//                                                            Setprop MySite,*TransferType=Binary  RVW remove
.end patch 1.29
