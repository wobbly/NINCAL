...
.//   Set the text message that is send with the attachments
                                                                      ...
                                                                      Call      EmailSupport                            
                                                            Else
.// Patch 1.32 this plus calling the CuteFTP function at the same time makes folders                                                                    Setprop MySite,*LocalFolder=NFTP2LocalDir
...
.// Patch 1.32 this plus calling the CuteFTP function at the same time makes folders                                                                                Setprop MySite,*RemoteFolder=NFTP2RemoteDir                                                                   
                                                                                If (N9 = c0)                                    
.                                                                                         MySite.Status giving taskname 
...
.//If record has been applied then skip - Program will slap SENT_ after it has been applied.                                      
                                                                                                              ...
                                                                                                              If (NFTP2RemoteDir = "/")
													      		Pack CuteRemoteString,NFTP2RemoteDir,taskname1 .//"Fix color coding in Textedit
													      Else
													  		Pack CuteRemoteString,NFTP2RemoteDir,"/",taskname1 .//"Fix color coding in Textedit
                                                                                                              Endif
													      Pack CuteLocalString,NFTP2LocalDir,"\",taskname1  .//"Fix color coding in Textedit
													      Display *P10:16,"Filename : ",taskname1
													      Display *P10:16,Filestring	.//for debug
													      
													      MySite.Upload giving n9 using CuteLocalString,CuteRemoteString
.//													      Display *ES,CuteRemoteString
.//													      Display *ES,CuteLocalString
                                                                                                              If (N9 = c0)                                    
.                                                                                                                       MySite.Status giving taskname           
...
.//End Patch 1.30          													 
															...
															MySite.Download giving n9 using CuteRemoteString,CuteLocalString
.//															Display *ES,CuteRemoteString
.//															Display *ES,CuteLocalString
          														If (N9 = c0)                                    
.                                                                                                                       MySite.Status giving taskname           
