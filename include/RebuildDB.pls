.RebuildDB  - This program builds or rebuilds the database of website hosted datacards

.A.  Go Through Datacard File
.Per each record:
.           1.  Check Usage
.                     a.  If used in <= 2 years
.                                1.  Check if it exists in Database
.                                           a.  If so delete it
.                                2.  Store the info necessary to build a datacard in the database
.                                3.  Go to next record

.///////////////////////////////////////////////////////////////////////////////
.//                                                                           //
.//   PROGRAM:   WebDBFunctions.inc                                           //
.//                                                                           //
.//    AUTHOR:   Robb Whiting rwhitin@nincal.com                              //
.//                                                                           //
.//      DATE:   2015 July 15th                                                 //
.//                                                                           //
.// COPYRIGHT:   2015 Names in the News California Inc.                       //
.//              All rights reserved.                                         //
.//                                                                           //
.//  PURPOSE:    These are the supporting fuctions,                           //
.//              for RebuildDB and UpdateDB.			              //
.//              Written by RVW September 2015.                               //
.//                                                                           //
.//              Ver 1.00  15 Sep 2015 RVW        Created.                    //
.//                                                                           //
.///////////////////////////////////////////////////////////////////////////////
