...
.sort diskin for input to create invrep01. renamed to espinv
.use diskin as input sorted by mlr(3-6),mlrpo(26-37),list desc(182-216)
release  init      "2.51"         JD   27May2005  Do not include orders after 5/19/05    
;Release	Init	"2.5"	DLH 	Invoice conversion
;RELEASE  init      "2.45"             JD  30DEC04 changed font.
;release  init      "2.41"                  DLH    08June2004	Datacard Conversion cleanup
;elease  init      "2.40"                  JD	26MAY2004	Mailer Conversion
;RELEASE  INIT      "2.35"          JD  07FEB2003 using epsimlrs variable.
;RELEASE  INIT      "2.3"        ASH 02OCT2000 NEW SERVER ADDED
.RELEASE  INIT      "2.2"        DLH 27Aug99 NINadj nadjust Y2K
.RELEASE  INIT      "2.1"        DLH 27APR99 NININV Y2K
.RELEASE  INIT      "2.0"         JD08mar99 added new client /93/4417.
.RELEASE  INIT      "1.9"          jd 22oct96 revised to use acs #24/#6319
.                                   LWV/VOLVO 2000.
.RELEASE  INIT     "1.8"         JD  17jan96 add brk read.
...
.
         ...
         MOVE      "NEOM0027" TO PROGRAM
         MOVE      "Epsilon EOQ COMM REG" TO STITLE
         move      c1 to ndatpath
         IFZ       PC
...
.START PATCH 2.3 REPLACED LOGIC
.         open      infile,"g:\data\epsinv"
         PACK      STR35,NTWKPATH1,"epsinv"
         open      infile,STR35
.END PATCH 2.3 REPLACED LOGIC
         ADD       C1 TO HOLDREC
.
...
.
.
READINV  read      infile,seq;invvars
         GOTO      eoj IF OVER
         MOVE      B1 TO RUNFLAG
...
.         COMPARE   FORM72 TO CALCAMT         .adjustment = calcamnt?
          compare    aslrinc to calcamt
             IF        EQUAL                  .YES
...
.            endif
.         endif
         if        (nacd1flag = 1)        .all ready paid out commission
...
.         edit      mlrpayd to paydate
         pack      paydate from mm,slash,dd,slash,yy
         endif
