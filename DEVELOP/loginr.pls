...
.stream *STDOUT,"<?php print ($_POST[cgiusername]) . " " . print ($_POST[password]);  ?>",newline2:
...
//End Patch 03  Code Modification
    ...
    if (cgiPassword = "")
//Begin Patch 03 Code Modified
        move "Password is required!" to errorMsg2
...
.TEMP
    ...
    stream *STDOUT,"<form name='loginForm' method='post' action='http://www.namesinthenews.com/plb-bin/mainmenu.plc'>",newline2:
