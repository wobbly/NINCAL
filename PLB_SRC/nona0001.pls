...
SelectCOunt    FOrm           5
.....................................................
release        init           "3.51"                  DLH   turn off locks on reads
Reldate        Init           "2014 April 2"
.release        init           "3.5"                  DLH   fix having to double click go
.Reldate        Init           "17 May 2012"
.release        init           "3.44"                  DLH   REason code 23
.Reldate        Init           "14 October 2010"
.release        init           "3.43"                  DLH  PLI - allow alphanumeric list order #
.Reldate        Init           "19 march 2008"
.release        init           "3.42"                  DLH  PLI New fields
.Reldate        Init           "8 November 2007"
.if escrow added from PL control tag entry as PL
.if paying from PL  control tag entry as PL
.Allow manual tagging as PL
.for patches prior to 3.41 see archived file Nona0001.3.4.pls
.release        init           "3.41"                  DLH  PLI
.Reldate        Init           "5 November 2007"
.release        init           "3.4"                  DLH   08MAR2005 Invoice Conversion
.Reldate        Init           "8 March 2005"
.release  init      "3.36"                  ASH   02MAR2005 Small Patch to zero-fill Control Number
.Reldate        Init           "02 March 2005"
.release  init      "3.35"                  JD    26MAY2004 Mailer Conversion
.Reldate        Init           "28 May 2004"
.Release        Init           "3.3"          DLH New Notes
.Reldate        Init           "18 January 2004"
.Release        Init           "3.2"          DLH add running balance to galley
.Reldate        Init           "17 December 2003"
.Release        Init           "3.1"          DLH correct select count and totals on 1st screen to reflect only records
.;                                            selected in the event of filter usage
.Reldate        Init           "24 July 2003"
.Release        Init           "3.0"          March2003 DLH GUI
.Reldate        Init           "March 2003"
.as part of release 3.0 all old code purged --- see archives
.release  init       "2.8"           01Feb01 DLH turned of modify mode. - never should have been there.
.release  init       "2.7"           03jul99 JD added daily file write.
.release  init       "2.6"           6May98 DLH NININV Y2K, File expansion
.release  init       "2.5"           27Oct98 ASH NINMOA Y2K, File expansion
.release  init       "2.4"           10octl96 do not allow change trans date.
.release  init       "2.3"          03jul96 no longer write daily moa file.
.release  init       "2.2"         25jan95 DLH new reason codes.
.release  init       "2.1"         more changes to balance display.
.release  init       "2.0"         DLH 28sep94 added mlr & brk help. fixed
.                                 i/o bug.
.RELEASE  INIT      "1.91"         DLH 07JUL94 FIXED COMMENT PROBLEM.     
.release  init      "1.9"         DLH 09jun94 fixed balance display.
.RELEASE  INIT      "1.8"         DLH 18MAR94 CONVERT TO MLR/BRK.
.RELEASE  INIT      "1.7"         DLH 10FEB94  ADD FILTERS ON INQUIRY BY
.                                DATE & CONTROL #.
.release  init      "1.6"         dlh 16sep93  get list number from order
.                                record, cleanup display
.RELEASE  INIT      "1.5"         DLH 23JUL93  FIX TO NMOAIO.INC
.RELEASE  INIT     "1.4"         DLH 16FEB93  GNXTxx.INC
.RELEASE  INIT     "1.3"         DLH 06MAY92   NPASXX, NMOAXX, NMOBXX
.RELEASE  INIT      "R1.2"       DLH 12MAR92   CONVERT TO PCBUS.incLUDES
.RELEASE  INIT      "1.1"
...
.begin patch 3.51
           ...
           move       c3,nownlock
           move       c3,CNCTlock
.          move       c3,complock            .weird company does not display when lock turned off
           move       c3,nrtnlock
           move       c3,nmoalock
           move       c3,ncmplock
...
.               Getitem        NMoa001cEditText009,0,ONACOM
          GetItem   NMoa001cEditText014,0,MoaCOMp
...
.               if      (Reason < 1 or Reason > 22 and reason <> 99)
               if      (Reason < 1 or Reason > 23 and reason <> 99)
.end patch 3.41 & 3.44
...
.check for leap year          
                                ...
                                Else    .leap year        
                                Load    NDD using N2,c31,c29,c31,c30,c31,c30,c31,c31,c30,c31,c30,c31
                                endif        
                                move    DD,N2
                                if (N2 > NDD)
...
.                              ONACOM,REASON,LIST,CHECKNUM,TRANSNUM,nmoabrk
                              MoaComp,MoaFIll,REASON,LIST,CHECKNUM,TRANSNUM,nmoabrk
.end patch 3.42
...
.               Setitem        NMoa001cEditText009,0,ONACOM
          SetItem   NMoa001cEditText014,0,MoaCOMp
.end patch 3.42
               TYPE           INVOICE
               if             equal
               move           c2 to ninvpath
