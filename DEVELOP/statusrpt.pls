...
.//                                                                                                                               //
.//       RElease   2.5       23February2015 RVW  don't print header, just print CSS and Menu                                     //
.//       RElease   2.4       03October2012 DLH   replace contact.htm with index.php/contact-us/                                  //
.//       Release   2.3       14April2009 DLH     Added logic search by Mailer                                                    //
.//                                               fixed bad javacript in statusrpt.htt                                            //
.//                                               created new statysrptmlrnumberresp.htt                                          //
...
sortedOutput            varlist cgiOrderName:           //001-260
                                cgilistnum:             //261-266
                                cgimailernum:           //267-272
                                cgimailername:          //273-322
                                cgiponum:               //323-334
                                cgimailerkey:           //335-346
                                cgimailerdate:          //347-361
                                cgistatus:              //372-381
                                cgiorderqty:            //392-427
                                cgiexcrent              //428-437
.end patch 2.3
...
readKey             dim     12
.begin patch 2.3
readMethod          dim     1   // O=order id,L=List, "-"=other ,M=Mailer
...
.httName             init    "statusrptdevo.htt"            .testing
...
.                             stream    *STDOUT,"No company set up in your user account.  Please contact support!"
                              stream    *STDOUT,"No company set up in your user account.  Please contact your <a href=#"#/index.php/contact-us/#";#"> NIN representative</a>!"
...
.///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
actionProcess
.         stream    *STDOUT,"CGIordernum =  ",cgiordernum," cgimailernum = ",cgimailernum," cgilistnum = ",cgilistnum:
.                   "cgiother = ",cgiother,". <br><br>",newline2
...
.                    move      cgiMailerNum,nwk4
.                    move      nwk4,cgiMailernum
.                    replace   " 0",cgiMailernum
                    move      nwk4,str4
                    rep       zfill,str4
                    move      "M",readMethod
                    move      str4,readkey
.                    move      cgiMailerNum,readKey
.end patch 2.3
          elseif (cgiListNum <> "")
.                    clear     CgimailerNum
...
.testing
        call actionDisplay
.         stream    *STDOUT,"CGIordernum =  ",cgiordernum," cgimailernum = ",cgimailernum," cgilistnum = ",cgilistnum:
.                   "cgiother = ",cgiother,"cgisearchflag = ",cgisearchflag,". <br><br>",newline2
.          pause     "10"
...
.         stream    *STDOUT,"CGIordernum =  ",cgiordernum," cgimailernum = ",cgimailernum," cgilistnum = ",cgilistnum:
.                   "cgiother = ",cgiother,"ReadMEthod = ",readmethod,". <br><br>",newline2
.          pause     "10"
    if (readMethod = "L")
...
.begin patch 2.3
          ElseIF    (ReadMethod = "M")
          call      CGIDisplayFile using "statusrptmlrnumberresp.htt"
...
.                              stream *stdout,"<tr><td colspan=10 align=center class=datarow1><br>You are not currently set up to view Order records.  Please contact your <a href=#"#/contact.htm#";#"> NIN representative</a>.<br><br></td></tr>"
                              stream *stdout,"<tr><td colspan=10 align=center class=datarow1><br>You are not currently set up to view Order records.  Please contact your <a href=#"#/index.php/contact-us/email-us/#";#"> NIN representative</a>.<br><br></td></tr>"
.END PATCH 1.7 REPLACED LOGIC
                              noreturn
                              return
                    endif
...
.         stream    *STDOUT,"CGIordernum =  ",cgiordernum," cgimailernum = ",cgimailernum," cgilistnum = ",cgilistnum:
.                   "cgiother = ",cgiother,". <br><br>",newline2:
.                   "readmethod = ",readmethod," Readkey = ",readkey
.          pause     "10"
...
.begin patch 2.3
    case "M"
        packkey nOrdFld1 from "01X",readkey
        call NordLast
