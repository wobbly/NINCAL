...
.======================================================================
        ...
        prtpage prfile;*pTitle4:row,*font=font12,*ALIGNMENT=*CENTER,*boldon,*ll,*ULON,"Misc Team Client Report",*ULOFF,*boldoff;
        add     eightlpi,row
        add     "60",row
        if      (rptflag = c1)
        	prtpage prfile;*pTitle4:row,*font=font12,*ALIGNMENT=*CENTER,*boldon,*ll,*ULON,"By Volume",*ULOFF,*boldoff;
        endif
        if      (rptflag = c2)
...
PrintLV1
        BrokerListView.SortColumn using *Column=0,*Type=4
