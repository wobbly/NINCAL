...
.         GOTO      PLUS IF EQUAL
         compare     "05" in  SALESBR         turned on 11/26/03.
         GOTO      check2 IF NOT EQUAL
         MOVE      C0 TO N2
         MOVE      OODTEM TO N2
         COMPARE   N2 TO c3
         IF        LESS
         ...
         ENDIF
CHECK2
         compare     "10" in  SALESBR         turned on 11/26/03.
...
.
.                                       3   5  3  7  4  6    3  1  8
.   LOAD      SALESNUM FROM SALESBR OF SAD,BO,SA,AL,NP,LSTM,SK,JC,COLD
.                                       1    2  3  4  5  6   7   8  9
.
.         TEAM# -   7  1  1  7  7   7   2   4   1  6    5  3  3
.                   MM,BS,CD,BC,SMM,CY,??, MF,??,LSTM,??,??,MG
