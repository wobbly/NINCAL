PC       EQU       0
         ...
         include   nmoddd.inc
          ...
          Include Compdd.inc
          Include Cntdd.inc   
RELEASE  INIT      "1.05"      DLH Remove Reuben
reldate   Init      "2015 May 18"
.RELEASE  INIT      "1.04"      DLH added Denise
.reldate   Init      "2015 April 20"
.RELEASE  INIT      "1.03"      DLH remove Inga
.reldate   Init      "2014 September 24"
.RELEASE  INIT      "1.02"      DLH Add Amy
.reldate   Init      "2014 July 14"
.RELEASE  INIT      "1.01"      DLH Remove Pia
.reldate   Init      "2013 September 9"
.RELEASE  INIT      "1.0"      DLH New pull rolling report of lists updated last 12 mos and usage
...
....................................................................
         ...
         MOVE      "Weekly List Rolling Report" TO STITLE
...
....................................................................
         ...
         sub        "365" from Juldays           .rolling 12 months       
         move       Juldays to Today2
         sub        "180" FROM jULDAYS           .temporary rolling 18 months
         move       juldays,Today3
.
          if        (prtname = "")
          Move      "Weekly",prtname
...
.        setprop ex,*Visible="True"
              ...
              setprop sheet.range("l6","l6"),*Value="Planner",*HorizontalAlignment=xlAlignCenter
              setprop sheet.range("l6:l6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("l6:l6").Font,*Bold="True"

              setprop sheet.range("m6","m6"),*Value="Caller",*HorizontalAlignment=xlAlignCenter
...
CHECK   
         ...
         CALL      CVTJUL
          if        (juldays >= Today3 & Juldays <= today1)
          call      INFo
          endif
         GOTO      a100
...
INFO     add       c1 to count1
         display   *p10:14,"updated last 365 days",count1
...
.Email new XLS to User
                              move    "Here is your Weekly Rolling List Management Report",MailSubjct
                              pack    MailBody,"Input File:  ",INPNAME
                              pack      MailBOdy,"Input File:  ",INPNAME
          if        (func = "1")
                              Pack      MailTO from User,"@nincal.com"
          elseif    (func = "2")
                              Pack      MailTO from "Sanstra@NINCAL.com,SMcguir@NINCAL.com,JMagee@NINCAL.com,CFrazer@NINCAL.com,":
                                        "JCox@NINCAL.com,LDebarr@nincal.com,AFrey@nincal.com,DHubbar@nincal.com"
.                                        "JCox@NINCAL.com,KWatkin@nincal.com,LDebarr@nincal.com,AFrey@nincal.com,DHubbar@nincal.com"
.                                        "IBEck@NINCAL.com,JCox@NINCAL.com,KWatkin@nincal.com,LDebarr@nincal.com,RHollan@nincal.com,AFrey@nincal.com"
.                                        "IBEck@NINCAL.com,JCox@NINCAL.com,KWatkin@nincal.com,LDebarr@nincal.com,PPayne@nincal.com,RHollan@nincal.com"
                              move    "Here is your Weekly Rolling List Management Report",MailSubjct
