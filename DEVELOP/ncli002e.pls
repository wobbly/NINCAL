...
.Create/Add a single Workbook
        books.open using "c:\andrew\strategic\lmlost.xls"
        books2.open using "c:\andrew\strategic\AprilBoardMeetingDraft4.xls"
...
.add one new Worksheet each time a Workbook is created.
        ...
        //Second Sheet is used for LM lost Clients!!
        sheets2.item giving sheet2 using 4
.
	move	C1,NDATPATH
	move	C1,NOWNPATH
	move	C1,NXRFPATH
...
.=(DAYS360(C17,G2)/365)  representation of formula
		pack	taskname,"=(DAYS360(R",str9a,",T",str9a,")/365)"
		setprop sheet2.range(str11a),*Formula=taskname
...
.Autofit
	...
	sheet2.range(str25).Columns.Autofit
	pack	str25,"T6:T",str9a
	sheet2.range(str25).Columns.Autofit
	pack	str25,"U6:U",str9a
	sheet2.range(str25).Columns.Autofit
.Alignment
	pack	str25,"A7:U",str9a
