...
DATACHANNEL           DIM        4                     .//store PASV or PORT to change DataChannel
COUNTDRAC  INIT       1
check                 FORM       1
...
.//Load the variables into the MySite class
	   ...
	   MOVE "PORT",TRANSFERTYPE
	   MOVE "PORT",NFTPPROTOCOL
	   MOVE "PORT",NFTPUSERNAME
           MOVE "
...
.//                      If (N9 = c0)                                    //we don't have rights to do this at the moment
                      if (c1 == c2)
...
CleanVars
           ...
           SQUEEZE   NFTPUSERNAME,NFTPUSERNAME
           SQUEEZE   NFTPPASSWORD,NFTPPASSWORD
           SQUEEZE   DATACHANNEL,DATACHANNEL
           return
