...
.                    setprop sheet.range("g6","g6"),*Value="LO Num."
                    setprop sheet.range("g6","g6"),*Value="Description"
                    setprop sheet.range("h6","h6"),*Value="Price"
.                    setprop sheet.range("h6","h6"),*Value="List Owner"
                    setprop sheet.range("i6","i6"),*Value="Comm."
                    setprop sheet.range("j6","j6"),*Value="Status"
