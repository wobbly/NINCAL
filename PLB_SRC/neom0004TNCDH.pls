...
File	FIle
...........................................
RELEASE	INit	"1.00"      DLH  20Aug2007 REads disking spits out goodies
...
.
         ...
         MOVE      "Add Hoc INVOICE REGISTER" TO STITLE
...
.         append    "\\nins1\d\users\accounti\gl\clninv." to str45
         append    "\\nins1\d\accounting\gl\clninvTNC." to str45
...
READINV  
.	Loop
INput	read	File,Seq;ordvars
	goto	Total if over
	packkey	Ninvfld,Olrn
	CALL       NINVKey

            GOTO      process1 IF  not OVER
	Goto 	INput
.	repeat
.	GOTO      TOTAL
