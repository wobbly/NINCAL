...
.//       include   nfuldd.inc
          ...
          Include Cntdd.inc   
.//Patch 3.8.9      
Release   Init      "3.92"   DLH   increase variable size for excel locations (only had room for 999)
REldate   INit      "13 May 2009"
.Release   Init      "3.91"   DLH   add google tracking
.REldate   INit      "17 March 2009"
.Release   Init      "3.90"   DLH   Remove Newsletter Link
.REldate   INit      "09 May 2008"
...
.LINE5A   DIM       5
.LINE5B   DIM       10
.begin 3.92 to find version of excel  DH 04/02/09
#VERSION  DIM 10
#VER_F    FORM 4.2
#VER      FORM 1 1=EXCEL 2007 OR LATER
.end 3.92 to find version of excel
.......................
LINE1    DIM       150
LINE1A   DIM       5
LINE1B   DIM       10
...
.        setprop ex,*Visible="True"
              ...
              setprop sheet.range("q6","q6"),*Value="Status",*HorizontalAlignment=xlAlignCenter
