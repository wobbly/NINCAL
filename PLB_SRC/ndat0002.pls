...
.end patch 1.42
          include winapi.inc
Release   INit      "1.56"    DLH   .use insertitemEX to speed up listview  turn off filepis, add that as option in nrefdd
Reldate   INit      "2016 May 11"
.Release   INit      "1.55"    DLH   .PDF_FLAGS
...
.begin patch 1.56
                                 MOVE     "9999",CurIndex
                                 selectlistview.InsertItemEX Using NSELINDEX,CurIndex:
                                 *SubItem1=NSELNUM:
                                 *SubItem2=NSELLIST
...
.                              selectlistview.SetItemText giving N1 using N8,NSELLIST,2
                                 ...
                                 select2listview.InsertItemEX Using NSELINDEX,CurIndex:
                                 *SubItem1=NSELNUM:
                                 *SubItem2=NSELLIST
...
.argh what is going on        
                              ...
                              pack      Mailreply from DimPtr2,"@nincal.com"
          elseif (CallFlag = 0)
...
Own9
          ...
          if (ownfax <> "")
                    ...
                    pack      str15,"(",#str3,")",b1,str3,DASH,str4
                    prtpage DataCardPrint;*p4000:ROW,*ALIGNMENT=*LEFT,*font=CourierNew12,*ll,str15,"-Fax";
                    add       SingleSpaced to Row
          endif
          if (ROW   >= LastLine)
