...
Release    INIT    "1.32"               DLH      .Excel 2013 *WindowState=xlMinimized
Reldate   Init      "2014 January 22"
.Release   Init      "1.31"     DLH  rearrange output per Suzie
...
. FILE OPENING SEQUENCE
         ...
         MOVE      "NDAT0045" TO PROGRAM
           ...
           ENDIF
         MOVE      "Midmonth Monthly List" TO STITLE
         CLOCK     DATE TO DATE
...
.add one new Worksheet each time a Workbook is created.
        ...
        create xlColumnWidth,VarType=VT_R8A,VarValue="11.14"
        create xlColumnWidthA,VarType=VT_R8,VarValue="14.71"
        create xlColumnWidthB,VarType=VT_R8,VarValue="57.29"
...
.begin patch 1.31
              setprop sheet.range("A6","A6"),*Value="List ##",*HorizontalAlignment=xlAlignCenter
              setprop sheet.range("A6:A6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("A6:A6").Font,*Bold="True"

              setprop sheet.range("B6","B6"),*Value="Last Updated",*HorizontalAlignment=xlAlignCenter
              setprop sheet.range("B6:B6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("B6:B6").Font,*Bold="True"

              setprop sheet.range("C6","C6"),*Value="List Name",*HorizontalAlignment=xlAlignCenter
              setprop sheet.range("C6:C6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("C6:C6").Font,*Bold="True"


              setprop sheet.range("d6","d6"),*Value="Universe",*HorizontalAlignment=xlAlignCenter
              setprop sheet.range("d6:d6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("d6:d6").Font,*Bold="True"

              setprop sheet.range("e6","e6"),*Value="Uses in the last 12 months",*HorizontalAlignment=xlAlignCenter,*WrapText=OTRUE
              setprop sheet.range("e6:e6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("e6:e6").Font,*Bold="True"
.note word wrap this cell and column width = 8.43

              setprop sheet.range("f6","f6"),*Value="Caller",*HorizontalAlignment=xlAlignCenter
              setprop sheet.range("f6:f6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("f6:f6").Font,*Bold="True"
.new
              setprop sheet.range("g6","g6"),*Value="Action",*HorizontalAlignment=xlAlignCenter
              setprop sheet.range("g6:g6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("g6:g6").Font,*Bold="True"
.Note column width = 57.29
.new
              setprop sheet.range("h6","h6"),*Value="Date of Action",*HorizontalAlignment=xlAlignCenter,*WrapText=OTRUE
              setprop sheet.range("h6:h6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("h6:h6").Font,*Bold="True"
.Note column width = 14.71
.new
              setprop sheet.range("i6","i6"),*Value="Update Request Sent",*HorizontalAlignment=xlAlignCenter,*WrapText=OTRUE
              setprop sheet.range("i6:i6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("i6:i6").Font,*Bold="True"
.note word wrap this cell and column width = 14.71
.new
              setprop sheet.range("j6","j6"),*Value="Notes",*HorizontalAlignment=xlAlignCenter
              setprop sheet.range("j6:j6").Font,*Name="Times New Roman", *Size=14
              setprop sheet.range("j6:j6").Font,*Bold="True"

              setprop sheet.range("k6","k6"),*Value="Owner",*HorizontalAlignment=xlAlignCenter
...
.Begin patch 1.31
              ...
              pack      str10,MM,SLASH,DD,SLASH,CC,YY
              pack            str12,"B",str9
              setprop         sheet.Range(str12),*Value=str10,*HorizontalAlignment=AlignRight,*NumberFormat="MM/DD/YY"
              pack            str12,"C",str9
              setprop         sheet.Range(str12),*Value=Mlstname
              pack            str12,"D",str9
              setprop         sheet.Range(str12),*Value=Universe,*NumberFormat="##,####0_);[Red](##,####0)" 
              pack            str12,"E",str9
              ...
              pack            str12,"H",str9
              setprop         sheet.Range(str12),*Value=b1,*HorizontalAlignment=AlignRight,*NumberFormat="MM/DD/YY"
              pack            str12,"I",str9
              setprop         sheet.Range(str12),*Value=b1,*HorizontalAlignment=AlignRight,*NumberFormat="MM/DD/YY"
...
.begin patch 1.3
.begin patch 1.31
.sort by caller, list name, set column widths
         Setprop Sheet.Range("E1"),*ColumnWidth=xlColumnWidth
         Setprop Sheet.Range("H1"),*ColumnWidth=xlColumnWidthA
         Setprop Sheet.Range("I1"),*ColumnWidth=xlColumnWidthA
         Setprop Sheet.Range("G1"),*ColumnWidth=xlColumnWidthB
          move      c1,index
...
.send the file          
          Move      "Here is the Midmonth Monthly List Update Project report",MailSubjct
...
.          Move      "IngaBeck@nincal.com,SusanAnstrand@nincal.com,JenniferCox@NINCAL.COM",MailTo
          ...
          Move      "SuzieMcGuire@nincal.com,DeniseHubbard@nincal.com",MailTo
.begin patch 1.3
