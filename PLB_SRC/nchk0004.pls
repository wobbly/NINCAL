...
PC       EQU       0
         ...
         inc       hp.inc
.
Release   init     "2.72"               DLH change recon file from BOA format to Union Bank
Reldate   Init      "18 July 2012"
.Release   init     "2.71"               JD indicate NIN guarantee on check log 
.Reldate   Init      "15 May 2009"
...
.          Pack      Str55 from "e:\data\BOA",Comment,".dat|10.10.30.103:502"
          Pack      Str55 from "e:\data\UB",Comment,".txt|10.10.30.103:502"
          rep       Zfill in str55
...
.          Write     BofAfile,seq;CheckN,Amount,"318","002335503898",RCDATE," ","000000","00000000000","                  ","  "
          if        (rcapay > 0)
          Write     Bankfile,seq;*edion=tab,UBDate,CheckN,Amount,rpayee
          endif
.end patch 2.7
SkipBOA
          reset     rcchek
