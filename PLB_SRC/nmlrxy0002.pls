...
Release    INIT    "1.2"               DLH      .Excel 2013 *WindowState=xlMinimized
Reldate   Init      "2014 January 22"
.release init    "1.1"         ASH       12JUN2007 PLI Inclusion
...
.        setprop sheet.range("G3"),*Value="Comments"
        setprop sheet.range("A3"),*Value="Mailer 1"
        setprop sheet.range("B3"),*Value="Mailer 1 Name"
        setprop sheet.range("C3"),*Value="Company 1"
        setprop sheet.range("D3"),*Value="Mailer 2"
        setprop sheet.range("E3"),*Value="Mailer 2 Name"
        setprop sheet.range("F3"),*Value="Company 2"
        setprop sheet.range("G3"),*Value="Date"
        setprop sheet.range("H3"),*Value="Special Arrangements"
        setprop sheet.range("I3"),*Value="Comments"
...
........................
                              ...
                              pack      str10,"C",str9
                              if (CompExcl = "P")
                                        setprop sheet.range(str10),*Value="PLI"
                              else
                                        setprop sheet.range(str10),*Value="NIN"
                              endif
                              move      NMLRXYMLR2,COMPFLD
                              move      "2-COMPKEY",Location
                              pack      KeyLocation,"Key: ",COMPFLD
