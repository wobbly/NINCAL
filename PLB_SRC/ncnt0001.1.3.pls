...
.Prep screens
        call    ContactLoadDataListSearch
        call    ContactLoadComboTeam
.        call    ContactLoadDataLists
        setitem CNTDataListSearch,1,1
...
ContactDisableUpper
        ...
        setprop CNTDataListSearch,enabled=0,bgcolor=grey
        return
...
.Allow Exit
        ...
        setprop CNTDataListSearch,enabled=1,bgcolor=white
        return
...
.begin patch 1.3
          SETprop     CNTEditTextInits,enabled=1,bgcolor=grey
...
.No more checking required its an inactive sales record
                    ...
                    READ      NCNTFIL4,NCNTFLD4;*tab=114,str1
...
.Reset StatText Boxes
                ...
                getitem CNTDataListSearch,1,N4
                if (N4 > C0)    .There are entries
                        move    C1,N3
                        loop
                                getitem CNTDataListSearch,N3,str2
                                until (N3 > N4)
                                until (str2 = CNTNUM)
                                add     C1,N3
                        repeat
        ...
        setitem CNTDataListSearch,1,N3
...
.                insertitem CNTDataListSearch,999,hold
...
.        repeat
.        return
ContactLoadDataListSearch
        deleteitem CNTDataListSearch,0
