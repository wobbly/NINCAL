;for SI...to show mailer number for order qty of brokerage orders...see sinord0030
PC      EQU       0
        include common.inc
        include cons.inc
        INCLUDE   NORDDD.inc
...
FILEONE   FILE 
	prepare	fileone,"c:\work\fileone.csv"
...
. 	CREATE BROKERLISTVIEW=4:5:5:60,SORTHEADER=1:
	...
	BROKERLISTVIEW.INSERTCOLUMN  USING "Client",140,2
        ...
        BROKERLISTVIEW.INSERTCOLUMN  USING "MLRNUM",5,4
...
SORTER1
.sort by Volume
      	   	pack   taskname,sortfle,";",CLINTSRT,comma,"s=1<>","'",Salesper,"'"
                goto   dosort
SORTER2
...
.Read records and insertthem in the listview
         loop
	       	READ  INFILE,SEQ;STR2,OSLS,MCOMP,OODTEM,OODTEY,NUMOLD,QTYOLD,NUMNEW,QTYNEW,brcomp,mkey
          until over
		if (oodtey = "02")
			if (oodtem <>"12")
				goto looper1
		...
		if (numnew = c0)
	                LOAD  NUMVAR using yearflag,NUMNEW,NUMOLD
        	        LOAD  QTYVAR using yearflag,QTYNEW,QTYOLD
		endif
...
.                        call trim using str9
		        ...
		        brokerListView.SetItemText giving N8 using N7,MKEy,4
        	else
...
.Printing all on one document
        ...
        if (osflag = c2)
        	...
        	PRTOPEN prfile,"Laser6","Monthly Broker Report",noprint,spoolfile=str40
        endif
        call Page
...
.Client
	       	BrokerListView.GetItemText giving str4 using n9,4
                prtpage prfile;*p1900:row,*font=font12,*ALIGNMENT=*Left,str4;
...
.                prtpage prfile;*pcolumn1:row,*font=font12,*ALIGNMENT=*Left,str9;
                clear str9
	       	BrokerListView.GetItemText giving str10 using n9,0
       	        move str10 to qtynew
       	        prtpage prfile;*pcolumn6:row,*font=font12,*ALIGNMENT=*Left,str10;
.       	        prtpage prfile;*pcolumn2:row,*font=font12,*ALIGNMENT=*Left,str9;
		write	fileone,seq;*CDFON,str4,str35,numnew,qtynew
        	add c1 to RowCount
                add NUMNEW to OTOT1
                add QTYNEW to QTOT1
...
.                prtpage prfile;*pcolumn:row,*font=font12,*ll,*ALIGNMENT=*Left,MCOMP;
        	...
        	add c1 to RowCount
                add NUMNEW to OTOT1
                add QTYNEW to QTOT1
		write	fileone,seq;*CDFON,mkey,str35,numnew,qtynew
        endif
                move str45 to holdcomp
.                move mcomp to holdcomp
.        goto    EndLoop
