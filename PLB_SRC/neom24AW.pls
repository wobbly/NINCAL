;..............................................................................
;NEOM24AW - list owner income summary report
;
;  Andrew Harkins
;  December 17, 2004
;
;  This program is a copy of NEOM024A.PLS.  This copy, for CARE only,  creates single copies
;  of the CARE version of the Owner Activity Report.  These individual copies
;  will then be placed on our website.
;
;  This program does not do the updates or printing options available in NEOM024a!!
;
;  This program runs alongside NEOM024A.PLS.  However, this program MUST run second as NEOM024A cleans up the destination directory!!
...
release	init	"1.2"	DMB 26JAN2006  Folder Restructure nins1 E
.release	init	"1.1"	ASH 25FEB2005  Added logic to test for empty Input file
.release	init	"1.0"	ASH 14DEC2004
;
...
.NINLogo	PICT
	...
	MOVE	"CARE OAR for Website" TO STITLE
	Move	c3 to NMLRLOCK
	Move	c3 to NordLOCK
	Move	c3 to NdatLOCK
CHOOSE
...
.This program runs along with NEOM024W.PLS.  Note that THAT program actually cleans the receiving directory.
.It should always run first, otherwise the receiving directory is never cleaned and we have a problem.
...
.		pack	COMPFLD,"))))))"
.	endif
.	move	"redsls1a-COMPKEY",Location
.	pack	KeyLocation,"Key: ",COMPFLD
.	call	COMPKEY
.........................
	move	SLSMLR,COMPFLD3
...
.Force an over
	...
	move	"redsls1a-COMPKEY3",Location
	pack	KeyLocation,"Key: ",COMPFLD3
	call	COMPKEY3
	call	readtax
	goto getmore
...
;
	...
	clear	str4
	clear	str2
	UNPACK	SlsMDTe TO str2,str2,str4
	...
	clear	str4
	clear	str2
	UNPACK	SlsiDTe TO str2,str2,str4
	pack	str6 from str4,str2
	RESET	STR6                         .MMDDYY
