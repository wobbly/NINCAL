...
release init    "1.2"         DLH Excel 2013
Reldate   Init      "2014 January 22"
.release init    "1.1"         ASH 11JUN2007 Added logic for PLI
...
.
          setprop sheet.range("C4"),*Value="Corporate"
        setprop sheet.range("D4"),*Value="Mailer?"
        setprop sheet.range("E4"),*Value="Broker?"
        setprop sheet.range("F4"),*Value="List Owner?"
        setprop sheet.range("G4"),*Value="Service Bureau?"
        setprop sheet.range("H4"),*Value="Consultant?"
        setprop sheet.range("I4"),*Value="List Manager?"
        setprop sheet.range("J4"),*Value="Old Mailer"
        setprop sheet.range("K4"),*Value="Old Broker"
        setprop sheet.range("L4"),*Value="Old Owner"
        setprop sheet.range("M4"),*Value="Old Service Bureau"
...
.begin address patch
                    pack      str11,"N",str9
                  setprop sheet.range(str11),*Value=COMPADDR
                    pack      str11,"O",str9
                    Clear     Str55
                    call      Trim using Compcity
                    pack      Str55 from COMPCITY,",",CompState,b1,CompZip
                  setprop sheet.range(str11),*Value=str55
                    pack      str11,"P",str9
                  setprop sheet.range(str11),*Value=COMPPhone
.end address patch
