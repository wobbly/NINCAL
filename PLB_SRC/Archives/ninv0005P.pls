...
.end patch 3.0
Release        Init           "3.37"       13January2009 JD    New Year
.Release        Init           "3.36"      4January2008  DLH   New Year
.Release        Init           "3.35"      30Apr2007  DLH   PLI
...
.begin patch 3.35
Results   IFILE      Keylen=6,FIX=35,Name="InvStatP.isi|10.10.30.103:502"       .PHYSICAL OUTPUT FILE 'INVSTATS.isi'
.end patch 3.35
.end patch 3.2
.file layout
...
.
.Begin patch 3.0
         OPEN      Results,"InvStatP.isi|10.10.30.103:502",exclusive
...
START    TRAPCLR   IO
         NORETURN
.begin patch 3.0
         DISPLAY   *P10:12,*EF,*HON,"InvStatP File NOT FOUND. IT WILL BE CREATED."
.end patch 3.0
         BEEP
...
.         Prepare   Results,"\\nins1\e\data\text\INVStats.dat","\\nins1\e\data\index\INVStats.isi","6","33"
         Prepare   Results,"\\nins1\e\data\text\INVStatP.dat","\\nins1\e\data\index\INVStatP.isi|10.10.30.103:502","6","35"
..end patch 3.2
.end patch 3.35
...
. .....SCREEN DISPLAY;
.
DISPLAY  DISPLAY   *ES,*P31:24,"***** Ninv0005P *****",*R,*R:
.begin patch 3.0
                   *P12:24,"Pacific Lists Inc.";
...
.                                if (time3 > 5500) .55 Seconds Maximum
              ...
              repeat
          Move      "Here is your PL billing PDF File",MailSubjct
          Move      "Creques@nincal.com",MailFrom
          Move      "Dherric@nincal.com",MailTo
          Move      Str55,MailBody
          MOve      "c:\work\pdf\invprtP.pdf",MailAttach
          call      SendMail
