...
release init    "2.5"   DLH       .add email link and pdf functions
reldate init    "2016 March 18"
.release init    "2.4"   DLH       Use API to change file attributes
.reldate init    "2015 May 13"
.release init    "2.3"   DLH       Moved Samples to PDF from TIFF
.reldate init    "2014 November 24"
...
.END PATCH 1.6 ADDED LOGIC
        ...
        setprop SamplesModify,visible=1
        return
...
.END PATCH 1.6 ADDED LOGIC
        ...
        setprop SamplesDelete,visible=1,enabled=1
        setprop SamplesModify,visible=0
        return
...
.                    pack      FileName1,taskname,"\teachers.tif"
                    pack      FileName1,taskname,"\teachers.pdf"
.end patch 2.3
...
..begin patch 2.3 don't use pict use webbrowser

        loop
                getprop SamplesExplorer1,*ReadyState=result
                until (result = 4)      .ReadyState_Complete=4
        repeat
           SamplesExplorer1.Navigate2 USING Taskname

           setfocus   SamplesExplorer1
.
.                  clear   N9
...
.END PATCH 2.2 ADDED LOGIC
                    ...
                    setprop   SamplesProceed,enabled=0,height=0
.begin patch 2.3
.                    pack      FileName2,SmpPAth,"s",NSMPMLR,NSMPNUM,".tif"
                    pack      FileName2,SmpPAth,"s",NSMPMLR,NSMPNUM,".pdf"
...
.                    append    " +r",taskname
                    ...
                    winapi     SetAttrib giving RETURN using FileName2,Attributes
.                    execute   taskname
.end patch 2.4
.
...
.........................
        clear   APIFileName
        pack    APIFileName,SmpPAth,"S",NSMPMLR,NSMPNUM,".DCX",hexzero
...
.                pack    APIFileName,SmpPAth,"bmp",str10,".bmp",HexZero
...
.;                pack    APIFileName,SmpPAth,"bmp",str10,".pcx",HexZero
