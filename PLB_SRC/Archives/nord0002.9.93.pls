...
LONGDIST DIM        1
DCX       INIT      ".TIF"
.begin patch xxx  This is part of the owner record now
...
.non LM first
SortBrk             Display   *p1:22,*el,"sorting Nprint.dat to Nprint.Brk"
...
Rerun
                    ...
                    open      INPUT,"\\NinS1\e\data\NPRINT.TMP"
...
.Prep for Owner run
                                        ...
                                        pack      KeyLocation,"SEq "
                                        trap      IOMssg giving Error if IO
                                        open      INPUT,"\\NinS1\e\data\NPRINT.OWN"
...
.Prep for Fulfillment run     
                                        ...
                                        pack      KeyLocation,"SEq "
                                        trap      IOMssg giving Error if IO
                                        open      INPUT,"\\NinS1\e\data\NPRINT.FUL"
...
.Prep for Office run, which includes creation of file for Overlay run
                                        ...
                                        pack      KeyLocation,"SEq "
                                        trap      IOMssg giving Error if IO
                                        open      INPUT,"\\NinS1\e\data\NPRINT.LR"
...
.Prep for Overlay run
                                        ...
                                        call      FindFirstFile
                                                  ...
                                                  open      INPUT,"\\NinS1\e\data\NPRINT.OVR"
...
.end patch 9.91
                    ...
                    scan      OSTAT,rprtcode
                              if not equal
.begin patch xxx this check now part of the owner record
.                                        if (formflag <> "2")
                                        call      CreateRecord
...
..................................................Regular run
          if (hotflag = 1 & ReRunFlag <> yes)    .Full Run
                    ...
                    Weof      Output2,seq
                    close     output2
                    open      dfile,"\\NinS1\e\data\orders.FAX"
                    Clear     MailBody
