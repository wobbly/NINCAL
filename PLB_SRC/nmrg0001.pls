...
.START PATCH 1.61 REMOVED LOGIC
         include   winapi.inc
.
RELEASE   INIT      "2.05"          DLH new field mlr list code
Reldate   Init      "2016 March 16"
.RELEASE   INIT      "2.04"          DLH New fax gateway
...
.         setitem   MergeOrderdate,0,str10
          ...
          setitem   Nmrg001aStatKey,0,nmrgkcod
          ...
          setitem   Nmrg001aStatMlstcde,0,OmlrLstCd           
...
MergeSearchLoadList
           ...
           MergeSearchListView.DeleteAllItems
...
MergeCLearLower
          ...
          setitem mergemp,0,""
          setitem Nmrg001aStatMlstcde,0,""
          setitem mergenet,0,""
          setitem mergetotrej,0,""
          setitem mergelistinfo,0,""
          setitem Nmrg001aStatKey,0,""
          return
...
adddisp
          ...
          setprop   Nmrg001aStatMlstcde,enabled=0,bgcolor=grey  
          ...
          setitem   Mergemp,0,omlrky
          setitem   Nmrg001aStatMlstcde,0,OMlrLstCd
          setprop   Mergemp,enabled=1,Visible=1
          setprop   Nmrg001aStatMlstcde,enabled=1,Visible=1
