...
httName             init    "statusrptdevo.htt"
...
.begin patch xxx
          call      CGIParse using "cgisearchflag",cgisearchflag
.end patch xxx
.START PATCH 1.9 REMOVED LOGIC
...
.begin patch 2.3
                    ...
                    Elseif        (cgiSearchFlag = "1")
.look up mailer number
                    cLEAR     cGImAILERnUM
                   packkey    NXRFFLD from CgiListNum
                    rep       zfill,nxrffld
                   move       c1,nxrfpath
         stream    *STDOUT,"Nxrffld =  ",Nxrffld," cgimailernum = ",cgimailernum," cgilistnum = ",cgilistnum:
                   "cgiother = ",cgiother,"cgiSearchFlag = ",cgisearchflag,". <br><br>",newline2
                   call       nxrfkey
                   if         not over
.call company file and get oldmailer number                   
                    packkey   compFld,thisSession.userCompany
                    call      COMPKEY
                              if over
.                                       // no results
                                       ...
                                       "cgiother = ",cgiother,"cgiSearchFlag = ",cgisearchflag,". <br><br>",newline2
                                        ...
                                        reset     validMailers
                                        scan      Compoldmlr,validMailers
                                                  if equal
                                                  move       Compoldmlr,CgiMailerNum
                                                  endif
                                        endif                                        
                              endif
.check against valid mailers
                    move      cgiMailerNum,nwk4
                    move      nwk4,cgiMailernum
                    replace   " 0",cgiMailernum
                    move      "M",readMethod
...
.                             stream *stdout,"<tr><td colspan=10 align=center class=datarow1><br>You are not currently set up to view Order records.  Please contact your NIN representative.<br><br></td></tr>"
                              stream *stdout,"<tr><td colspan=10 align=center class=datarow1><br>You are not currently set up to view Order records.  Please contact your <a href=#"#/index.php/contact-us/#";#"> NIN representative</a>.<br><br></td></tr>"
.END PATCH 1.7 REPLACED LOGIC
                              noreturn
                              return
                    endif
