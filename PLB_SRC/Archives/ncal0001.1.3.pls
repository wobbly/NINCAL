...
.
        ...
        add     howmany,N8,result
        create  Report;CheckBoxes(4)=howmany:result:N9:N10,"Print Preview",font="'>MS Sans Serif'(10)"
.begin patch 1.4
        getprop ReportCheck5,top=howmany
        add     howmany,N8,result
        create  Report;CheckBoxes(5)=howmany:result:N9:N10,"Send to Excel",font="'>MS Sans Serif'(10)"
...
CallDisableLower1
        ...
        setprop Call1EditDate3,enabled=0,bgcolor=grey
...
CallEnableLower1
        ...
        setprop Call1EditDate3,bgcolor=white
...
.begin patch 1.4
       clear   str10
        ...
        setitem Call1EditDate3,0,str10
.end patch 1.4
...
.
        ...
        getitem Call1EditDate3,0,str10
        call    TRIM using str10
        count   N2,str10
        if (N2 <> 0)
                if (N2 = 10)
...
.begin patch 1.4
                                        call      CallPrintHeader using FrmPtr
                                        add     sixlpi,row
                                        if ((FrmPtr = C1 & HoldMlr = CAL2MLR) | (FrmPtr = C2 & HoldList = CAL2LIST))
.START PATCH 1.14 REPLACED LOGIC
.                                                 pack      taskname,MCOMP
...
.begin patch 1.4
                    ...
                    call      Trim using str9
                    pack      str12,"F",str9
                    setprop   sheet.Range(str12),*Value=CAL2date3
