...
.release  init      "3.8"        DMB         23JAN2006 File Folder Restructure for NTS1
...
.         APPEND    "\\nts1\d\users\Accounti\gl\clnadj." TO STR55
         APPEND    "\\nts1\d\Accounting\gl\clnadj." TO STR55
.>Patch 3.8 Code Modified         
         APPEND    MM,STR55
         append    ".tmp",str55
         RESET     STR55
...
.                   "A/R","A/P1","A/P2","LRInc","Adj Date","adj code","List","Reason"
         ...
         write     detout,seq;*cdfon,jstmlr,jstlr,jstinvno,jstsubno:
                   FART,FAP1T,FAP2T,LRINC,jstdate,JSTCD,O1DES,jstreasn,DivFlag
...
OhMy
              Create  ex
.              pack            Taskname,"\\nts1\d\users\dherric\monday2009.xlsx"
.              pack            Taskname,"\\nts1\d\users\dherric\monday2009.xls"       
              pack            Taskname,"\\nts1\d\accounting\monday2010.xls"       
