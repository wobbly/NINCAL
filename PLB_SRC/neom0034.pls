...
. DATE       : 03/27/00
. AUTHOR     : D.L. Herrick
. DESCRIPTION: PRODUCES Flat file for Care Discount reconciliation
.
............................................................................
.
PC       EQU       0
...
.         include   nmlrdd.inc
;Patch1.2
release        init           "1.3"        DLH	8March2005	Invoice Conversion 
...
;.START PATCH 1.1 REPLACED LOGIC
        PACK      STR35,NTWKPATH1,"careaccr.dat"
...
;.  305233
        ...
        move      "451515" to nordfld               ..1st Care lr May of 2002
        call       nordtst
        trap       exit if f5
looper  call       nordks
        goto       exit if over
...
;Care Mailer #
        ...
        call       rotdial
;Must be broker the domain group
        match      "0709" to obrknum             .Domain
        goto       looper if not equal
        add        c1 to count
        display    *p10:10,"Care records ",count
        move       oqty to n9
        goto       looper if (n9 <=0)
...
;been invoiced
        ...
        if        not over
	move      yes to inv
                    move      commpct to comchg
                    move      qtybild to billedqty
                    move      ppm to priceper
        else
                    move       c0 to billedqty
                    move       c0 to priceper
                    move       c0 to commpct
                    move       c0 to comchg
        endif
	...
	move      yes to shipsw
        ...
        move      commpct to comchg
;        if        (commpct < "20")
;Must receive 20 percent commission
;	goto      looper
;        endif
;
        clear     str10
...
writeit   write     output,seq;b10:              quarter  user supplied  col A
