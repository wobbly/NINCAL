...
Release	     Init			    "1.2.8"	    9AUGUST2006 DMS	 	 Add tab page to allow modification of new category database
.Release	     Init			    "1.2.7"	    29JUNE2006 DMS	 	 Add search, as per 6/12/2006 CTF Meeting
.PATCH 1.2.6 NOT YET IMPLEMENTED!!
...
.START PATCH 1.2.8 ADDED LOGIC
NewFlag4 init "N"		. FOR CATEGORY CODE RECORDS
.END PATCH 1.2.8 ADDED LOGIC
...
.END PATCH 1.1.5 ADDED LOGIC
.START PATCH 1.2.8 ADDED LOGIC
		NDAT001EListView.InsertColumn using "List Name",150,0
		NDAT001EListView.InsertColumn using "List Type",75,1
		NDAT001EListView.InsertColumn using "Broad Market",85,2
		NDAT001EListView.InsertColumn using "Sub-Market",75,3
		NDAT001EListView.InsertColumn using "Environmental",80,4
		NDAT001EListView.InsertColumn using "Political",60,5
		NDAT001EListView.InsertColumn using "Health/Charit",75,6
		NDAT001EListView.InsertColumn using "Progressive",75,7
		NDAT001EListView.InsertColumn using "List Focus",75,8
		NDAT001EListView.InsertColumn using "List Num",75,9
		NDAT001EListView.InsertColumn using "CatCodeHold",0,10  // hidden col
.
		NDAT001ELISTVIEWBroad.InsertColumn using "",300,0
		NDAT001ELISTVIEWSub.InsertColumn using "",300,0
		NDAT001ELISTVIEWEnv.InsertColumn using "",300,0
		NDAT001ELISTVIEWPolit.InsertColumn using "",300,0
		NDAT001ELISTVIEWHealth.InsertColumn using "",300,0
		NDAT001ELISTVIEWProg.InsertColumn using "",300,0
.END PATCH 1.2.8 ADDED LOGIC
...
.                                            call           CreateDataCard using str25,INITS,CNTNAME,N1
                                             ...
                                             call           NCNTKEY
                                             if over
                                                            pack           taskname,"I have lost track of who you are.",newline,"Your Datacards will print via Laser 2!"
                                                            alert          note,taskname,result
                                                            move           C1,N1
                                             endif
.START PATCH 1.1.5 REPLACED LOGIC
...
.END PATCH 1.1.2 ADDED LOGIC
              ...
              create  Report2;ComboBoxes(1)=25:45:225:325,"",";L)aser 2;)Laser 3;)PDF"
.START PATCH 1.1.5 REPLACED LOGIC
...
.END PATCH 1.1.5 ADDED LOGIC
.START PATCH 1.2.8 ADDED LOGIC
.Screen 4   // WHEN MAIN (TOP) SEARCH YIELDS NOTHING
	setitem         NDAT001EStatListNum,0,""
	setitem		NDAT001EStatListName,0,""
	setitem		NDAT001EStatNewNum,0,""
	setprop		NDAT001EStatNewNum,visible=0
	setprop		NDAT001EStatNewNumLabel,visible=0
	NDAT001EListView.DeleteAllItems  // in case was filled from previous read
	CALL NDAT001ELVCOUNT
	call NDAT001EClearScreen
.END PATCH 1.2.8 ADDED LOGIC
              return
...
.START PATCH 1.2.8 ADDED LOGIC
NDAT001EClearScreen
	setitem	NDAT001EEditBroad,0,""
	setitem NDAT001EEditSub,0,""
	setitem NDAT001EEditEnv,0,""
	setitem NDAT001EEditPolit,0,""
	setitem NDAT001EEditHealth,0,""
	setitem NDAT001EEditProg,0,""
	setitem NDAT001EComboType,0,C1
	setitem NDAT001EComboFocus,0,C1
	RETURN
.END PATCH 1.2.8 ADDED LOGIC
DataClearSelectLV
...
.END PATCH 1.1.5 ADDED LOGIC
.START PATCH 1.2.8 ADDED LOGIC
.Screen 4  // CODE LOADS 1ST ENTRY IN MAIN (TOP) LISTVIEW
	NDAT001EListView.DeleteAllItems
	
	setitem		NDAT001EStatNewNum,0,""
	setprop		NDAT001EStatNewNum,visible=0
	setprop		NDAT001EStatNewNumLabel,visible=0
	
	setitem         NDAT001EStatListNum,0,LSTNUM
	setitem		NDAT001EStatListName,0, MLSTNAME
	move            "E.Load-NCATCODEKEY",Location
	pack            NCATCODEFLD,LSTNUM
	pack            KeyLocation,"Key: ",NCATCODEFLD
	call            NCATCODEKEY
	if not over
		call NDAT001ELoadListView
		setprop NDAT001EButtonNew,enabled=0
	else	// no cat code associated with list
		setprop NDAT001EButtonNew,enabled=1
	endif
	CALL NDAT001ELVCOUNT
.END PATCH 1.2.8 ADDED LOGIC
              return
...
.
              ...
              return
.START PATCH 1.2.8 ADDED LOGIC
NDAT001ELoadListView
	pack 	CatCodeHold, NCATCODEVARS
	pack           NDATFLD,NCATCODENUM
	move           "NDAT001ELOADLISTVIEW-NDATKEY",Location
	pack           KeyLocation,"Key: ",NDATFLD
	call           NDATKEY
	CALL 	TRIM USING MLSTNAME
	NDAT001EListView.InsertItem giving result using MLSTNAME // CREATES NEW ROW, ASSIGN VALUE TO 1ST COL
	if (NCATCODETYPE = "B")
		move "Byrs/Subs",str15
	elseif (NCATCODETYPE = "D")
		move "Dnrs/Mbrs",str15
	elseif (NCATCODETYPE = "C")
		move "Compiled",str15
	elseif (NCATCODETYPE = "M")
		move "Misc.",str15
	else	
		clear str15
	endif
	NDAT001EListView.SetItemText using result,str15,1 // col2
	call TRIM using NCATCODEMARKET
	NDAT001EListView.SetItemText using result,NCATCODEMARKET,2 // col3
	call TRIM using NCATCODESUBMARK
	NDAT001EListView.SetItemText using result,NCATCODESUBMARK,3 // col4
	call TRIM using NCATCODEENV
	NDAT001EListView.SetItemText using result,NCATCODEENV,4 // col5
	call TRIM using NCATCODEPOLIT
	NDAT001EListView.SetItemText using result,NCATCODEPOLIT,5 // col6
	call TRIM using NCATCODEHEALTH
	NDAT001EListView.SetItemText using result,NCATCODEHEALTH,6 // col7
	call TRIM using NCATCODEPROG
	NDAT001EListView.SetItemText using result,NCATCODEPROG,7 // col8
	if (NCATCODEFOCUS = "C")
		move "Christian",str15
	elseif (NCATCODEFOCUS = "V")
		move "Veterans",str15
	elseif (NCATCODEFOCUS = "P")
		move "Pets",str15
	elseif (NCATCODEFOCUS = "W")
		move "Women",str15
	elseif (NCATCODEFOCUS = "K")
		move "Children",str15
	elseif (NCATCODEFOCUS = "S")
		move "Seniors",str15
	elseif (NCATCODEFOCUS = "G")
		move "Gay/Lesbian",str15
	elseif (NCATCODEFOCUS = "J")
		move "Jewish",str15
	else
		clear str15
	endif
	NDAT001EListView.SetItemText using result,str15,8 // col9
	NDAT001EListView.SetItemText using result,NCATCODENUM,9 // col10
	NDAT001EListView.SetItemText using result,CatCodeHold,10 // col11
.END PATCH 1.2.8 ADDED LOGIC
Data3LoadScreen
...
.START PATCH 1.2.8 ADDED LOGIC
NDAT001ELoadScreen
	setitem NDAT001EStatListNum,0,NCATCODENUM
	pack           NDATFLD,NCATCODENUM
	move           "NDAT001ELoadScreen-NDATKEY",Location
	pack           KeyLocation,"Key: ",NDATFLD
	call           NDATKEY
	CALL 	TRIM USING MLSTNAME
	setitem NDAT001EStatListName,0,MLSTNAME
	setitem	NDAT001EEditBroad,0,NCATCODEMARKET
	setitem NDAT001EEditSub,0,NCATCODESUBMARK
	setitem NDAT001EEditEnv,0,NCATCODEENV
	setitem NDAT001EEditPolit,0,NCATCODEPOLIT
	setitem NDAT001EEditHealth,0,NCATCODEHEALTH
	setitem NDAT001EEditProg,0,NCATCODEPROG
	getitem NDAT001EComboType,0,N1
	if (NCATCODETYPE = "B")
		setitem NDAT001EComboType,0,C2
	elseif (NCATCODETYPE = "D")
		setitem NDAT001EComboType,0,C3
	elseif (NCATCODETYPE = "C")
		setitem NDAT001EComboType,0,C4
	elseif (NCATCODETYPE = "M")
		setitem NDAT001EComboType,0,C5
	else 
		setitem NDAT001EComboType,0,C1
	endif
	if (NCATCODEFOCUS = "C")
		setitem NDAT001EComboFocus,0,C2
	elseif (NCATCODEFOCUS = "V")
		setitem NDAT001EComboFocus,0,C3
	elseif (NCATCODEFOCUS = "P")
		setitem NDAT001EComboFocus,0,C4
	elseif (NCATCODEFOCUS = "W")
		setitem NDAT001EComboFocus,0,C5
	elseif (NCATCODEFOCUS = "K")
		setitem NDAT001EComboFocus,0,C6
	elseif (NCATCODEFOCUS = "S")
		setitem NDAT001EComboFocus,0,C7
	elseif (NCATCODEFOCUS = "G")
		setitem NDAT001EComboFocus,0,C8
	elseif (NCATCODEFOCUS = "J")
		setitem NDAT001EComboFocus,0,C9
	else
		setitem NDAT001EComboFocus,0,C1
	endif
	
	NDAT001EListView.GetItemCount giving howmany
	if (howmany > 0)
		call NDAT001EDisableButtons
		call NDAT001EDisableFields
		call NDAT001EEnableList
		setprop NDAT001EButtonModify, enabled=1
		setprop NDAT001EButtonDelete,enabled=1
		call NDAT001EEnableButtons
	else	// listview empty
		call NDAT001EDisableButtons
		call NDAT001EDisableFields
		call NDAT001EEnableButtons
...
NDAT001ELVCOUNT
	...
	call	TRIM using str9
	call 	FormatNumeric using str9,str11
	pack	str45,str11, " Market Designation(s) Found"
	setitem	NDAT001EStatRecordsFound,0,str45
	if (howmany > 0)
		NDAT001EListView.SetItemState giving N9 using 0,2,2
		call Click_NDAT001EListView
		call NDAT001EEnableButtons
	else
		// if list num parent not equal to NDAT001EStatListNum, clear
		getitem DataSearchList,0,str6
		call TRIM using str6
		getitem NDAT001EStatListNum,0,str10
		...
		call NDAT001EClearScreen // webClearRecord
		call NDAT001EDisableList // webDisableList
		call NDAT001EDisableButtons // webDisable Buttons
		call NDAT001EEnableButtons
	endif
	RETURN
NDAT001EEnableList
	setprop	NDAT001EListView, enabled=1
	return
NDAT001EDisableList
	setprop	NDAT001EListView, enabled=0
	return
NDAT001EEnableButtons
	setprop NDAT001EButtonSearch, enabled=1
	return
NDAT001EDisableButtons
	setprop NDAT001EButtonModify, enabled=0
	setprop NDAT001EButtonSave, enabled=0
	setprop NDAT001EButtonQuit, enabled=0
	setprop NDAT001EButtonOK, enabled=0
	setprop NDAT001EButtonDelete, enabled=0
	setprop NDAT001EButtonSearch, enabled=0
	return
NDAT001EEnableFields
	setprop	NDAT001EEditBroad,enabled=1,bgcolor=white
	setprop NDAT001EEditSub,enabled=1,bgcolor=white
	setprop NDAT001EEditEnv,enabled=1,bgcolor=white
	setprop NDAT001EEditPolit,enabled=1,bgcolor=white
	setprop NDAT001EEditHealth,enabled=1,bgcolor=white
	setprop NDAT001EEditProg,enabled=1,bgcolor=white
	setprop NDAT001EComboType,enabled=1,bgcolor=white
	setprop NDAT001EComboFocus,enabled=1,bgcolor=white
	RETURN
NDAT001EDisableFields
	setprop	NDAT001EEditBroad,enabled=0,bgcolor=grey
	setprop NDAT001EEditSub,enabled=0,bgcolor=grey
	setprop NDAT001EEditEnv,enabled=0,bgcolor=grey
	setprop NDAT001EEditPolit,enabled=0,bgcolor=grey
	setprop NDAT001EEditHealth,enabled=0,bgcolor=grey
	setprop NDAT001EEditProg,enabled=0,bgcolor=grey
	setprop NDAT001EComboType,enabled=0,bgcolor=grey
	setprop NDAT001EComboFocus,enabled=0,bgcolor=grey
	RETURN
NDAT001EButtonDelete
	...
	if (result = 1)  // yes
		...
		loop
			move result, N9
			NDAT001EListView.GetNextItem giving result using C2,N9 // -1 is error code
			until (result=SEQ)
			NDAT001EListView.GetItemText giving hold using result, 9 // populate hold with list number
			unpack hold, NCATCODEFLD
			move "NDAT001EButtonDelete - NCATCODETST",location
			pack KeyLocation,"Key: NCATCODEFLD"
			call	NCATCODETST
			if over
			...
			move "NDAT001EButtonDelete - NCATCODEDEL",location
			pack KeyLocation,"Key: NCATCODEFLD"
			call NCATCODEDEL
		repeat
		NDAT001EListView.DeleteAllItems 
.		//if (NCATCODEFLD1 = "" && NCATCODEFLD2 = "" && NCATCODEFLD3 = "" && NCATCODEFLD4 = "" && NCATCODEFLD5 = "" && NCATCODEFLD6 = "" && NCATCODEFLD7 = "" && NCATCODEFLD8 = "")
		call TRIM using NCATCODETYPE
		call TRIM using NCATCODEMARKET
		call TRIM using NCATCODESUBMARK
		call TRIM using NCATCODEENV
		call TRIM using NCATCODEPOLIT
		call TRIM using NCATCODEHEALTH
		call TRIM using NCATCODEPROG
		call TRIM using NCATCODEFOCUS
		if (NCATCODETYPE = "" && NCATCODEMARKET = "" && NCATCODESUBMARK = "" && NCATCODEENV = "" && NCATCODEPOLIT = "" && NCATCODEHEALTH = "" && NCATCODEPROG = "" && NCATCODEFOCUS = "")
		// no previous search - call click_ok button on parent form
			clear NCATCODEFLD1  // MAKE SURE NO INTERVENING SEARCHES
			clear NCATCODEFLD2  // ON LOWER PANEL PUT INFO IN THESE FIELDS
			clear NCATCODEFLD3
			clear NCATCODEFLD4
			clear NCATCODEFLD5
			clear NCATCODEFLD6
			clear NCATCODEFLD7
			clear NCATCODEFLD8
			//alert note, "no prev. search", result
			call CLICK_DataOK
		else   // repeat previous search criteria
...
elixir			CALL NDAT001ELVCOUNT	
		endif
	endif
	if (result = 2)    // no
		call NDAT001EButtonQuit
		return
	endif
	if (result =3) // cancel
		call NDAT001EButtonQuit
...
NDAT001EButtonNew
	call NDAT001EClearScreen
	call NDAT001EDisableButtons
	call NDAT001EEnableFields
	call NDAT001EDisableList
	setprop NDAT001EButtonNew, enabled=0
	setprop NDAT001EButtonSearch, enabled=0
	setprop NDAT001EButtonQuit, enabled=1
	setprop NDAT001EButtonSave, enabled=1
	return
NDAT001EButtonSearch
	call NDAT001EDisableList
	call NDAT001EClearScreen
	call NDAT001EDisableButtons
	call NDAT001EEnableFields
	...
	setprop NDAT001EButtonSearch, enabled=0
	setprop NDAT001EButtonQuit, enabled=1
	setprop NDAT001EButtonOK, enabled=1
	return
NDAT001EButtonModify
	call NDAT001EDisableList
	call NDAT001EDisableButtons
	call NDAT001EEnableFields
	setprop NDAT001EButtonQuit, enabled=1
...
.set up screen 4
		Activate NDAT001E
		setprop NDAT001EListViewBroad, visible=0  // but not the following!
		setprop NDAT001EListViewSub, visible=0  // but not the following!
		setprop NDAT001EListViewEnv, visible=0  // but not the following!
		setprop NDAT001EListViewPolit, visible=0  // but not the following!
		setprop NDAT001EListViewHealth, visible=0  // but not the following!
		setprop NDAT001EListViewProg, visible=0  // but not the following!
		setprop NDAT001ESTATNEWNUM,visible=0
		setprop NDAT001ESTATNEWNUMLABEL,visible=0
		call NDAT001EDisableList
		call NDAT001EDisableButtons
		// do tst on listnum value in parent form.  If no entry in nincode, enable new
		getitem DataSearchList,0,NCATCODEFLD
		call TRIM using NCATCODEFLD
		if (NCATCODEFLD<>"")
			call zfillit using NCATCODEFLD
			move            "E.Load-NCATCODEKEY",Location
			pack            KeyLocation,"Key: ",NCATCODEFLD
			call            NCATCODEKEY
				if over  // no catcode record
					setprop NDAT001EButtonNew, enabled=1
				else
					setprop NDAT001EButtonNew, enabled=0
				endif
...
.START PATCH 1.2.2 REMOVED LOGIC - TEMPORARILY, UNTIL INFO.PLS IS CONVERTED
.             call            DataDisplayMailer using NDAT0001,DataEditMlrNum,DataEditMlrCnt,N4,MouseForm,T1,L1
...
;end patch 1.2.5
.START PATCH 1.2.8	ADDED LOGIC
		include		F:\LIBRARY\DEVELOP\DSTRAHAN\CATCODES\NCATCODEIO.INC
.END PATCH 1.2.8	ADDED LOGIC
