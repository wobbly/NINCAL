...
..	OPEN    REDFILE,"\\nins1\e\data\dbase\revenue"
   prepare    NEWFILE,"c:\work\revenuelunbill.0506"
*.==========================================================================
...
.			osls17,osls18,osls19,osls20,osls21,osls22
			write     newfile,seq;src,cid,client,lr12mos,lr12mosn,lr12mosg,b1,unbill1,compaddr,compzip,compstate,str25
				move      c0 to lr12mos
				move      c0 to lr12mosn
				move      c0 to yr1ninh
				move      c0 to yr1acth
...
.			write     newfile,seq;cid,client,yr2act,yr2nin,yr1act,yr1nin,unbill
.=====================================================================================
