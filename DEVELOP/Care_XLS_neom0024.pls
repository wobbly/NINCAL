...
//                                 *p=8500:row,*Alignment=*Left,"Exchange List Recovery"
			Pack Cell,"Q",str5	        
	        	Setprop sheet.range(Cell),*Value="Exchange List Recovery",*HorizontalAlignment=AlignRight                                                      
               Else
//               		PrtPage Laser;*p=9950:row,*Alignment=*Left,TaxPrt,*Alignment=*Left
               Endif
.              PRINT       hpt825:
...
//Patch 2.53 New Logic
		Pack Cell,"E",str5      	 
		Setprop sheet.range(Cell),*Value=Adjap2,*HorizontalAlignment=AlignRight                        
//Patch 2.53 New Logic	                                  
.         PRINT     hpt400,Adjap2
.end patch 2.41
