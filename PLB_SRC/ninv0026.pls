...
.
...........................................
release        init           "1.02"        DLH  .Annual update of FirstN
Reldate    Init       "2016 Jan 29"
.release        init           "1.01"        DLH  .renamed, taken live, and added to weekly run
...
READINV  CALL      NINVKS
         ...
         MOVE      B1 TO RUNFLAG
         ADD       C1 TO COUNT
         DISPLAY   *P10:12,"INVOICES PROCESSED, LR##, INV##: ",COUNT,b5,lrn,b1,invnum
         DISPLAY   *P10:13,"Invoice Date                  ",invdtem,slash,invdted,slash,invdtec,invdtey
              Move            c0,holdar
              Move            c0,holdap1
              Move            c0,holdap2
              Move            c0,holdap3
...
.              IF              (ar = HoldAr & ap1 = HoldAp1 & ap2 = HoldAp2 & ap3 = HoldAp3)
                      IF              (Formar = HoldAr & ap = HoldAp1 & formap2 = HoldAp2 & ap3 = HoldAp3)
                      Goto                  Readinv
                      endif
.              
           if         (ppsw = yes & FormAr-prepay=holdar & ap1 = HoldAp1 & ap2 = HoldAp2 & ap3 = HoldAp3 & AP = Holdap1)
           goto       Readinv
           endif
.          
gotcha   add        c1,found
         DISPLAY   *P10:14,"Pontential Problem Count      ",found
           call       debug
                      COMPARE  "9900" to ROW
...
TOTAL    
              COMPARE  "6000" to ROW
.         
              prtpage prfile;*pColumn:row,*ALIGNMENT=*Left,*boldon,*ll,"## INVOICES Tested ",COUNT,*boldoff;
...
.        prtpage prfile;*font=font8,str10;
        prtpage prfile;*pHeader1:row,*ALIGNMENT=*CENTER,*font=font8,*ll,*boldon,"NINV0026 Invoice Check",*boldoff;  
        add     eightlpi,row        
        add     eightlpi,row        
...
.                 
                 match   "R" to typer
                 if      equal
                 pack    nrevfld from "EB","00",mlrn,"2015"
                 else
                 pack    nrevfld from "RB","00",mlrn,"2015"
                 endif
                 call    nrevkey
                 return
.
...
.              erase           "c:\progra~1\pdf995\flag.dat"                
         MOVE      NO to str1
           if         (found > c0)
.got bad records - email creques (changed by Robb 06-30-14)
          ...
          Move      "Invoice Verification",Mailsubjct
          Move      "360",MailTimer
          call      SendMail
