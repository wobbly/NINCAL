...
TYPEGET  COMPARE   C0 TO FUNCBR
         ...
         GOTO      TYPENG IF LESS
         LOAD      RPTTYPE USING FUNCBR FROM R1,R2,R3,R4,R5,R6,r7,r8
...
OMIT     DISPLAY   *P1:24,*EL;
         ...
         BRANCH    FUNCBR TO START,START,START,OMIT1,START,start,start,start
OMIT1
.         PRINT     HPuniv10
...
AGE      MOVE      NO TO OVER60
         BRANCH    FUNCBR OF AGE1,AGE1,AGE2,AGE1,AGE2,age2,age1,age2
AGE1
...
AGE4     CALL      CVTJUL
         MOVE      SYSDAYS TO DIFFDAYS
         SUBTRACT  JULDAYS FROM DIFFDAYS
         BRANCH    FUNCBR OF CHK90,CHK90,CHK90,CHK90,CHK365,chk90,chk90,chk90
...
.
ageexit  branch    funcbr of chkmlr,chkmlr,chkmlr,chkmlr,chkmlr,age3,chkmlr,age3
         goto      chkmlr
.
CHK90ap  
         MOVE      C1 TO JSTN
...
.
         print    *F,033,"&l1E",033,"&a0c0R":          .top of form, set top margin 0 lines, position to 0.0
               ...
               033,"*p1040.0x264Y":
               033,"(8U",033,"(s1p07.00v0s-2b5T","1300 Clay St., 11th Floor":
               033,"*p1040x301.5Y":
               033,"(8U",033,"(s1p07.00v0s-2b5T","Oakland, CA 94612-1429":
               033,"*p980x339.0Y":
...
.               033,"*p1135x825.0Y":                                                          .position for header lettering
               ...
               033,"(8U",033,"(s1p08.00v1s+1b5T","30 days":                              . bold & italicised
...
.begin patch 3.83
	...
	prtpage	Laser;*p=1:25,*font=font018b,"Pacific Lists, Inc.":
		*p=451:343,*font=font07,"1300 Clay St. 11th Floor":
...
.end PATCH 3.75
               PRTPAGE        Laser;*units=*HIENGLISH,*ROWSPACE=0,*COLSPACE=0,*Overlayon,*ORIENT=*PORTRAIT:
                              ...
                              *p=4125:3010,*font=Font09BI,"30 Days":
