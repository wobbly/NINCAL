...
release init    "1.34"		08Mar2007  DLH	Oslspern.inc expansion
...
.
FILE2
.    KEYIN     *P10:12,"FILE2 : ",FILE2,*P70:12,"OK? ",ANS,*P70:12,*EL;
.         CMATCH    "Y" TO ANS
...
READ
         ...
         rep       zfill in str2
         match     "06" to str2                    .LM don't take ????
         goto       read if equal
         ADD       C1 TO ORDCT
...
WRITE
         ...
         move      mslsper to n2
         move      osls0 to str25
         load      str25 from n2 of osls1,osls2,osls3,osls4,osls5,osls6,osls7,osls8,osls9:
                   osls10,osls11,osls12,osls13,osls14,osls15,osls16,osls17,osls18,osls19:
                   osls20,osls21,osls22,osls23,osls24,osls25:
		osls26,osls27,osls28,osls29,osls30,osls31,osls32,osls33,osls34,osls35
         write     recmst,key;*cdfon,mnum,mcomp,str25
