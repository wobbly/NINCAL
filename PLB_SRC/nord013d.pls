...
Release   Init      "3.10"         DLH .cleanup format,switch to Landscape
Reldate   INit      "2015 April 19"
.Release   Init      "3.06"         DLH .USe new order comselect code
.Reldate   INit      "2015 January 8"
.Release  init      "3.05"        DLH    Getprice use exchange price from order if present
.reldate   Init      "2014 January 7"
.Release  init      "3.04"        DLH    Replace laser3 blankstock with Laser4 Legal
.reldate   Init      "2013 December 12"
.Release  init      "3.03"        DLH    Fix exchange calcs
.reldate   Init      "2013 December 04"
.Release  init      "3.02"        ASH    Adjustments to allow Datacard Select items on Order to remain independent from current Datacard state
...
.
          if        (inpname = "")
         MOVE      "NINORDU.SRT|NINS1:502" TO NORDNAME
          else
...
.                    *ORIENT=*Portrait,*Font=Font8,*DUPLEX=2
       PRTPAGE     Laser;*units=*HIENGLISH,*ROWSPACE=0,*COLSPACE=0,*Overlayon,*ORIENT=*LANDSCAPE:
                   *MarginL=0,*MarginT=0,*Font=Font8:
                   *Alignment=*Left,*Duplex=3;                 
...
.begin patch 3.0
          ...
          PrtPage   Laser;*p=1:row,"CONFIDENTIAL",*p=4250:row,*alignment=*center,"N I N   U N B I L L E D   'Batch'   O R D E R S   ",*alignment=*Left
         goto      hdx
hd2      
.testing think we need a new page on second and third passes even if page 1 as all are sent to the same pdf
          if        (page <> c1)
          Prtpage   Laser;*Newpage
          endif
          PrtPage   Laser;*p=1:row,"CONFIDENTIAL",*p=4250:row,*alignment=*center,"N I N   U N B I L L E D   'Broker'   O R D E R S   "
          add       sixlpi,row
         goto      hdx
hd3     
          if        (page <> c1)
          ...
          PrtPage   Laser;*p=1:row,"CONFIDENTIAL",*p=4250:row,*alignment=*center,"N I N   U N B I L L E D   O R D E R S   "
          add       sixlpi,row
         goto      hdx
hdx      
          PrtPAge   Laser;*alignment=*Left,*p=10000:row,"Date:":
                    *alignment=*right,*p=10750:row,TODAY
          add       sixlpi,row
          PrtPAge   Laser;*alignment=*left,*p=10000:row,"Page:":
                    *alignment=*right,*p=10750:row,PAGE,*ALIGNMENT=*LEFT          
          add       sixlpi,row
          PrtPage   Laser;*p=1:row,"ORDER",*p=2000:row,"MAILER NAME",*p=5125:row,"Owner Name",*p9500:row,"MAIL",*alignment=*right,*p=10750:row,"Return":
                    *ALIGNMENT=*LEFT          
          add       sixlpi,row
          PrtPage   Laser;*p=1:row,"DATE",*p=625:row,"MLR##",*p=1500:row,"LR",*p=2000:row,"OFFER",*p9500:row,"DATE",*alignment=*right,*p=10750:row,"Date":
                    *ALIGNMENT=*LEFT          
          add       sixlpi,row
            prtpage laser;*p1:row,*pensize=10,*line=10800:row;
.          prtpage   laser;*p=1:row,*RPTCHAR "-":350
.          add       SixLPI,row
...
.begin patch 3.0
          Clear       str10
          pack        str10 from ORTNDTEM,SLASH,ORTNDTED,SLASH,ORTNDTEC,ORTNDTEY
.          PrtPage     Laser;*p=1:row,"MP##",Omlrky,*p=2000:row,brcomp,*p=4750:row,olon,*p=5125:row,ownocpy:
.                      *alignment=*right,*p=10750:row,str10:
.                    *ALIGNMENT=*LEFT          
           call       trim using omlrky
          if          (omlrky <> "")
          PrtPage     Laser;*p=1:row,"MP##",Omlrky;
          endif
          PrtPage     Laser;*p=2000:row,brcomp,*p=4750:row,olon,*p=5125:row,ownocpy:
                      *alignment=*right,*p=10750:row,str10:
                    *ALIGNMENT=*LEFT          
...
.          PrtPage   Laser;*p6750:row,*BOLDON,OMDTEM,SLASH,OMDTED,SLASH,OMDTEC,OMDTEY,*BOLDOff
          PrtPage   Laser;*p9500:row,*BOLDON,OMDTEM,SLASH,OMDTED,SLASH,OMDTEC,OMDTEY,*BOLDOff
          else
          PrtPage   Laser;*p9500:row,OMDTEM,SLASH,OMDTED,SLASH,OMDTEC,OMDTEY
          endif
          add       sixlpi,row
...
shipprt
          ...
          PrtPage   Laser;*p=1:row,OODTEM,SLASH,OODTED,SLASH,OODTEC,OODTEY:
                    ...
                    *p=6015:row,"Ship: ",MEDIA,*p=8065:row,"Via: ",shipdesc
           else
          PrtPage   Laser;*p=1:row,OODTEM,SLASH,OODTED,SLASH,OODTEC,OODTEY:
                    *p=625:row,OMLRNUM,SLASH,OCOBN,*p=1130:row,*boldon,mcode,*boldoff:
...
.          endif
         ...
         EDIT      N9 TO STR9e
          ...
          PrtPage   Laser;*p=10:row,*Boldon,Shipped,*Boldoff:
                    ...
                    *Alignment=*Left,b1,*boldon,exchange,*Boldoff,*p=6750:row,"QTY: ",STR9,"/",str9e,*Alignment=*right,*p=8500:row,UNBILINC:
                    *Alignment=*Left
          add       sixlpi,row
...
.          PrtPage   Laser;*p=1:row,"LIST - ",O1DES,B1,O2DES,B1,*BoldON,str15,*BoldOFF,b1,COMSLCT,*p=6500:row,"QTY: ",STR9,"/",str9e
        Clear   str6
                if      (OComMod = "1")
                move    "/M",str6
                PrtPage   Laser;*p=1:row,"LIST - ",O1DES,B1,NSEL2NAME,B1,*BoldON,str15,*BoldOFF,b1,COMSLCT,"@",OComPrc,str6
                elseif  (OComMod = "2") 
                move    "/Flat",str6
                PrtPage   Laser;*p=1:row,"LIST - ",O1DES,B1,NSEL2NAME,B1,*BoldON,str15,*BoldOFF,b1,COMSLCT,"@",OComPrc,str6
                else                            .all others     
                PrtPage   Laser;*p=1:row,"LIST - ",O1DES,B1,NSEL2NAME,B1,*BoldON,str15,*BoldOFF,b1,COMSLCT
                endif
...
.START PATCH 3.02 REMOVED LOGIC
.                              endif
.END PATCH 3.02 REMOVED LOGIC
                    elseif (NSEL3CODE = "L")
...
.what is this?
                    ...
                    if (N10 > 124)
                              reset     line1
                               ...
                               PrtPage   Laser;*p=10:row,*Font=Font7,"*",*ll,line1,*pl,*Font=Font8
                               add       sixlpi,row
                              clear     line1
                    elseif (taskname <> "")
...
parser
         ...
         if (line1 <> "")
          ...
          PrtPage   Laser;*p=10:row,*Font=Font7,"*",*ll,line1,Line2,*pl,*Font=Font8
          add       sixlpi,row
          endif 
         if (line3 <> "")
                    if        (row >= 7500)
          ...
          PrtPage   Laser;*p=10:row,*Font=Font7,"*",*ll,line3,Line4,*pl,*Font=Font8
          add       sixlpi,row
          endif 
         if (line5 <> "")
                    if        (row >= 7500)
          ...
          PrtPage   Laser;*p=10:row,"*",*Font=Font7,*ll,line5,Line6,*pl,*Font=Font8
          add       sixlpi,row
          endif 
         if (line7 <> "")
                    if        (row >= 7500)
          ...
          PrtPage   Laser;*p=10:row,*Font=Font7,"*",line7,*Font=Font8
          add       sixlpi,row
          endif 
