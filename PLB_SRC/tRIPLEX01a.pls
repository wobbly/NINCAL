...
.
         ...
         call      nxcgkey
.         READ      EXCHARGE,lrn;LR,MLR,MLRCNT,LN,OWNER,TPI,QTY,AR,AP,CE,YR,MO
         if        over
         move      c0 to nxcgar
         endif
         clear     str2
         ...
         write     output,seq;*CDFON,lrn,tinvlr,mcomp,o1des,gross,formar,commpct,saveap,formap2,lrinc:
                   str1,tipe:
                   tinvdate,tinvinv,form102,nininc,nxcgAR
         ADD       c1 TO COUNTo
         DISPLAY   *P15:10,COUNTo
         branch    pass of readinv,readinv1
         GOTO      readinv
*......................................................................
.
...
testinv1
         ...
         rep       zfill in nordfld
         call      nordkey
         if        (olnum = "017889" or olnum = "005051")
         move      b1 to tipe
         RESET     EXCODES
         SCAN      OELCODE IN EXCODES
         GOTO      RENTAL IF not EQUAL
