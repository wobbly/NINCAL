...
.START PATCH 2.84 REMOVED LOGIC
.;.START PATCH 2.62 ADDED LOGIC
.         INCLUDE   NFULDD.INC
.;.END PATCH 2.62 ADDED LOGIC
.END PATCH 2.84 REMOVED LOGIC
...
release  init      "2.89"         DLH added OMlrLstCd
Reldate   Init      "2016 March 16"
.release  init          "2.89"           .return to 5319 was missing
.Reldate   Init      "2014 January 2"
.release  init          "2.88"           Adjustments to allow Datacard Select items on Order to remain independent from current Datacard state
.Reldate   Init      "09 December 2010"
.release  init          "2.87"           Change TDMC addy
.Reldate   Init      "09 December 2010"
.release  init          "2.86"           DLH 18sep07  PLI Inclusion cleanup
.release  init         "2.85"           ASH 18JUN07  PLI Inclusion
.                                 DLH 19Jul07 minor fixes for above
.release  init         "2.84"           DMS 22JUN06  FULFILLMENT CONVERSION
...
font5               font
fontO8              font
.begin patch 2.85 DLH this var was mia
fontO9              font
.end patch 2.85 DLH this var was mia
fontO9I             font
fontO10             font
fontO10n  font
fontO10B  font
...
MAIL2    DIM       25                       MATION
MAIL3    DIM       25                       READ
.begin patch 2.85 DLH this var is a dupe???
.MAILCC   DIM       17                       MAILER
.end patch 2.85 DLH this var is a dupe???
...
PackData DataList
.END PATCH 2.74A - ADDED LOGIC
.START PATCH 2.84 ADDED LOGIC
NFULCOMP  DIM       55
.END PATCH 2.84 ADDED LOGIC
. .............................................................................
* PROGRAM MAIN.
* *************
.
...
.         OPEN      SAVEFILE,"TDMCORD/SAV:TEXT"
         OPEN      SAVEFILE,"TDMCORDS"
.END PATCH 2.6 REPLACED LOGIC
         XIF
         IFZ      PC
         OPEN      TDMCORD,"c:\work\TDMCORD.OUT",EXCLUSIVE
         ADD       C1 TO FILE
.START PATCH 2.74A ADDED LOGIC
.Create work var
...
.Note for patch 2.85:  prtorderpage1.inc takes care of Logos for Pacific Lists!!
.begin patch 2.86
...
.START PATCH 2.88 REMOVED LOGIC
.                              endif
.END PATCH 2.88 REMOVED LOGIC
                    elseif (NSEL3CODE = "L")
...
.                   write     Xmlfile,seq;"<shipcity>",RTCITY,"</shipcity>"
                    if (RTNUM = "5318")
. begin patch 2.87
                              write     Xmlfile,seq;"<shipcity>incoming.files@infogroup.com</shipcity>"
.                              write     Xmlfile,seq;"<shipcity>incoming.files@donnelley.infousa.com</shipcity>"
. end patch 2.87
                    else
                              write     Xmlfile,seq;"<shipcity>",RTCITY,"</shipcity>"
                    endif
