...
guarwkly       file
.Tempfile       File
release        init           "1.84"        DLH    .Changed mailfrom to Gemma, some site are blocking computerRequest email
Reldate        INit           "2016 March 21"
.release        init           "1.83"        DLH    HTML cleanup
.Reldate        INit           "2016 February 24"
.release        init           "1.82"        DLH    loose PDF put message in the body of the email
...
.testing testing testing
               ...
               setitem        StatTextBoxes(3),0,"Creating & Sending Letters"
...
.           append     "<meta http-equiv=#"content-type#" content=#"text/html; charset=UTF-8#">",Mailbody         
           append     "<title>Guarantee Reminder</title>",Mailbody
           append     "</head>",Mailbody
           APPEND     HexCRLF,MAILBODY
.end patch 1.83
           append     "<body>",Mailbody
           append     "<h2 align=#"center#">Guarantee Reminder</h2>",Mailbody
...
.                    MOve      "ComputerRequest@nincal.com",MailFrom                      .
                    MOve      "GemmaSpranza@nincal.com",MailFrom                      .
...
.Begin patch 1.82
           ...
           append     "<br><br>",mailbody
           append     "FROM: Names in the News - Accounting",mailbody
           append     "<br><br>",mailbody
           append     "Just a reminder that the following order carries a ",mailbody           
           append     gdays,mailbody
           append     " Day Payment Guarantee due on or before ",mailbody
           append     Duedate,mailbody
           append     ".",mailbody
.Begin patch 1.83
           APPEND     hEXcrlf,MailBody
.end patch 1.83
           ...
           append     "<br><br>",mailbody
           append     "Broker guarantees payment from initial mail date as noted on both our order confirmation and invoice.",mailbody
.Begin patch 1.83
           APPEND     hEXcrlf,MailBody
.end patch 1.83
           append     "<br><br>",mailbody
           append     "Timely payment is appreciated and will insure further acceptance of guarantees from your company.",mailbody
           append     "<br><br>",mailbody
.Begin patch 1.83
           APPEND     hEXcrlf,MailBody
.end patch 1.83
           append     "Please take a minute to fill out the following information and send this form back to Names In The News.",mailbody
.Begin patch 1.83
           APPEND     hEXcrlf,MailBody
.end patch 1.83
           append     "<br><br>",mailbody
           append     "GemmaSpranza@nincal.com or fax (415)433-7796.",mailbody
           append     "<br><br>",mailbody
           append     "I sent in check ## ________ on  ____/____/____  for $_____________",mailbody
           append     "<br><br>",mailbody
           append     "Payment will be sent on ____/____/____",mailbody
.Begin patch 1.83
           APPEND     hEXcrlf,MailBody
.end patch 1.83
           append     "<br><br>",mailbody
           append     "If payment is not received on time, we have the option to place the mailer on credit hold.",mailbody
           append     "<br><br>",mailbody
           append     "Thank you for your attention to this matter.",mailbody
.Begin patch 1.83
           APPEND     hEXcrlf,MailBody
.end patch 1.83
           append     "<br><br>",mailbody
           append     "Your name:   _____________________________________________________",mailbody
           append     "<br><br>",mailbody
           append     "Phone/Email: _____________________________________________________",mailbody
...
.Begin patch 1.82
           ...
           append     "Just a reminder that the following order carries a ",mailbody           
           append     gdays,mailbody
           append     " Day Guarantee that is now <B>past</B> due. Due date was on or before ",mailbody
           append     Duedate,mailbody
           append     ".",mailbody
           append     "<br><br>",mailbody
           append     "LR##: ",mailbody
...
.Begin patch 1.82
           ...
           append     "Broker guarantees payment from initial mail date as noted on both our order confirmation and invoice.",mailbody
           append     "<br><br>",mailbody
           append     "Despite our multiple attempts to contact you regarding this overdue payment, it has not been received.",mailbody
           append     "<br><br>",mailbody
           append     "We can no longer accept guarantees from your company, and your mailer is now on credit hold.",mailbody
           append     "<br><br>",mailbody
           append     "If your payment is already in the mail please take a minute to fill out the following information and send this form back to Names In The News.",mailbody
           append     "<br><br>",mailbody
           append     "GemmaSpranza@nincal.com or fax (415)433-7796.",mailbody
           append     "<br><br>",mailbody
           append     "I sent in check ## ________ on  ____/____/____  for $_____________",mailbody
           ...
           append     "Payment will be sent on ____/____/____",mailbody
           append     "<br><br>",mailbody
           append     "If payment is not received on time, we have the option to place the mailer’s credit status on hold.",mailbody
           append     "<br><br>",mailbody
           append     "Thank you for your attention to this matter.",mailbody
           append     "<br><br>",mailbody
           append     "Your name:   _____________________________________________________",mailbody
