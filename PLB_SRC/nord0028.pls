...
.Patch 3.97
         include   ncntdd.inc
release  init      "5.65"          DLH   Yearly
reldate   Init      "2016 January 5"
.release  init      "5.64"          DLH   Yearly
.reldate   Init      "2015 January 5"
.release  init      "5.63"          DLH     added Flags= to prtopen with PDF:
.reldate   Init      "2014 March 25"
.release  init      "5.62"          DLH   Yearly
.reldate   Init      "2014 January 2"
.release  init      "5.61"          DLH   fix calendar records selection
.reldate   Init      "2013 May 14"
.release  init      "5.60"          DLH   Sunbelt PDF
.reldate   Init      "2013 April 25"
.release  init      "5.52"          DLH   Yearly Update
.reldate   Init      "22 August 2012"
...
.YR4 init "2012"
.YR5 init "2013"
.begin patch 5.64..>Update Yearly<<<<<<<<<<<
.begin patch 5.65
YR1 init "2012"
YR2 init "2013"
YR3 init "2014"
...
process  MOVE     C1 TO NDATPATH
        ...
        Display     *P10:14,*EL,"OUTPUT FILE ALREADY EXISTS ",*CYAN,"Preparing a New One"
         CLOSE     OUTPUT
          erase     "c:\work\listsum.dat"
          erase     "c:\work\listsum.srt"
          erase     "c:\work\listsum.isi"
NOOUT    TRAPCLR   IO
         IFNZ      PC
...
OUTPUT2
         ...
         move      c1 to branch
.begin patch 5.52 cleanup logic
...
.          goto      input
          move      c0,branch
.          if       (OMdtey = YRone)                         .1st calender
.begin patch 5.61
.          if       (datechk = YRone)                         .1st calender
.          MOVE      C2,Branch
.          Elseif    (datechk = YRTwo)                        .1st calender
          if    (datechk = YRTwo)                        .1st calender
.end patch 5.61
          MOVE      C2,Branch
          Elseif    (datechk = YrTHree)                  .2nd
          MOVE      C3,Branch
          Elseif    (datechk = YrFour)       .3rd 
          MOVE      C4,Branch
          Elseif    (datechk = YrFive)       .4th 
          MOVE      C5,Branch
          Elseif    (datechk = YRSix)       .5th 
          MOVE      C6,Branch
          Endif
          if        (branch = c1)
          goto      Input
...
.                              PRTOPEN prfile,"PDF995","LstSum.pdf"
                              PRTOPEN prfile,"PDF:","c:\work\pdf\LstSum.pdf",Flags=PDF_FLAGS_WIN_ANSI_ENCODING
.end patch 5.60
                    else
                          ...
                          if (cntprint = "1" | cntprint = "3")      .Laser6
                                  if (bosflag = c2)
                                        ...
                                        PRTOPEN prfile,"\\NINs2\Laser3",spoolname,noprint,spoolfile=splfle
...
.patch3.yr6
        loop
          until (N3 = COPY)
                ...
                Elseif     (cntprint = "5" )      .Susan
                              PRTPLAY splfle,"NIN0010 KYOCERAS"
               Elseif (cntprint = "7")      .
