...
.                   READ                IFILE,LR;DATA,CODE,*tab=335,compid,compid2
          READ                IFILE,LR;DATA,CODE,*tab=132,Obildrct,*tab=176,Ohist,*tab=335,compid,compid2
...
.End patch 1.21
        ...
        move    b1,str1
          ...
          IF        (changes > 0)
          FILEPI              1;IFILE
          UPDATAB             IFILE;DATA,CODE,*tab=132,Obildrct,*tab=176,Ohist,*tab=335,compid,compid2
