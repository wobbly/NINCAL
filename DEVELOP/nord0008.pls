...
release   init      "2.89"    DLH    convert samples to pdf
REldate   INit      "2015 January 29"
...
.END PATCH 2.84 REPLACED LOGIC
       if      (newsflag = c1)
          ...
          append    CRLF,Mailbody
          Append              "This is from Nightly Orders's. Your above LR had",Mailbody
          append    CRLF,Mailbody
       ...
       Elseif      (newsflag = c2)
          ...
          append    osamcde,MailBody
          append    CRLF,Mailbody
          Append              "This is from Nightly LCR's. Your above LCR had",Mailbody
          append    CRLF,Mailbody
          Append              "a Sample number. However I found no sample!!!! ",Mailbody
          append    CRLF,Mailbody
          Append              "The order has not been sent. Please review & correct.",Mailbody
       ...
       Elseif      (newsflag = c3)
          ...
          append    b1,MailBody
          append    CRLF,Mailbody
          Append              "This is from Nightly ORders. This LR",Mailbody
          append    CRLF,Mailbody
       ...
       Elseif      (newsflag = c4)
          ...
          append    b1,MailBody
          append    CRLF,Mailbody
          Append              "This is from Nightly LCR's. This LCR could",Mailbody
          append    CRLF,Mailbody
