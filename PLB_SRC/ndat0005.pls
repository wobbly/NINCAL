...
Release   Init      "4.14"   DLH   .Update add Noweb flag status on excel report.
REldate   INit      "2015 November 13"
.Release   Init      "4.13"   DLH   .Update web ip from  64.71.27.110 to 207.141.154.44  
.REldate   INit      "2014 October 21"
.Release   Init      "4.12"   DLH   .add external call from Ndat0004 to create excel cards. and RH, convert to prtpage
.REldate   INit      "2014 July 31"
.Release   Init      "4.11"   DLH   .add usage to external call from Ndat0001 to create excel cards.
.REldate   INit      "2014 July 23"
.Release   Init      "4.10"   DLH   .add external call from Ndat0001 to create excel cards.
.REldate   INit      "2014 July 23"
.Release   Init      "4.04"   DLH   Reciprocal verbage
.REldate   INit      "2013 October 24"
.Release   Init      "4.04"   DLH   Reciprocal verbage
.REldate   INit      "2013 October 24"
.NOTE ERRORS HAPPEN IN EXCEL IF DUPLICATE LIST NAMES See WorksheetName 
.Release   Init      "4.03"   DLH   Remove Pia
.REldate   INit      "2013 September 9"
.Release   Init      "4.02"   ASH   Trap logic added for naming worksheet
.REldate   INit      "2013 July 22"
...
.end patch 4.11
.begin patch 4.10
ExtFlag    Dim        1          .Y=called from Ndat0001
.end patch 4.10
.begin patch 4.12
DATACARDPRINT       PFILE
font8    font
...
.begin patch 4.03
                      create  font8,"Calibri",size=8
                      create  font8i,"Calibri",size=8,italic        
          if (CallFlag = 1)
                    pack      inpname,DimPtr
                    pack      INITS,DimPtr1
                      Move      "EXCEL",COMMENT
...
.begin patch 4.12
          call      GetWinVer
                ...
                elseif (PrintFlag = 3)  .PDF
                        Erase     "c:\work\pdf\datacard.pdf"
                        pack    str45,"c:\work\pdf\Datacard.pdf"
                              
                        PRTOPEN DataCardPrint,"PDF:",str45,Flags=PDF_FLAGS_WIN_ANSI_ENCODING
                endif
.         SPLOPEN   PRTFILE
.end patch 4.12
...
.show ndatweb 2015 Nov 13
                    pack            Exrange1 from "U",DimRow1
                    pack            Exrange2 from "U",DimRow2
                    pack            Exrange3,Exrange1,":",Exrange2
                    if           (ndatweb = "1")  
                    setprop sheet.range(ExRange1,ExRange1),*Value="NO"
                    Else  
                    setprop sheet.range(ExRange1,ExRange1),*Value="Yes"
                    endif  
.endshow ndatweb 2015 Nov 13
          Add       c1 to row1
          Add       c1 to row2
.begin patch 4.0
          Elseif        (XLSXFlag = c3)
...
.                    Setprop sheet,*Name=WorksheetName
                        TRAP WorksheetNameTrap giving error if OBJECT
WorksheetName
                    Setprop sheet,*Name=WorksheetName
WorksheetNameAfter
...
.begin patch xxx
         ...
         if        equal
                    if        (row >= 7500)           .approx an inch up from the botton
                    call      header
                    endif
.         COMPARE   "52" TO lines
.         CALL      HEADER IF NOT LESS
         else
                    if        (row >= 10000)           .approx an inch up from the botton
                    call      header
                    endif
.         COMPARE   "57" TO lines
.         CALL      HEADER IF NOT LESS
...
DT1      
.begin patch xxx   Note add check for position and call to header
           add     eightlpi,row

           PRTPAGE    DataCardPrint;*p250:Row,Lstnum:
                      *p1000:row,Mlstname:
                      *p4250:row,Text1
                              call trim using EXCL
                              call trim using pstatus
                     ...
                     if        (Typeflag <> c2)
                              ...
                              pack str1,password
                              pack str3,str2,str1
                      PRTPAGE    DataCardPrint;*p7250:row,str3,b1,str55a
                      else
                      PRTPAGE    DataCardPrint;*p7250:row,str55a
                      endif



.          PRTPAGE    DataCardPrint;*p250:Row,line1,*p4250:Row,line1a,*p7250:row,str31a,b3,str51a
          ...
          ENDIF
           ...
           PRTPAGE    DataCardPrint;*p250:Row,Lstnum:
                     ...
                     if        (Typeflag <> c2)
                              ...
                              pack str1,password
                              pack str3,str2,str1
                      PRTPAGE    DataCardPrint;*p7250:row,str3,b1,str55a,*p8125:row,str10
                      else
                      PRTPAGE    DataCardPrint;*p7250:row,str55a,*p8125:row,str10
                      endif
...
.begin patch xxx
           ...
           PRTPAGE    DataCardPrint;*p10:Row,"CONFIDENTIAL":
                      *p3000:row,"*** NAMES IN THE NEWS MASTER LISTING ***":
                      *p7250:row,"PAGE ",PAGE
           add     eightlpi,row
           PRTPAGE    DataCardPrint;*p7250:Row,"DATE: ",TODAY
           add     eightlpi,row
           add     eightlpi,row
           add     eightlpi,row
           add     eightlpi,row
...
.end patch xxx
         ...
         GOTO      PAGE2X
.begin patch xxx
PAGE2B             PRTPAGE DataCardPrint;        *NEWPAGE
.          PRINT     *F,033,"M";
PAGE2X   
           ...
           PRTPAGE    DataCardPrint;*p10:Row,"CONFIDENTIAL":
                      *p4000:row,"*** NAMES IN THE NEWS MASTER LISTING ***":
                      *p9500:row,"PAGE ",PAGE
           add     eightlpi,row
           PRTPAGE    DataCardPrint;*p9500:Row,"DATE: ",TODAY
           add     eightlpi,row
           add     eightlpi,row
           add     eightlpi,row
           add     eightlpi,row
...
.          if        (Typeflag <> c2)
           ...
           PRTPAGE    DataCardPrint;*p250:Row,*ulon,"LIST##":
                      *p1000:row,"MASTER LIST NAME":
                      *p4250:row,"QUANTITY":
                      *p5125:row,"DESCRIPTION":
                      *p6500:row,"PRICE",*uloff
          if        (Typeflag <> c2)
           PRTPAGE    DataCardPrint;*p7250:row,*ulon,"Typist",*uloff
           endif
           add     eightlpi,row
           add     eightlpi,row
.          PRINT     *2,"LIST##":
...
.        setprop ex,*Visible="True"
              ...
              setprop sheet.range("U6","U6"),*Value="Website",*HorizontalAlignment=xlAlignCenter
...
.need to check flag if portrait then 9500
                    if        (row >= 7500)           .approx an inch up from the botton
                    call      page
                    endif
         ...
         DISPLAY   *P1:23,*EL,TOTUNIV,*W
           ...
           add     eightlpi,row
           add     eightlpi,row
           PRTPAGE    DataCardPrint;*p2250:Row,"NUMBER OF RECORDS FOUND ",*p4000:Row,LRTOT,"****"
           add     eightlpi,row
           PRTPAGE    DataCardPrint;*p2250:Row,"TOTAL UNIVERSE",*p4000:Row,UNIVPRT
...
.                              Pack      MailTO from "SuzieMcGuire@nincal.com,PiaPayne@nincal.com"
                              Pack      MailTO from "SuzieMcGuire@nincal.com,DeniseHubbard@nincal.com"
                              move    "Here is your Weekly List File in Excel",MailSubjct
          endif
.begin patch 4.10
                                 if         (ExtFlag = YEs)
                                 Pack      MailFrom from DimPtr3,"@nincal.com"
                                 Pack      MailTo from DimPtr3,"@nincal.com"
                                 else
...
CheckFile1
          ...
          trap      WaitForEnd1 giving error if IO
...
.argh what is going on        
                              ...
                              pack      Mailto from DimPtr3,"@nincal.com"
                              pack      MailFrom from DimPtr3,"@nincal.com"
                              pack      Mailreply from DimPtr3,"@nincal.com"
          elseif (CallFlag = 0)
                              pack      Mailto from user,"@nincal.com"
                              pack      MailFrom from user,"@nincal.com"
                              pack      Mailreply from user,"@nincal.com"
          endif
...
.                    return
          ...
          Stop   if (callflag >= 1)                      .should be able to return something has popped the statck
           SHUTDOWN   "CLS"
          STOP
.end patch 4.12
...
AddNotes
          ...
          clear     SELNOTESFLAG
.
.Begin patch 4.11   add usage here?
.          if (hold2 <> "")
.                    reset     hold2
.          ENDIF
           if (NDATLUSAGE <> "F" & UsageFlag = c1)
          destroy PackData
          ...
          if (howmany > C0)
                    append    NewLine,hold2
                    append    NewLine,hold2
                    append    "12 MONTH CONTINUATION USAGE",Hold2
                    sub       C1,howmany
                    for N9,C0,howmany
                              PackData.GetText giving COMPCOMP using N9
                    append    NewLine,hold2
                    append    COMPCOMP,hold2
                    repeat
          endif
           endif
          if (hold2 <> "")
...
.
          if (rentFlag = Yes & (ELSTCDE = "C" or Elstcde = "P"))
                    ...
                    append    hold2,LineFeed
.begin patch 4.04
                    append    "Mailers choosing not to make their list available may be subject to a nonreciprocal fee on rentals.",hold2
                    append    hold2,LineFeed
.end patch 4.04
...
WorksheetNameTrap
          trapclr   OBJECT
          move      WorksheetName,taskname
          move      C0,N2
          loop
WorksheetNameTrapInnerLoop
                    movelptr WorksheetName,N9
                    sub       C3,N9
                    setlptr   WorksheetName,N9
                    add       C1,N2
                    if (N2 >= 98)       .Force another object error by going back...
                              move      taskname,WorksheetName
                              goto WorksheetName
                    endif
                    move      N2,str2
                    rep       zfill,str2
                    pack      WorksheetName,WorksheetName,"_",str2
                    TRAP WorksheetNameTrapInnerLoop giving error if OBJECT
                    Setprop sheet,*Name=WorksheetName
                    trapclr   OBJECT
                    break
          repeat
          goto WorksheetNameAfter
.END PATCH 4.02 ADDED LOGIC

DREWDEBUG
          MOVE      STR1,STR1
          RETURN
.Begin PATCH 4.10 ADDED LOGIC
CreateXLSCard Routine DimPtr,DimPtr1,DimPtr3,FrmPtr,FrmPtr1,FrmPtr2
.DimPtr  = FileName
.DimPtr1 = Initials
.DimPtr2 = Used Elsewhere
.DimPtr3 = LogIn Name
.                                           Printer Choice  1=laser3,2=laser4,3=pdf
.FrmPtr  = Owner Info Choice
.FrmPtr1 = Usage Choice - '0'=No Usage, '1'=Usage 
.FrmPtr2 = Company
.NOTE OWNER AND USAGE NOT YET IMPLEMENTED
          if        (FrmPtr2 = c2)
                    move      FrmPtr2,Company
          endif     
          call      Trim using DimPtr
          if (DimPtr <> "")
                      FindFIle   dimPtr,Filesize=n5
                      if         (zero & n5 > c0)
                              move      C1,CallFlag
                              call      Trim using DimPtr3
                              call      RemoveChar using DimPtr3,B1
                                 move       DimPtr3,User
                              move      FrmPtr1,UsageFlag
                                 Move       "NDAT0005",program
                                 Move       "DataExcl",prtname
                                 MOve       YEs,ExtFlag
                              call      starter
                              
                              destroy   selectlistview
                              destroy   select2listview
                              erase     DimPtr                               .erase input file
                    endif
          endif
          return
.END PATCH 4.10 ADDED LOGIC
.Begin PATCH 4.12 ADDED LOGIC
CreateXLS Routine DimPtr,DimPtr1,DimPtr3,FrmPtr,FrmPtr1,FrmPtr2
.DimPtr  = FileName
.DimPtr1 = Initials
.DimPtr2 = Used Elsewhere
.DimPtr3 = LogIn Name
...
.Begin PATCH 4.12 ADDED LOGIC
CreateRHLIST Routine DimPtr,DimPtr1,DimPtr3,FrmPtr,FrmPtr1,FrmPtr2,FrmPtr3
.DimPtr  = FileName
.DimPtr1 = Initials
.DimPtr2 = Used Elsewhere
.DimPtr3 = LogIn Name
.FrmPtr  = Printer Choice  1=laser3,2=laser4,3=pdf                         
.FrmPtr1 = Owner Info ChoiceUsage Choice 
.FrmPtr2 = Usage Choice - '0'=No Usage, '1'=Usage  
.FRMpTR3 = Company
.NOTE OWNER AND USAGE NOT YET IMPLEMENTED
          if        (FrmPtr2 = c2)
                    move      FrmPtr2,Company
          ...
          return
.rh with revdate
CreateRHLISTR Routine DimPtr,DimPtr1,DimPtr3,FrmPtr,FrmPtr1,FrmPtr2,FrmPtr3
.DimPtr  = FileName
.DimPtr1 = Initials
.DimPtr2 = Used Elsewhere
.DimPtr3 = LogIn Name
