...
.        prtpage prfile;*p5000:row,*font=font12,*ALIGNMENT=*Left,*boldon,*ULON,"Status",*ULOFF,*boldoff;
        ...
        add     "20",row
.Begin Patch 1.62
          Move      "Orders not reported received by InfoGroup and appear already processed by NINCAL",mailsubjct
.End Patch 1.62          
          ...
          append    CRLF,mailbody
.Begin Patch 1.62
          append    "These orders were able to be found in the InfoGroup log file",Mailbody
          append    CRLF,mailbody
