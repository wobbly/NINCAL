...
.END PATCH 9.36 - ADDED LOGIC
          liston
release   init    "9.71"    ASH  Adjustments to allow Datacard Select items on Order to remain independent from current Datacard state
REldate   Init      "2013 August 05"
.release   init    "9.70"    DLH  Sunbelt PDF (I belv this old code may still be used on website)
.REldate   Init      "2013 April 23"
.release   init    "9.67"    DLH  tdmc addy
.REldate   Init      "09 December 2010"
.release   init    "9.66"    DLH  Why in use? remove PL logo
.REldate   Init      "11 February 2010"
.release   init    "9.65"    DLH  Suppress TAG Print as we send fulfillment orders electronically
.REldate   Init      "04 September 2008"
.release  init    "9.64"    DLH  Got rid of objects Blockout & Blockout1
.REldate  Init      "7 July 2008"
.release  init    "9.63"    DLH  Update Consumer direct fax #
.REldate  Init      "7 July 2008"
...
.START PATCH 9.50
.begin patch 9.63
ovrTEL1   init      "7732890855"                      .Consumer Direct
...
.                             move      "\\nins1\c\apps\plb\code\pdftest.bat",str35
.
.        call       GetPDFPath
...
.       Full Run requires faxfile to print to:  \\nins1\d\data\fax\faxfile.prn - CORRECTED 12/9/2004 ASH NOW USES C:\WORK
...
.
                    call      CreateRecord
                    call      PrtCloseFile
.                   pack      APIFileName,"\\nins1\d\data\fax\faxfile.prn",hexzero
.START PATCH 9.38.4 ADDED LOGIC
.begin patch 9.70
.                    if (PDFFlag = 1)
.START PATCH 9.38.5 ADDED LOGIC
...
.                              call      FindFirstFile
.                              if (APIResult <> 0 & APIResult <> hexeight)
..                                       rename   "\\nins1\d\data\fax\faxfile.prn",prtname
.                                        pack      str45,"C:\WORK\",prtname
.                                        erase     str45
...
.                    pack      Mailto,"JamieMittone@nincal.com,JamieMittone@nincal.com"
                    pack      Mailto,"CarolFrazer@nincal.com,LauraDeBarros@nincal.com"
...
.not live yet . read the file everytime to make sure we have the flag
...
.START PATCH 9.38.3 REPLACED LOGIC
.         append  " /b + \\nins1\d\data\fax\faxfile.prn /b \\nins1\d\data\fax\faxfile2.prn",taskname
.         reset   taskname
.         execute taskname
.         copyfile "\\nins1\d\data\fax\faxfile2.prn",spoolfl2
.         copyfile "\\nins1\d\data\fax\faxfile.sav","\\nins1\d\data\fax\faxfile.prn"
.         erase     "\\nins1\d\data\fax\faxfile2.prn"
.         erase     "\\nins1\d\data\fax\faxfile.sav"
..................................................
...
test3
                                        move      C0,LastFlag
.START PATCH 9.38.3 REPLACED LOGIC
.                                       rename   "\\nins1\d\data\fax\faxfile.prn",spoolf
...
.         move      C0,PriceFlag
          ...
          loop
                    ...
                    if (NSEL3CODE = "A")
                              ...
                              call      NADDKEY
.START PATCH 9.71 REPLACED LOGIC
.                              if not over
...
.START PATCH 9.71 REMOVED LOGIC
.                              endif
.END PATCH 9.71 REMOVED LOGIC
                    elseif (NSEL3CODE = "L")
...
.;                             if (osflag = c2)         .nt
                                        PRTOPEN Laser,"\\NINs2\Laser8",prtname
