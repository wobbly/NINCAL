...
.                              Pack      MailTO from "SuzieMcGuire@nincal.com,PiaPayne@nincal.com"
                              Pack      MailTO from "SuzieMcGuire@nincal.com"
...
.Begin PATCH 4.10 ADDED LOGIC
CreateRHLIST Routine DimPtr,DimPtr1,DimPtr3,FrmPtr,FrmPtr1,FrmPtr2
.DimPtr  = FileName
.DimPtr1 = Initials
.DimPtr2 = Used Elsewhere
.DimPtr3 = LogIn Name
...
.NOTE OWNER AND USAGE NOT YET IMPLEMENTED
		...
		if	(zero & n5 > c0)
          ...
          return
.rh with revdate
CreateRHLISTR Routine DimPtr,DimPtr1,DimPtr3,FrmPtr,FrmPtr1,FrmPtr2
.DimPtr  = FileName
.DimPtr1 = Initials
.DimPtr2 = Used Elsewhere
.DimPtr3 = LogIn Name
