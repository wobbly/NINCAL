...
.Begin 2016 March 10 these appear to be backwards, the reset changes the flags
.                        reset taskname1
.                        CALL CheckLog If equal
                        CALL CheckLog If equal
                        if       (NFTPCOMP  = "009428" )  .mmi      
                        call     checklog 
                                 if       (check = c3)
                                 break
                                 goto     verify
...
.end 2016 March 11                      
                      ...
                      Endif
.begin 2016 March 11                      
                      scan NFTPLOGDATE in taskname3    .//See if the date in NFTPLOGDATE is part of the date in taskname 3
                      if equal           
                                 move       c3,check            .//set flag for skipped
                                 return                             .//if so return back to Download and move on to the next file
                      Endif
