...
.
.begin patch 3.1.1
         DISPLAY   *P10:13,"                              ",b5,b5,omdtem,slash,omdted,slash,omdtec,omdtey
         REP       ZFILL IN OLNUM
...
.Begin patch 3.73
	...
	Append	CRLF,Mailbody
.	Pack	MailBody from Count,b1,"Invoices",CRLF:
.		"LR INCOME TOTALS ",TOtLR,CRLF:
.		"NIN INCOME TOTALS ",TOtNIN,CRLF:
.		"LR INCOME Rental ",LRBRINC,CRLF:
.		"LR INCOME EXCHANGE ",LRBEINC,CRLF

.        move          "NEOM0004 - output" to SmtpSubject Subject
.              append         count,SmtpTextMessage(1)   Array <Text message >
.              append         b1,SmtpTextMessage(1)   Array <Text message >
.              append         "Invoices",SmtpTextMessage(1)   Array <Text message >
...
.              append         TOTLR,SmtpTextMessage(2)   Array <Text message >
...
.              append         TOTNIN,SmtpTextMessage(3)   Array <Text message >
...
.              append         LRBRINC,SmtpTextMessage(4)   Array <Text message >
...
.              append         LRBEINC,SmtpTextMessage(5)   Array <Text message >
...
.              append         LRMinc,SmtpTextMessage(6)   Array <Text message >
...
.	Reset	MailBody
	...
	append	CRLF,MailBody
.	Reset	MailBody
.              append         "List Management EXCh Fee ",SmtpTextMessage(7)   Array <Text message >
.              append         b1,SmtpTextMessage(7)   Array <Text message >
.              append         LRexfee,SmtpTextMessage(7)   Array <Text message >
.        reset          smtpTextMessage(7)
.              append         "LR INCOME Rent (previous month) ",SmtpTextMessage(8)   Array <Text message >
.              append         b1,SmtpTextMessage(8)   Array <Text message >
.              append         LRBbr,SmtpTextMessage(8)   Array <Text message >
.        reset          smtpTextMessage(8)
.
.              append         "LR INCOME Exch (previous month) ",SmtpTextMessage(9)   Array <Text message >
.              append         b1,SmtpTextMessage(9)   Array <Text message >
.              append         LRBBE,SmtpTextMessage(9)   Array <Text message >
...
;jose here
	...
	append	CRLF,MailBody
.	Reset	MailBody
.              append         "New Business Brokerage Rent ",SmtpTextMessage(10)   Array <Text message >
.              append         b1,SmtpTextMessage(10)   Array <Text message >
.              append         coldbr,SmtpTextMessage(10)   Array <Text message >
...
.
	...
	append	CRLF,MailBody
.	Reset	MailBody
.              append         "New Business Brokerage Exch ",SmtpTextMessage(11)   Array <Text message >
.              append         b1,SmtpTextMessage(11)   Array <Text message >
.              append         ColdBE,SmtpTextMessage(11)   Array <Text message >
.              reset          smtpTextMessage(11)
	...
	Reset	MailBody
.
.              append         "New Business List Management ",SmtpTextMessage(12)   Array <Text message >
.              append         b1,SmtpTextMessage(12)   Array <Text message >
.              append         ColdLm,SmtpTextMessage(12)   Array <Text message >
.          reset          smtpTextMessage(12)
.;
.;              Move       "9",SmtpTextIndexLast                               Index to last entry in TextMessage array
.              Move       "12",SmtpTextIndexLast                               Index to last entry in TextMessage array
;end patch 3.7
