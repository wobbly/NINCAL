.Current Client Income report for April 2006 Board Meeting - BROKERAGE
        include common.inc
        include cons.inc
        include norddd.inc
	INCLUDE	COMPDD.inc
...
.Create/Add a single Workbook
        books.open using "c:\andrew\strategic\sales.xls"
        books2.open using "c:\andrew\strategic\AprilBoardMeetingDraft1.xls"
...
.add one new Worksheet each time a Workbook is created.
        ...
        sheets2.item giving sheet2 using 1
.Detail Records
...
.Combined Address
		//Street
		//pack	str11,"H",str9
		//getprop sheet.range(str11),*Value=str75
		//call	Trim using str75
		//City
		//pack	str11,"H",str9
		//getprop sheet.range(str11),*Value=str55
		...
		//ZIP
		//pack	str11,"I",str9
		//getprop sheet.range(str11),*Value=str10
		...
		if (COMPCITY = "" & str15 = "")
			...
			//pack	taskname,str75,SReturn,COMPCITY,COMMA,B1,str15,B1,str10
...
.=(DAYS360(C17,G2)/365)  representation of formula
		pack	taskname,"=(DAYS360(N",str9a,",$G$2)/365)"
		setprop sheet2.range(str11a),*Formula=taskname
.
		add	C1,result2
EndLoop
