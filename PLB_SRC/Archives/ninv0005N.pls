...
.begin patch 3.35
Results   IFILE      Keylen=6,FIX=35,Name="InvStatN.isi|10.10.30.103:502"       .PHYSICAL OUTPUT FILE 'INVSTATS.isi'
.end patch 3.35
.end patch 3.2
.file layout
...
.
.Begin patch 3.0
         OPEN      Results,"InvStatN.isi|10.10.30.103:502",exclusive
...
.begin patch 3.35         
          ...
          move      c1,nordpath
          call      Nordkey
          if        (Ocompid = "P" or OCompId2 = "P")          .if pacific lists skip it
          goto        read1
          Else
.continue
          endif
...
START    TRAPCLR   IO
         NORETURN
.begin patch 3.0
         DISPLAY   *P10:12,*EF,*HON,"InvStatN File NOT FOUND. IT WILL BE CREATED."
.end patch 3.0
         BEEP
...
.         Prepare   Results,"\\nins1\e\data\text\INVStats.dat","\\nins1\e\data\index\INVStats.isi","6","33"
         Prepare   Results,"\\nins1\e\data\text\INVStatN.dat","\\nins1\e\data\index\INVStatN.isi|10.10.30.103:502","6","35"
..end patch 3.2
.end patch 3.35
...
. .....SCREEN DISPLAY;
.
DISPLAY  DISPLAY   *ES,*P31:24,"***** Ninv0005N *****",*R,*R:
.begin patch 3.0
...
.                                if (time3 > 5500) .55 Seconds Maximum
              ...
              repeat
          Move      "Here is your NIN billing PDF File",MailSubjct
          Move      "Creques@nincal.com",MailFrom
          Move      "Dherric@nincal.com",MailTo
          Move      Str55,MailBody
          MOve      "c:\work\pdf\invprtN.pdf",MailAttach
          call      SendMail
