...
pc       equ      0
         include  common.inc
         include  cons.inc
.******note since 2015 old mailer number cleanup some records prior to 2005 will display no or wrong mailer Name
...
.        OPEN    INPUT,STR35,READ
        PACK    STR55,"e:\data\INCOME7.DAT|10.10.30.103:502"
        OPEN    INPUT,STR35,READ
