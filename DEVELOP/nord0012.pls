...
.
         ...
         OPEN      Results,"ordSLSstats",exclusive
         TRAPCLR   IO
...
.	Move	"JoseDuenas@nincal.com,Dherric@nincal.com,LynBunch@nincal.com,ShereneKelly@nincal.com,JoeyGamache@nincal.com",MailTo
...
ERR      DISPLAY   *P1:1,*ES,"RANGE ERROR :",ERROR;
         ...
         GOTO      ERR
NOfile
         prepare   results,"\\nts1\e\data\text\OrdSlsstats.dat","\\nts1\e\data\index\OrdSlsstats.isi","8","64",exclusive
         return
.
