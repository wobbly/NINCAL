...
BoxOneRight         FORM      "550"
;BoxOneRight        FORM      "600"
BoxTwoLeft          FORM      "600"
;BoxTwoRight        FORM      "2750"
BoxTwoRight         FORM      "2290"
;BoxTwoLeft1        FORM      "1700"
BoxTwoLeft1         FORM      "1370"
;BoxTwoRight1       FORM      "2750"
BoxTwoRight1        FORM      "2290"
;BoxThreeLeft       FORM      "2800"
BoxThreeLeft        FORM      "2340"
;BoxThreeRight      FORM      "6400"
BoxThreeRight       FORM      "5100"
BoxFourLeft         FORM      "5400"
...
BoxTwoRightText     FORM      "2280"
;BoxThreeRightText  FORM      "6390"
BoxThreeRightText   FORM      "5090"
...
;Header2
          ...
          prtpage MONTHINCREPORT;*pHeader16:row,*ALIGNMENT=*CENTER,*font=Arial11,*ll,*boldon,TASKNAME,*boldoff;
...
;Previous Year Acutals
        ...
        edit AP1JAN2 to dim16a
          call      trim using          dim16a
          prtpage MONTHINCREPORT;*pBoxSixVert2Text:row,*bgcolor=*WHITE,*ALIGNMENT=*RIGHT,*font=Arial10,*ll,dim16a;
          add       SmBoxHeight to row
        move mask16 to dim16a
        edit AP1FEB2 to dim16a
          call      trim using          dim16a
          prtpage MONTHINCREPORT;*pBoxSixVert2Text:row,*ALIGNMENT=*RIGHT,*font=Arial10,*ll,dim16a;
          add       SmBoxHeight to row
        move mask16 to dim16a
...
.OldProj
                  ...
                  edit AP1TOT2 to dim16a
                    call      trim using          dim16a
                    prtpage MONTHINCREPORT;*pBoxSixVert2Text:TotBoxRow,*ALIGNMENT=*RIGHT,*font=Arial10,*ll,*ulon,dim16a;
.Variance
          move mask18 to dim18a
...
;.   Set the text message that is send with the attachments
                    ...
                    append  "Dherric",SmtpEmailAddress
...
;   Set the destinations of the email. Max 100 (Mime spec)
                    ...
                    move    "Dherric",SmtpDestinations(1,2)
