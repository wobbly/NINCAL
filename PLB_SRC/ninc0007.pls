...............................................................................
. INCRENTEXCH - CALC'S CLIENT/OWNER BILLING & ADJUSTMENT FOR CURRENT YEAR.
.               BREAK'S UP DATA BY SOURCE AND ALSO BY EXCHANGE/RENTAL.
...............................................................................
.
PC       EQU       0
         INC       COMMON.inc
...
Release   INit      "2.90"   DLH  Review for adjustments that should be suppressed: IE Shortpay, adv pay to LO codes 16 & 14
.                                combine management exchange fees, sub infogroup pass thru  revenue database updated 1/1/2013 forward
Reldate   Init      "2014 August 13"
.Release   INit      "2.88"   DLH  check for passed date variable
.Reldate   Init      "04 May 2011"
.Release   INit      "2.87"   DLH  Use New company number instead of old mlr number
.Reldate   Init      "05 Oct 2010"
.Release   INit      "2.86"   DLH  CALC unbilled AR
...
.begin patch 2.85  don't need any more
.Patch2.81
...
.end patch 2.85  don't need any more
.temp
.START PATCH #2.4 - INCREASED VARS
...
.Begin patch 2.87  turn off lr income calc keep it as AR
.         MOVE      "E" TO TIPE
         MOVE      "R",TIPE
.end patch 2.87  turn off lr income calc keep it as AR
         GOTO      NEXT
RENTAL   
.Begin patch 2.87  turn off lr income calc keep it as AR
          MOVE      "R" TO TIPE
...
.end patch 2.84a
.begin patch 2.87
.          if        (salesnum = six or salesnum = "19" or Salesnum = "27" or Salesnum = "28")
...
.begin patch 2.87
         MOVE      "R",TIPE
.         move      "E" to tipe
          move      "018710",olnum       .bundle under one number
.end patch 2.87
         goto      manage
         endif
.         scan      "B-M" in LRN
...
.         close     nordfile
         MOVE      c3 TO PASS
         MOVE      "unbilled|NINS1:502" TO NORDNAME
...
.         compare   c6 to n2
.         if        equal
.WHY??? use order salesnumber  2014 Nov 21 DLH
.          if        (n2 = six or n2 = "19" or n2 = "27" or n2 = "28")
              if (SALESNUM = 2 | SALESNUM = 06 | SALESNUM = 19 | SALESNUM = 27 | SALESNUM = 28 | SALESNUM = 30)
.end patch 2013 July 16
         move       yes to lstmsw
