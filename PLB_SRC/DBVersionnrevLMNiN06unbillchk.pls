...
..	OPEN    REDFILE,"\\nins1\e\data\dbase\revenue"
   	prepare    NEWFILE,"c:\work\revenueunbillLM.chk"
*.==========================================================================
...
;       	 pack   taskname,sortfle,";",clintsrt,comma,"s=2=","'","B","'","&9=","'",YR1,"'","|","2=","'","B","'","&9=","'",YR2,"'","|","2=","'","B","'","&9=","'",YR3,"'"
       	 pack   taskname,sortfle,";",clintsrt,comma,"s=2=","'","M","'","&9>","'","2003","'"
...
*********************************************************************
	...
	NProListView.SetcolumnText using 1,"Total Due"
        ...
        NProListView.SetcolumnText using 4,"2005 NIN"
...
*********************************************************************
	OPEN    INFILE,outsrt
        ...
        NPROListview.deleteallitems
	NProListView.SetcolumnText using 1," 2005 Acutals"
...
.===================================================================================
;if year 3  (earliest year) then grab sept - dec '04
YR3AddSwitch
                for n2,"9",nmm  ;sept - dec
...
.if second pass to get other side either rental or exchange
;                if (mtchflg = c1)
;                        move c0 to mtchflg
;                        move    oldtot to yr3act
;                        move    oldtot2 to yr3nin
;	                unpack  nrevfld,type,src,cid,yr0
;               		move 	yr1 to yr0       .Moving to next year
;	                pack    nrevfld,type,src,cid,yr0
;	                clear   newtot
;                        clear   newtot2  
;	                clear   oldtot
...
;	                        goto ADDOLD                        
;	                else
;Check for the Reverse Type for YR0
...
;                else
                         ...
                         move    oldtot to yr3act
                     	 move    oldtot2 to yr3nin
		         unpack  nrevfld,type,src,cid,yr0
;Getting Ready for Year 1 Run
                	 move 	 yr1 to yr0
		         pack    nrevfld,type,src,cid,yr0
.Read Revenue file for Year 1
		         call    NREVKEY
                	 if not over
	                        clear   newtot
                        	clear   newtot2  
...
writeflat
	...
	move 	      YR3ACT to TempVariable 
	add	      TempVariable  to lr12mos        
	move 	      c0 to TempVariable        
	
        move          yr2nin to lr12mosn
        move          yr1nin to yr1ninh
        add           yr1ninh to lr12mosn
        
	move 	      YR3nin to TempVariable 
	add	      TempVariable  to lr12mosn       
	move 	      c0 to TempVariable  
        ...
        add           lr12mosn to lr12mosg
		  ...
		  move          mslsper to n2
   		load	str25 from n2 of osls1,osls2,osls3,osls4,osls5,osls6,osls7:
			...
			write     newfile,seq;src,cid,client,lr12mos,lr12mosn,lr12mosg,b1,unbill1,b1,compaddr,compzip,compstate,str25
				move      c0 to lr12mos
				move      c0 to lr12mosn
				move      c0 to yr1ninh
				move      c0 to yr1acth
