...
.Release  init       "1.8"      JD 06Mar94    add copywrite.
...
T12        FORM      10
.begin patch 3.8
col1           form           "46"               ;print positions for Monthly info
col2           form           "56"
col3           form           "66"
col4           form           "76"
col5           form           "86"
...
col11          form           "146"
col12          form           "156"
Mpos1          form           3                  ;print column variable is loaded here. IE if start month is jan col1 =Mpos1
Mpos2          form           3                  ;print column variable is loaded here. IE if start month is Feb col1 =Mpos2
Mpos3          form           3                  ;print column variable is loaded here. IE if start month is mar col1 =Mpos3
Mpos4          form           3
Mpos5          form           3
Mpos6          form           3
Mpos7          form           3
...
.         open      Nordsfile,"ninord.ISI|20.20.30.103:502"
         open      Nordsfile,"ninord.ISI|10.10.30.103:502"
.>Patch 3.88 End
...
.need to get low month for columns
               ...
               move           str2 into n2
               for            n3 from "1" to "12"
               load           str3 from n3 of col1,col2,col3,col4,col5,col6,col7,col8,col9,col10,col11,col12
               store          str3 into n2 of Mpos1,Mpos2,Mpos3,Mpos4,Mpos5,Mpos6,Mpos7,Mpos8,Mpos9,Mpos10,Mpos11,Mpos12
               if             (n2 = 12)
               move           c1 to n2
               else
               add            c1 to n2
...
.         print     *1,copyWrite,"1992-2003, Names in the News/CA"
         print     *1,copyWrite,"1992-2007, Names in the News"
