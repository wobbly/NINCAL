...
.............................................................................
................................................
Release    INIT    "2.2"               DLH      .More checking on adjustments - some need to be  skipped, move sort files to server use datamanager
Reldate   Init      "2014 October 28"
.Release    INIT    "2.1"               DLH      .Excel 2013 *WindowState=xlMinimized
.Reldate   Init      "2014 January 22"
.release   init    "2.00"                DLH   Rewrite to use AR & AP
.Reldate   Init      "27 Sep 2010"
.need to create a new file to replace revenue that contains AR & AP
.can use income7 as it already has AR & AP
...
.hold vars
projARnew       form      11          hold exchange portion  AR
ProjAPnew        form      11          hold exchange portion AP
projARlast      form      11          hold exchange portion  AR  for requested prev Year
projAPlast       form      11          hold exchange portion Ap  for requested Previous Year
projARlast1e  form      11          hold exchange portion projected AR  for Previous Year
projAPlast1e   form      11          hold exchange portion projected Ap  for Previous Year
projARlast1r  form      11          hold rent portion projected  AR  for Previous Year
projAPlast1r   form      11          hold rent portion projected AP  for Previous Year
projAPActlstE    Form            11
...
.end patch 1.8
.begin patch 6.0
ARlast1       form      11          AR prev Year
APlast1       form      11          AP Previous Year
ARlast2       form      11          AR 2 years Prior
APlast2       form      11          AP 2 years Prior
.begin patch 6.0
.......................................................................
.SORTVAR       INIT              "c:\data\average7.dat,c:\data\average7.srt;2,9-53"
.begin patch 2.2
.SORTVAR        INIT              "c:\work\average7.dat,c:\work\average7.srt;2,9-53"
SORTVAR        INIT              "\\nins1\e\data\average7.dat,\\nins1\e\data\average7.srt;2,9-53"
.end patch 2.2
countout      form      5
sheetno       form      2
Hmany1        form      9
...
.Set Vars used for About Box
        ...
        move    "Revenue Projection Program",Wfunction
...
.See if it already exists in ListView
              if (MergeFlag = 1)
               pack           str8,PrjSrc,PrjClient
              else
               pack           str8,PrjType,PrjSrc,PrjClient
              endif
...
ProjAddNewItem
              if (SalesFlag > 0)
               if (PrjSrc = "B")            .Brokerage
.START PATCH 1.67 REPLACED LOGIC
.                             unpack         PrjClient,str2,str4
.                             move           C1,NMLRPATH
.                             pack           MKEY,str4,"000"
...
ProjAddNewItem3 Routine AutPtr,FrmPtr
              if (FrmPtr = C1)               .MergeFlag
               ...
               setprop AutPtr,*SubItems(1)=PrjType
              endif
              setprop AutPtr,*SubItems(2)=PrjSrc
              if (PrjSrc = "B")             .Brokerage
.START PATCH 1.67 REPLACED LOGIC
.              unpack         PrjClient,str2,str4
...
.              endif
..........................................
               setprop AutPtr,*SubItems(3)=PrjClient
               pack           COMPFLD,PrjClient
...
.Associate ListIts2 with Proj2ListView2
              ...
              for IntIndex2,"5",howmany,"2"
               ...
               if ((str14 <> "" and str14 <> "0") OR (str15 <> "" and str15 <> "0"))
                              ...
                              unpack         str11,PrjYr,str5,PrjKey
                              move           C0,MergeCtr
                              loop
                                             if (MergeFlag = 1)
                                                            call           Trim using str8
                                                            if (MergeCtr = 0)
                                                                           pack           NPRJFLD,"E",str8,PrjYr,PrjKey
                                                                           add            C1,MergeCtr
                                                            else
                                                                           pack           NPRJFLD,"R",str8,PrjYr,PrjKey
                                                                           add            C1,MergeCtr
                                                            endif
                                             else
                                                            packkey        NPRJFLD,str8,PrjYr,PrjKey
                                                            move           C2,MergeCtr
                                             endif
                                             move           C1,NPRJPATH
...
.                                                           ListIts2.Add giving ListIt2 using *Index=1,*Text=NPRJFLD
                                                            ...
                                                            setprop ListIt2,*SubItems(5)=PrjYr
                                                            setprop ListIt2,*SubItems(6)=PrjKey
                                                            move           PrjLR,str11
                                                            call           FormatNumeric using str11,str14
                                                            ...
                                                            call           Trim using PrjDate
                                                            if (PrjDate <> "")
                                                                           unpack         PrjDate,str4,MM,DD
                                                                           pack           str10,MM,SLASH,DD,SLASH,str4
                                                            else
                                                                           clear          str10
                                                            endif
                                                            setprop ListIt2,*SubItems(9)=str10
                                                            setprop ListIt2,*SubItems(10)=PrjNotes
                                                            call           Trim using PrjMod
                                                            if (PrjMod <> "")
                                                                           unpack         PrjMod,str4,MM,DD
                                                                           pack           str10,MM,SLASH,DD,SLASH,str4
                                                            else
                                                                           clear          str10
                                                            endif
...
.END PATCH 1.67 REPLACED LOGIC
                                                            ...
                                                            setprop ListIt2,*SubItems(13)=PrjMast
                                                            pack           str7,PrjYr,PrjKey,str1
                                                            setprop ListIt2,*SubItems(14)=str7
                                                            pack           str7,PrjType,PrjYr,PrjKey
...
Proj2LoadDetail
              getprop ListIt2,*SubItems(1)=PrjType
              move            C1,N1
              if (PrjType = "E")
               move           C2,N1
              elseif (PrjType = "R")
              ...
              getprop ListIt2,*SubItems(2)=PrjSrc
              move            C1,N1
              if (PrjSrc = "B")
               move           C2,N1
              elseif (PrjSrc = "M")
              ...
              getprop ListIt2,*SubItems(3)=PrjClient
              setitem         Proj2Edit2Client,0,PrjClient
              getprop ListIt2,*SubItems(4)=str45
              setitem         Proj2Stat2ClientName,0,str45
              getprop ListIt2,*SubItems(5)=PrjYr
              setitem         Proj2Edit2Year,0,PrjYr
              getprop ListIt2,*SubItems(6)=PrjKey
              setitem         Proj2Edit2Key,0,PrjKey
              ...
              getprop ListIt2,*SubItems(10)=PrjNotes
              setitem         Proj2Edit2Notes,0,PrjNotes
...
.END PATCH 1.67 REPLACED LOGIC
              ...
              setitem         Proj2Stat2ClientName,0,str45
              call            ZFillIt using PrjStr6,C0
              move            PrjStr6,PrjClient
.
              getitem         Proj2Edit2Year,0,PrjYr
              call            Trim using PrjYr
              if (PrjYr = "")
...
.
              ...
              if (howmany <> 8)
               ...
               pack           PrjDate,str4,MM,DD
              endif
.
              if (NewFlag = YES)
               clear          PrjMod
              else
               unpack         timestamp,PrjMod
              endif
.
...
.             endif
.
              getitem         Proj2Edit2Notes,0,PrjNotes
              call            Trim using PrjNotes
.
...
.               prepare        OUTPUT2,"c:\work\INCOME7","c:\work\INCOME7","15","210",EXCLUSIVE
               prepare        OUTPUT2,"\\nins1\e\data\INCOME7","\\nins1\e\data\INCOME7|nins1:502","15","210",EXCLUSIVE
.end patch 2.2
.end patch 1.3
...
.             append  "TEXT\NININV.DAT,C:\WORK\NININV.SRT;130-137,S=#"130>='",taskname
             append  "TEXT\NININV.DAT,\\nins1\e\data\NININV.SRT;130-137,S=#"130>='",taskname   ."
.end patch 2.2
...
.             sort    taskname
             sort    taskname,Sundm="NINS1:502"
                    If        Over
                              pack      str255 from "Sort of NININV failed, ",CRLF,"Error: ",S$ERROR$,crlf:
...
.
sortinvdone
     setitem Proj3StatProgress,0,"Reading \\nins1\e\data\NININV.SRT"
.end patch 2.2
     move    "                                        ",APIFileName
              clear   APIFileName
.begin patch 2.2
              pack    APIFileName,"\\nins1\e\data\NININV.SRT",hexzero
              call    FindFirstFile
...
.              move            "c:\work\NININV.SRT",str45
              move            "\\nins1\e\data\NININV.SRT|nins1:502",str45
.end patch 2.2
...
.               append         "TEXT\NADJUST.DAT,C:\WORK\NADJUST.SRT;125-132,S=#"125>='",taskname          ."
               append         "TEXT\NADJUST.DAT,\\nins1\e\data\NADJUST.SRT;125-132,S=#"125>='",taskname          ."
               append         FromDate,taskname
               append         "'&125<='",taskname
               append         ToDate,taskname
               append         "'#"",taskname
...
.               sort           taskname
              ...
              setitem         Proj3StatProgress,0,"Reading \\nins1\e\data\NADJUST.SRT"
              move    "                                        ",APIFileName
              clear   APIFileName
.              pack    APIFileName,"c:\work\NADJUST.SRT",hexzero
              pack    APIFileName,"\\nins1\e\data\NADJUST.SRT",hexzero
              call    FindFirstFile
              if (APIResult = 0 | APIResult = hexeight)
...
.              move            "c:\work\NADJUST.SRT",str45
              move            "\\nins1\e\data\NADJUST.SRT|nins1:502",str45
.end patch 2.2
              open            tempfile,str45,read
              positeof tempfile
              fposit          tempfile,N10
              calc            howmany=(N10/191)             .191 = 189(NadJST record length) + 2 bytes for CR/LF
              reposit tempfile,C0                           .Reposition File Pointer to beginning of file
.
              move            C2,Pass
              loop
...
.Check is done again in case User is re-using an existing Sort file that may not meet exact specs.
.begin patch 2.2
.additional code to match updated others IE  NINC0004a.pls.
. Do not adjust for shortpayment or adv pay to LO 
.               if (str10 >= FromDate AND str10 <= ToDate)
               if (str10 >= FromDate AND str10 <= ToDate & jstreasn <> "16" & jstreasn <> "14")
.end patch 2.2
                              call           ProjReadFiles2
               endif
.Update Progress Bar
...
.               append         "TEXT\TDMCINV.DAT,C:\WORK\TDMCINV.SRT;1-6,S=#"11>='",taskname
               append         "TEXT\TDMCINV.DAT,\\nins1\e\data\TDMCINV.SRT;1-6,S=#"11>='",taskname             ."
               append         FromDate,taskname
               append         "'&11<='",taskname
               append         ToDate,taskname
               append         "'#"",taskname
...
.               sort           taskname
              ...
              setitem         Proj3StatProgress,0,"Reading \\nins1\e\data\TDMCINV.SRT"
              move    "                                        ",APIFileName
              clear   APIFileName
.              pack    APIFileName,"c:\work\TDMCINV.SRT",hexzero
              pack    APIFileName,"\\nins1\e\data\TDMCINV.SRT",hexzero
              call    FindFirstFile
              if (APIResult = 0 | APIResult = hexeight)
...
.               move           "c:\work\TDMCINV.SRT",str45
               move           "\\nins1\e\data\TDMCINV.SRT|NINS1:502",str45
.end patch 2.2
              open            tempfile,str45,read
              positeof tempfile
              fposit          tempfile,N10
...
.               append         "TEXT\EXCHARGE.DAT,C:\WORK\EXCHARGE.SRT;1-6,S=#"61>='",taskname
               append         "TEXT\EXCHARGE.DAT,\\nins1\e\data\EXCHARGE.SRT;1-6,S=#"61>='",taskname
...
.               sort           taskname
              ...
              setitem         Proj3StatProgress,0,"Reading \\nins1\e\data\excharge.SRT"
              move    "                                        ",APIFileName
              clear   APIFileName
              pack    APIFileName,"\\nins1\e\data\excharge.SRT",hexzero
              call    FindFirstFile
              if (APIResult = 0 | APIResult = hexeight)
...
.               move           "c:\work\excharge.SRT",str45
               move           "\\nins1\e\data\excharge.SRT|nins1:502",str45
.end patch 2.2
              open            tempfile,str45,read
              positeof tempfile
              fposit          tempfile,N10
...
.74 = Mail Date
               ...
               append         NTWKPATH1,taskname
.begin patch 2.2
               append         "UNBILLED.DAT,\\nins1\e\data\UNBILLED.SRT;74-81,S=#"66>='",taskname
               append         FromDate,taskname
               append         "'&66<='",taskname
               append         ToDate,taskname
               append         "'&74>='",taskname
              ...
              setitem         Proj3StatProgress,0,"Reading \\nins1\e\data\UNBILLED.SRT"
              move    "                                        ",APIFileName
              clear   APIFileName
              pack    APIFileName,"\\nins1\e\data\UNBILLED.SRT",hexzero
              call    FindFirstFile
              if (APIResult = 0 | APIResult = hexeight)
...
.
              move            "\\nins1\e\data\UNBILLED.SRT|nins1:502",str45
.end patch 2.2
              open            tempfile,str45,read
              positeof tempfile
              fposit          tempfile,N10
...
.begin patch 2.2
              if (SALESNUM = 2 | SALESNUM = 06 | SALESNUM = 19 | SALESNUM = 27 | SALESNUM = 28 | SALESNUM = 30)
.end patch 2.2
               goto MANAGE
              endif
.begin patch 2.2
...
.               call           NInvAcdRecClear
               ...
               Call           NInvAcdRecLoad
.begin patch 2.2
                      move            No,Subppsw                   .do not subtract prepayments(its the default but lets be sure)
.end patch 2.2
              call            COMPUTE
.begin patch 2.2
.subtract out pass thru charges From AR
          packkey   Tinvfld,lrn
           move       c0,form122
          call      Tinvkey
           if        not over
...
.begin patch 1.3
.             read            OUTPUT2,KEY15;KEY15,INCNAME,OWNER,ARTOT,APTOT,ARTot,APTot,QTYTOT:
.              ADJARTOT,ADJAPTOT,ADJARTot,ADJAPTot,UNBILL
...
.               move           "65.00",FORM52          *ESTIMATED $.   (USE DATACARD?)
               move           "75.00",FORM52          *ESTIMATED $.   (USE DATACARD?)
              else
               move           card$,form52
              endif
              mult            FORM52,CMPT92
...
.
              ...
              clear   APIFileName
.begin patch 2.2
              pack    APIFileName,"\\nins1\e\data\",DimPtr,".SRT",hexzero
              call    FindFirstFile
              if (APIResult <> 0 & APIResult <> hexeight)
               pack           str45,"\\nins1\e\data\",DimPtr,".SRT"
               open           tempfile,str45,read
               if (FrmPtr1 = 1)
                              read           tempfile,SEQ;INVVARS
                              pack           str10,INVDTEC,INVDTEY,INVDTEM,INVDTED
               ...
               if (str10 >= FromDate)
                              ...
                              if (str10 <= ToDate)
                                             if (FrmPtr1 = 3)
                                                            if (str11 <= ToDate)
                                                                           clear          taskname
                                                                           pack           taskname,"There is a copy of \\nins1\e\data\",DimPtr,".DAT that contains records within your Date Range.",newline,"Do you want to use this file and save time sorting?"
...
.              open            tempfile,"c:\work\income7.dat",read
              open            tempfile,"\\nins1\e\data\income7.dat|nins1:502",read
.bend patch 2.2
...
.              prepare         output,"c:\work\average7.dat","c:\work\average7.isi","8","1007",exclusive
              prepare         output,"\\nins1\e\data\average7.dat","\\nins1\e\data\average7.isi|nins1:502","8","1007",exclusive
.end patch 2.2
.end patch 1.91
.end patch 1.3
input
...
.              janAP1,febAP1,marAP1,aprAP1,mayAP1,junAP1,julAP1,augAP1,sepAP1,octAP1,novAP1,decAP1:
.              janx1,febx1,marx1,aprx1,mayx1,junx1,julx1,augx1,sepx1,octx1,novx1,decx1:
.              janAPx1,febAPx1,marAPx1,aprAPx1,mayAPx1,junAPx1,julAPx1,augAPx1,sepAPx1,octAPx1,novAPx1,decAPx1:
.              unbilled
              read            output,key8;key8:           1-8      8
                              incname:                    9-53    45
                              owner:                     54-57     4
                              jan1,feb1,mar1,apr1,may1,jun1,jul1,aug1,sep1,oct1,nov1,dec1:   55-798
               janAP1,febAP1,marAP1,aprAP1,mayAP1,junAP1,julAP1,augAP1,sepAP1,octAP1,novAP1,decAP1:   -966
               janx1,febx1,marx1,aprx1,mayx1,junx1,julx1,augx1,sepx1,octx1,novx1,decx1:                           -1134
               janAPx1,febAPx1,marAPx1,aprAPx1,mayAPx1,junAPx1,julAPx1,augAPx1,sepAPx1,octAPx1,novAPx1,decAPx1:    -1470
...
.begin patch 2.0
              move            MM,N2
              if (tipe = B1 OR tipe = "R" or Tipe = "E")
               load           ARCalc from N2 of jan1,feb1,mar1,apr1,may1,jun1,jul1,aug1,sep1,oct1,nov1,dec1
               add            ARTot,ARCalc
               add            adjARTot,ARCalc
               store          ARCalc into N2 of jan1,feb1,mar1,apr1,may1,jun1,jul1,aug1,sep1,oct1,nov1,dec1
.
               load           APCalc from N2 of janAP1,febAP1,marAP1,aprAP1,mayAP1,junAP1,julAP1,augAP1,sepAP1,octAP1,novAP1,decAP1
               add            APTot,APCalc
               add            adjAPTot,APCalc
               store          APCalc into N2 of janAP1,febAP1,marAP1,aprAP1,mayAP1,junAP1,julAP1,augAP1,sepAP1,octAP1,novAP1,decAP1
.begin patch 1.3
...
.              if (tipe = "E")
.               load           ARCalc from N2 of janx1,febx1,marx1,aprx1,mayx1,junx1,julx1,augx1,sepx1,octx1,novx1,decx1
.               add            ARTot,ARCalc
.               add            adjARTot,ARCalc
.               store          ARCalc into N2 of janx1,febx1,marx1,aprx1,mayx1,junx1,julx1,augx1,sepx1,octx1,novx1,decx1
..
.               load           APCalc from N2 of janAPx1,febAPx1,marAPx1,aprAPx1,mayAPx1,junAPx1,julAPx1,augAPx1,sepAPx1,octAPx1,novAPx1,decAPx1
.               add            APTot,APCalc
.               add            adjAPTot,APCalc
.               store          APCalc into N2 of janAPx1,febAPx1,marAPx1,aprAPx1,mayAPx1,junAPx1,julAPx1,augAPx1,sepAPx1,octAPx1,novAPx1,decAPx1
..begin patch 1.3
...
.              open            tempfile2,"c:\work\average7.srt",read
              open            tempfile2,"\\nins1\e\data\average7.srt|nins1:502",read
.end patch 2.2
...
sheetsetup
              ...
              setprop sheet,*Name="Brokerage AR Totals"
...
.        repeat     until equal
              ...
              setprop sheet,*Name="List Management AR"
              setprop sheet.PageSetup,*Orientation=xlLandscape
              setprop sheet.PageSetup,*CenterFooter=" Page &P"
              setprop sheet.PageSetup,*PrintComments=xlPrintNoComments
              setprop sheet.PageSetup,*Draft=OFALSE
              ...
              setprop sheet,*Name="Brokerage LO Payables"
              setprop sheet.PageSetup,*Orientation=xlLandscape
              setprop sheet.PageSetup,*CenterFooter=" Page &P"
              setprop sheet.PageSetup,*PrintComments=xlPrintNoComments
              setprop sheet.PageSetup,*Draft=OFALSE
              ...
              setprop sheet,*Name="List Management Payables"
              setprop sheet.PageSetup,*Orientation=xlLandscape
              setprop sheet.PageSetup,*CenterFooter=" Page &P"
              setprop sheet.PageSetup,*PrintComments=xlPrintNoComments
              setprop sheet.PageSetup,*Draft=OFALSE
...
.begin patch 1,8              
              MOve            c0,ActLRE     ;hold exchange portion Actual AR  for Previous Year
              move            c0,ActNINE    ;hold exchange portion Actual AP  for Previous Year
              Move            c0,ActLrR     ;hold rent portion Actual  AR  for Previous Year
              Move            c0,ActNINR    :hold rent portion Actual AP  for Previous Year
.              pack            Nrevfld from str1,source,prjstr6,"2004"
.              call            Nrevkey

              if              (source = M)
.              pack            Nrevfld from str1,source,prjstr6,"2004" ????????????????
              pack            Nrevfld from str1,source,prjstr6,Fromyear
              call            Nrevkey
              Add             JanAR to ActLrR
              add             FebAR to ActLrR
              add             MARAR to ActLrR      
              ...
              add             DecAR to ActLrR      
.
              add             JanAP to ActNINR     
              add             FebAP to ActNINR     
              add             MarAP to ActNINR     
              add             AprAP to ActNINR     
              add             MayAP to ActNINR     
              add             JunAP to ActNINR     
              add             JulAP to ActNINR     
              add             AugAP to ActNINR     
              add             SepAP to ActNINR     
              add             OctAP to ActNINR     
              add             NovAP to ActNINR     
              add             DecAP to ActNINR
              endif
.end patch 1.8
              move            c0,ProjARLast
              move            c0,ProjAPLast
              move            c0,ProjARLast1e
              move            c0,ProjAPLast1e
              move            c0,ProjARLast1r
              move            c0,ProjAPLast1r
              move            c0,ProjARNew
              move            c0,ProjAPNew
.begin patch 6.0
          Move      C0,ARLast1
          ...
          move      C0,RevAP
          if        (source = "B")
          PackKey   Nrevfld from "R",source,PrjStr6,prevyear
          else
          PackKey   Nrevfld from b1,source,PrjStr6,prevyear
          endif
          call      debug
          call      Nrevkey
          move      RevAr,ARLast1
          ...
          move      C0,RevAP
          if        (source = "B")
          PackKey   Nrevfld from "R",source,PrjStr6,n4
          else
          PackKey   Nrevfld from b1,source,PrjStr6,N4
          endif     
          call      Nrevkey
          move      RevAr,ARLast2
          move      REvAP,APLast2
...
.end patch 6.0
          call      debug
              ...
              loop
                              ...
                              call           NPRJKEY
                              until over
                       move   PrjAR,projARnew
                       move   PrjAP,ProjAPnew
                              until (PrjMast = YES)
               repeat
               move           "RB",str2
               move           C0,N2
               loop
                              ...
                              call           NPRJKEY
                              until over
                       move   PrjAR,projARlast
                       move   PrjAP,ProjAPlast
                              until (PrjMast = YES)
               repeat
               move           "EB",str2
               move           C0,N2
               ...
               loop
                              ...
                              call           NPRJKEY
                              until over
                       move   PrjAR,projARlast1e
                       move   PrjAP,projAPlast1e
                              until (PrjMast = YES)
               repeat
               move           "RB",str2
               move           C0,N2
               loop
                              ...
                              call           NPRJKEY
                              until over
                       move   PrjAR,projARlast1r
                       move   PrjAP,ProjAPlast1r
                              until (PrjMast = YES)
               repeat
              endif
              if (source = "M")
...
.;begin patch 1.8
              ...
              add             DecAR to ActLrE      
.
              add             JanAP to ActNINE     
              add             FebAP to ActNINE     
              add             MarAP to ActNINE     
              add             AprAP to ActNINE     
              add             MayAP to ActNINE     
              add             JunAP to ActNINE     
              add             JulAP to ActNINE     
              add             AugAP to ActNINE     
              add             SepAP to ActNINE     
              add             OctAP to ActNINE     
              add             NovAP to ActNINE     
              add             DecAP to ActNINE
.begin patch 6.0
.              MOve            "R" to str1
              MOve            " " to str1
.end patch 6.0
...
.rtotal total
               ...
               call           trim using percent
               append         percent,taskname
               append         "*'Brokerage AR Totals'!O",taskname
               append         str9,taskname
               append         ")",taskname
               reset          taskname
               setprop sheet.range(str4),*Formula=Taskname,*NumberFormat="##,####0_);[Red](##,####0)"
.Previous year AR
               ...
               call           Trim using str9
               pack           str4,"P",str9
.               setprop sheet.range(str4),*Value=ProjARLast,*NumberFormat="##,####0_);[Red](##,####0)"
               setprop sheet.range(str4),*Value=ARlast1,*NumberFormat="##,####0_);[Red](##,####0)"
.year prior to selected proj year  - add code to pull
.change to Previous year AR
               move           howmany,str9
               call           Trim using str9
               pack           str4,"Q",str9
               setprop sheet.range(str4),*Value=ARLast2,*NumberFormat="##,####0_);[Red](##,####0)"
.              setprop sheet.range(str4),*Value=ProjARLast1r,*NumberFormat="##,####0_);[Red](##,####0)"
.salesperson  - add code to pull
               move           howmany,str9
               call           Trim using str9
               pack           str4,"R",str9
...
.lastyear  - add code to pull
               ...
               call           Trim using str9
               pack           str4,"P",str9
               setprop sheet.range(str4),*Value=ProjARNew,*NumberFormat="##,####0_);[Red](##,####0)"
.prev to lastyear  - add code to pull
               move           howmany,str9
               call           Trim using str9
               pack           str4,"Q",str9
               setprop sheet.range(str4),*Value=ProjARLast1e,*NumberFormat="##,####0_);[Red](##,####0)"
.salesperson  - add code to pull
               move           howmany,str9
               call           Trim using str9
               pack           str4,"R",str9
...
.ok lets do sheet 5 & 6 & 7
               ...
               if      (Source = "B" or ndattdmc = "Y")
                              ...
                              add            novAP1,rAPTotal
                              add            decAP1,rAPTotal
                              add     janAPx1,eAPTotal
                              add            febAPx1,eAPTotal
                              add            marAPx1,eAPTotal
                              add            aprAPx1,eAPTotal
                              add            mayAPx1,eAPTotal
                              add            junAPx1,eAPTotal
                              add            julAPx1,eAPTotal
                              add            augAPx1,eAPTotal
                              add            sepAPx1,eAPTotal
                              add            octAPx1,eAPTotal
                              add            novAPx1,eAPTotal
                              add            decAPx1,eAPTotal
                              add            eAPTotal,APTotal
                              add            rAPTotal,APTotal
               endif
....................................................................
...
.Jan total
               ...
               pack           str4,"C",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!C",taskname
               append         str9,taskname
...
.feb total
               ...
               pack           str4,"D",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!D",taskname
               append         str9,taskname
...
.mar total
               ...
               pack           str4,"E",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!E",taskname
               append         str9,taskname
...
.Apr total
               ...
               pack           str4,"F",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!F",taskname
               append         str9,taskname
...
.May total
               ...
               pack           str4,"G",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!G",taskname
               append         str9,taskname
...
.JUne total
               ...
               pack           str4,"H",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!H",taskname
               append         str9,taskname
...
.July total
               ...
               pack           str4,"I",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!I",taskname
               append         str9,taskname
...
.Aug total
               ...
               pack           str4,"J",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!J",taskname
               append         str9,taskname
...
.Sep total
               ...
               pack           str4,"K",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!K",taskname
               append         str9,taskname
...
.Oct total
               ...
               pack           str4,"L",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!L",taskname
               append         str9,taskname
...
.Nov total
               ...
               pack           str4,"M",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!M",taskname
               append         str9,taskname
...
.Dec total
               ...
               pack           str4,"N",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!N",taskname
               append         str9,taskname
               ...
               setprop sheet.range(str4),*Formula=Taskname,*NumberFormat="##,####0_);[Red](##,####0)"
.
.brokerage Payables totals
               move           APTotAL,NINPERc
...
...................................................................................
               ...
               pack           str4,"P",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!P",taskname
               append         str9,taskname
...
...................................................................................
               ...
               pack           str4,"Q",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!Q",taskname
               append         str9,taskname
...
...................................................................................
               ...
               pack           str4,"U",str9
               clear          taskname
               append         "=SUM('Brokerage LO Payables'!U",taskname
               append         str9,taskname
...
.calculate rent %
               move           C0,rpercent
               move           rAPTotal,rpercent
               divide         Rtotal,rpercent
.Jan rental portion
               move           C0,mpercent
               move           janAP1,mpercent
               divide         RAPTotal,mpercent
.
               move           howmany,str9
               call           Trim using str9
               pack           str4,"C",str9
...
.lastyear  - add code to pull
               ...
               call           Trim using str9
               pack           str4,"P",str9
.               setprop        sheet.range(str4),*Value=ProjAPLast,*NumberFormat="##,####0_);[Red](##,####0)"
               setprop        sheet.range(str4),*Value=APlast1,*NumberFormat="##,####0_);[Red](##,####0)"
.lastyear  - add code to pull
               move           howmany,str9
               call           Trim using str9
               pack           str4,"Q",str9
.               setprop        sheet.range(str4),*Value=ProjAPLast,*NumberFormat="##,####0_);[Red](##,####0)"
               setprop        sheet.range(str4),*Value=aPLast2,*NumberFormat="##,####0_);[Red](##,####0)"
.salesperson  - add code to pull
               move           howmany,str9
               call           Trim using str9
               pack           str4,"R",str9
...
.calculate exchange %
               move           C0,rpercent
               move           eAPTotal,epercent
               divide         Etotal,epercent
.Jan exchange portion
               move           C0,mpercent
               move           janAPx1,mpercent
               divide         EAPTotal,mpercent
.
               move           howmany,str9
               call           Trim using str9
               pack           str4,"C",str9
...
.lastyear  - add code to pull
               ...
               call           Trim using str9
               pack           str4,"P",str9
               setprop        sheet.range(str4),*Value=ProjAPNew,*NumberFormat="##,####0_);[Red](##,####0)"
.lastyear  - add code to pull
               move           howmany,str9
               call           Trim using str9
               pack           str4,"Q",str9
               setprop        sheet.range(str4),*Value=ProjAPLast1e,*NumberFormat="##,####0_);[Red](##,####0)"
.salesperson  - add code to pull
               move           howmany,str9
               call           Trim using str9
               pack           str4,"R",str9
...
.Jan LM total
               move           C0,mpercent
               move           JanAP1,mpercent
               add            JanAPx1,mpercent
               divide         APTotal,mpercent
.
               move           howmany,str9
               call           Trim using str9
               pack           str4,"C",str9
...
.LM total
               move           C0,ninperc
               move           APTotAL,NINPERc              .nin total
               divide         Rtotal,NINPERc               .lr total
               move           howmany,str9
               call           Trim using str9
               pack           str4,"O",str9
               clear          taskname
               append         "=('List Management AR'!o",taskname
               append         str9,taskname
               append         "*",taskname
               move           C0,percent
               move           NINperc,percent
...
.lastyear  - add code to pull
               ...
               call           Trim using str9
               pack           str4,"Q",str9
               setprop        sheet.range(str4),*Value=ProjAPLast1r,*NumberFormat="##,####0_);[Red](##,####0)"
.salesperson  - Not nec for LM
               move           howmany,str9
               call           Trim using str9
               pack           str4,"R",str9
...
.END PATCH 1.66 REPLACED LOGIC
              ...
              call            Trim using str9
              pack            str4,"A",str9
              setprop         sheet.range(str4),*Value="Brokerage Receivables"
              call            hdout1
.
...
.END PATCH 1.66 REPLACED LOGIC
              ...
              call            Trim using str9
              pack            str4,"A",str9
              setprop         sheet.range(str4),*Value="Brokerage Recevables Rental"
              call            hdout1
.
...
.END PATCH 1.66 REPLACED LOGIC
              ...
              call            Trim using str9
              pack            str4,"A",str9
              setprop         sheet.range(str4),*Value="List Managenent Receivables"
              call            hdout1
.
...
.END PATCH 1.66 REPLACED LOGIC
              ...
              call            Trim using str9
              pack            str4,"A",str9
              setprop         sheet.range(str4),*Value="Brokerage Payables"
              call            hdout1
.
...
.END PATCH 1.66 REPLACED LOGIC
              ...
              call            Trim using str9
              pack            str4,"A",str9
              setprop         sheet.range(str4),*Value="Brokerage Payables Rental"
              call            hdout1
.
...
.END PATCH 1.66 REPLACED LOGIC
              ...
              call            Trim using str9
              pack            str4,"A",str9
              setprop         sheet.range(str4),*Value="Brokerage Payables Exchange"
              call            hdout1
.
...
.END PATCH 1.66 REPLACED LOGIC
              ...
              call            Trim using str9
              pack            str4,"A",str9
              setprop         sheet.range(str4),*Value="List Management Payables"
              call            hdout1
.begin patch 1.3
