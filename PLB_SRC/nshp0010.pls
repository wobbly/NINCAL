...
.release  init      "1.1.2"               DMB 07JUL2006 Changed ship cost to support new more variations
...
./Patch 1.1.2 New code added for variation in cost formats
.scost    dim       5
scost    dim       6
./Patch 1.1.2 New code added for variation in cost formats
savefle  dim       35
...
BADCost
         COMPARE   LINES TO FIFTY4
         CALL      HEADER IF LESS
         PRINT     *L,*10,"LR ## ",SLRNUM,"Cost is not formatted properly"
         ADD       C2 TO LINES
         GOTO      INPUT
...
.begin patch 2.57
         ...
         PACK      TASKNAME,"c:\winnt\system32\cmd.exe /c copy ",NTWKPATH1,"PIDISHP.LST \\NINs2\Laser8 "
         Execute   TASKNAME
                    ElseIf              (osflag = c3 | osflag = c4)
         PACK      TASKNAME,"c:\command.com /c copy ",NTWKPATH1,"PIDISHP.LST \\NINs2\Laser8 "
         EXECUTE   TASKNAME
                    Elseif              (osflag = c6)
         PACK      TASKNAME,"c:\windows\system32\cmd.exe /c copy ",NTWKPATH1,"PIDISHP.LST \\NINs2\Laser8 "
         Execute   TASKNAME
         endif
...
sendnews
        ...
        move    cntname to str35
          ...
          Move    "This is a Informational e-mail from  the PIDI shipping program",mailSubjct
          Clear     MailBody
          Append    "This is a Informational e-mail from  the PIDI shipping program",MailBOdy
